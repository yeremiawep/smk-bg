              ...
              <tbody>
                ...
                <?php foreach ($query as $user) : ?>
                  <tr>
                    ...
                    <td><?= $user['name_jab']; ?></td>
                    <td width="20%">
                      <a href="index.php?page=input-nilai-cro&&id=<?= $user['id_user']; ?>&&idpeg=<?= $user['id_pegawai']; ?>&&div=<?= $user['divisi']; ?>&&jab=<?= $user['jabatan']; ?>" class="btn btn-primary inline-block"><i class="nav-icon fas fa-plus"></i> Nilai SKO</a>
