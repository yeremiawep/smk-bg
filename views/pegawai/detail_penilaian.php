        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-4">
                <input type="text" id="" value="<?= $m['id_pegawai']; ?>" disabled>
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="row mb-3 mt-2">
              ...
              <div class="col-2">
                <input type="text" id="nilaisko" name="nilaisko" value="<?= $m['total_nilai_sko']; ?>" disabled>
              </div>
            </div>
          </div>
          <hr class="border-primary">
          <div class="card-body">
            ...
            <div class="row mb-3 mt-2">
              ...
              <div class="col-2">
                <input type="text" id="nilaisko" name="nilaisko" value="<?= $m['total_nilai_sk']; ?>" disabled>
              </div>
            </div>
            <div class="row mb-3">
              <label for="nilaisk" class="col-sm-2 col-form-label">Nilai Akhir</label>
              <div class="col-2">
                <input type="text" id="nilaisko" name="nilaisko" value="<?= $m['nilai_akhir']; ?>" disabled>
              </div>
            </div>
            <div class="row mb-3">
              <label for="nilaisk" class="col-sm-2 col-form-label">Predikat</label>
              <div class="col-2">
                <input type="text" id="nilaisko" name="nilaisko" value="<?= $m['predikat']; ?>" disabled>
              </div>
            </div>
          </div>
          <hr class="border-primary">
          <div class="card-body">
            <div class="form-group">
              ...
              <textarea class="form-control" id="exampleFormControlTextarea1" rows="4" placeholder="Tidak ada catatan" disabled><?= $m['catatan']; ?></textarea>
            </div>
          </div>
        </div>
      </div>
