      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h1 class="card-title">Rekap Nilai Asisten Supervisor CRO</h1>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
                ...
                <?php foreach ($nilai as $nilai) : ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="index.php?page=edit-nilai-atasan&&idna=<?= $nilai['id_na']; ?>&&id=<?= $nilai['id_user']; ?>&&periode=<?= $nilai['periode']; ?>" class="btn btn-sm btn-warning"><i class="nav-icon fas fa-edit"></i></a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
        ...
        <div class="card">
          <div class="card-header">
            <h1 class="card-title">Rekap Nilai Asisten Supervisor CIT</h1>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table id="example1" class="table table-bordered">
                ...
                <?php foreach ($nilai2 as $nilai) : ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="index.php?page=edit-nilai-atasan&&idna=<?= $nilai['id_na']; ?>&&id=<?= $nilai['id_user']; ?>" class="btn btn-sm btn-warning"><i class="nav-icon fas fa-edit"></i></a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
        ...
        <div class="card">
          <div class="card-header">
            <h1 class="card-title">Rekap Nilai Asisten Supervisor Rutang</h1>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table id="example1" class="table table-bordered">
