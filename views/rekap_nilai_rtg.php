...
$nilai = mysqli_query($conn, "SELECT * FROM nilai_akhir JOIN users ON nilai_akhir.id_user=users.id_user RIGHT JOIN jabatans ON users.jabatan=jabatans.id RIGHT JOIN divisions ON users.divisi = divisions.id JOIN periode ON nilai_akhir.periode=periode.id_periode WHERE divisions.id='3' AND jabatans.id!='5' AND periode.id_periode='$periode'");
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h1 class="card-title">Rekap Nilai Divisi RTG</h1>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <div class="row px-2">
                ...
                <?php foreach ($nilai as $nilai) : ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="index.php?page=edit-nilai-rtg&&idna=<?= $nilai['id_na']; ?>&&id=<?= $nilai['id_user']; ?>&&periode=<?= $nilai['periode']; ?>" class="btn btn-sm btn-warning"><i class="nav-icon fas fa-edit"></i></a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
