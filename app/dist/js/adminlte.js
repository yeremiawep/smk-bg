...
(function (global, factory) {
  ...
  var SELECTOR_Arial_ATTR = "Arial-expanded";
  /**
   * Class Definition
   * ====================================================
   */
  ...
  var ExpandableTable = /*#__PURE__*/ (function () {
    ...
    _proto.init = function init() {
      $__default["default"](SELECTOR_DATA_TOGGLE$2).each(function (_, $header) {
        var $type = $__default["default"]($header).attr(SELECTOR_Arial_ATTR);
    ...
    _proto.toggleRow = function toggleRow() {
      ...
      var time = 500;
      var $type = $element.attr(SELECTOR_Arial_ATTR);
      ...
      if ($type === "true") {
        ...
        $element.attr(SELECTOR_Arial_ATTR, "false");
        $element.trigger($__default["default"].Event(EVENT_COLLAPSED$2));
      } else if ($type === "false") {
        $element.next(SELECTOR_EXPANDABLE_BODY).removeClass("d-none");
        $body.slideDown(time);
        $element.attr(SELECTOR_Arial_ATTR, "true");
  ...
  var IFrame = /*#__PURE__*/ (function () {
    ...
    _proto.createTab = function createTab(title, link, uniqueName, autoOpen) {
      ...
      var newNavItem =
        ...
        '" href="#' +
        tabId +
        '" role="tab" Arial-controls="' +
        tabId +
        '" Arial-selected="false">' +
        title +
        "</a></li>";
      $__default["default"](SELECTOR_TAB_NAVBAR_NAV).append(unescape(escape(newNavItem)));
      var newTabItem = '<div class="tab-pane fade" id="' + tabId + '" role="tabpanel" Arial-labelledby="' + navId + '"><iframe src="' + link + '"></iframe></div>';
    ...
    _proto.removeActiveTab = function removeActiveTab(type, element) {
      if (type == "all") {
        ...
        var tabId = $navClose.siblings(".nav-link").attr("Arial-controls");
        $navItem.remove();
  ...
  var Toasts = /*#__PURE__*/ (function () {
    ...
    _proto.create = function create() {
      var toast = $__default["default"]('<div class="toast" role="alert" Arial-live="assertive" Arial-atomic="true"/>');
      ...
      if (this._config.close == true) {
        var toastClose = $__default["default"]('<button data-dismiss="toast" />')
          ...
          .append('<span Arial-hidden="true">&times;</span>');
