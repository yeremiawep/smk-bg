...
class Toasts {
  ...
  create() {
    const toast = $('<div class="toast" role="alert" Arial-live="assertive" Arial-atomic="true"/>');
    ...
    if (this._config.close == true) {
      const toastClose = $('<button data-dismiss="toast" />').attr("type", "button").addClass("ml-2 mb-1 close").attr("Arial-label", "Close").append('<span Arial-hidden="true">&times;</span>');
