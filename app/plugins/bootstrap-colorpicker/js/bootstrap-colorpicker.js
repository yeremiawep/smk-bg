          ...
          _createClass(
            ...
            [
              ...
              },
              {
                ...
                /**
                 * Detects if a value is a string and a color in hexadecimal format (in any vArialnt).
                 *
                 * @param {String} str
            ...
            },
            {
              ...
              value: function createPopover() {
                ...
                this.popoverTip = useGetInstance
                  ? (0, _jquery2.default)(bootstrap.Popover.getInstance(this.popoverTarget[0]).getTipElement())
