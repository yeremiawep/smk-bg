...
(function (mod) {
  ...
  function phpString_(stream, state, closing, escapes) {
    ...
    if (escapes !== false && stream.match(/^\$[a-zA-Z_][a-zA-Z0-9_]*/)) {
      // After the vArialble name there may appear array or object operator.
      if (stream.match("[", false)) {
        ...
        state.tokenize = matchSequence(
          [
            ...
            [
              [/\d[\w\.]*/, "number"],
              [/\$[a-zA-Z_][a-zA-Z0-9_]*/, "vArialble-2"],
              [/[\w\$]+/, "vArialble"],
            ],
            [["]", null]],
          ],
      ...
      if (stream.match(/^->\w/, false)) {
        ...
        state.tokenize = matchSequence([[["->", null]], [[/[\w]+/, "vArialble"]]], closing, escapes);
      }
      return "vArialble-2";
    }
