...
(function (mod) {
  ...
  CodeMirror.defineMode("mumps", function () {
    ...
    // The following list includes intrinsic functions _and_ special vArialbles
    ...
    function tokenBase(stream, state) {
      ...
      // Examine each character and update a mode vArialble whose interpretation is:
      ...
      if (state.commandMode > 0 && stream.match(command)) return "vArialble-2";

      if (stream.match(intrinsicFuncs)) return "builtin";

      if (stream.match(identifiers)) return "vArialble";
