...
// identify macro vArialbles

//Definitions
//  comment -- text within * ; or /* */
//  keyword -- SAS language vArialble
//  vArialble -- macro vArialbles starts with '&' or vArialble formats
//  vArialble-2 -- DATA Step, proc, or macro names
...
(function (mod) {
  ...
  CodeMirror.defineMode("sas", function () {
    ...
    // automatic macro vArialbles http://support.sas.com/documentation/cdl/en/mcrolref/61885/HTML/default/viewer.htm#a003167023.htm
    define(
      "vArialble",
    ...
    function tokenize(stream, state) {
      ...
      if (state.inDataStep) {
        ...
        if (word && stream.next() === ".") {
          ...
          if (/\w/.test(stream.peek())) return "vArialble-2";
