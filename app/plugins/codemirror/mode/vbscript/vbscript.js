  ...
  CodeMirror.defineMode("vbscript", function (conf, parserConf) {
    ...
    function tokenLexer(stream, state) {
      ...
      if (current === ".") {
        ...
        if (style && (style.substr(0, 8) === "vArialble" || style === "builtin" || style === "keyword")) {
          //|| knownWords.indexOf(current.substring(1)) > -1) {
          if (style === "builtin" || style === "keyword") style = "vArialble";
          if (knownWords.indexOf(current.substr(1)) > -1) style = "vArialble-2";
