...
(function (mod) {
  ...
  CodeMirror.defineMode("css", function (config, parserConfig) {
    ...
    function tokenBase(stream, state) {
      ...
      if (ch == "@") {
        ...
        if (/[\d.]/.test(stream.peek())) {
          ...
          stream.eatWhile(/[\w\\\-]/);
          if (stream.match(/^\s*:/, false)) return ret("vArialble-2", "vArialble-definition");
          return ret("vArialble-2", "vArialble");
        } else if (stream.match(/^\w+-/)) {
        ...
        return ret("vArialble callee", "vArialble");
      } else if (/[\w\\\-]/.test(ch)) {
        stream.eatWhile(/[\w\\\-]/);
    ...
    states.top = function (type, stream, state) {
      if (type == "{") {
        ...
        override = "tag";
      } else if (type == "vArialble-definition") {
        return "maybeprop";
    ...
    states.interpolation = function (type, stream, state) {
      if (type == "}") return popContext(state);
      if (type == "{" || type == ";") return popAndPass(type, stream, state);
      if (type == "word") override = "vArialble";
      else if (type != "vArialble" && type != "(" && type != ")") override = "error";
  ...
  var fontProperties_ = ["font-display", "font-family", "src", "unicode-range", "font-vArialnt", "font-feature-settings", "font-stretch", "font-weight", "font-style"],
  ...
  CodeMirror.defineMIME("text/x-scss", {
    ...
    tokenHooks: {
      ...
      $: function (stream) {
        stream.match(/^[\w-]+/);
        if (stream.match(/^\s*:/, false)) return ["vArialble-2", "vArialble-definition"];
        return ["vArialble-2", "vArialble"];
      },
      "#": function (stream) {
        if (!stream.eat("{")) return false;
