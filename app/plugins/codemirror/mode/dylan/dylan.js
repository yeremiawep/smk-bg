...
(function (mod) {
  ...
  CodeMirror.defineMode("dylan", function (_config) {
    ...
    var words = {
      ...
      otherParameterizedDefinition: ["method", "function", "C-vArialble", "C-address"],
      ...
      // Words that introduce module vArialble definitions.
      // These must also be simple definitions and are
      // appended to otherSimpleDefinitionWords
      vArialbleSimpleDefinition: ["vArialble"],
    ...
    words["simpleDefinition"] = words["constantSimpleDefinition"].concat(words["vArialbleSimpleDefinition"]).concat(words["otherSimpleDefinition"]);
    ...
    var patternStyles = {
      symbolKeyword: "atom",
      symbolClass: "tag",
      symbolGlobal: "vArialble-2",
      symbolConstant: "vArialble-3",
    };
