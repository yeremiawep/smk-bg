...
(function (mod) {
  ...
  CodeMirror.defineMode("q", function (config) {
    ...
    function tokenBase(stream, state) {
      ...
      if (/[A-Za-z]|\./.test(c)) return stream.eatWhile(/[A-Za-z._\d]/), keywords.test(stream.current()) ? "keyword" : "vArialble";
    ...
    return {
      ...
      token: function (stream, state) {
        ...
        else if (/atom|string|vArialble/.test(style) && state.context) {
