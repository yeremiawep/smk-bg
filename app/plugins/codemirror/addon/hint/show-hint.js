...
(function (mod) {
  ...
  function Widget(completion, data) {
    ...
    hints.setAttribute("Arial-expanded", "true");
    hints.id = this.id;
    ...
    for (var i = 0; i < completions.length; ++i) {
      ...
      if (i == this.selectedHint) elt.setAttribute("Arial-selected", "true");
      elt.id = this.id + "-" + i;
    ...
    cm.getInputField().setAttribute("Arial-autocomplete", "list");
    cm.getInputField().setAttribute("Arial-owns", this.id);
    cm.getInputField().setAttribute("Arial-activedescendant", this.id + "-" + this.selectedHint);
  ...
  Widget.prototype = {
    close: function () {
      ...
      input.removeAttribute("Arial-activedescendant");
      input.removeAttribute("Arial-owns");
    ...
    changeActive: function (i, avoidWrap) {
      ...
      if (node) {
        ...
        node.removeAttribute("Arial-selected");
      }
      node = this.hints.childNodes[(this.selectedHint = i)];
      node.className += " " + ACTIVE_HINT_ELEMENT_CLASS;
      node.setAttribute("Arial-selected", "true");
      this.completion.cm.getInputField().setAttribute("Arial-activedescendant", node.id);
      this.scrollToActive();
