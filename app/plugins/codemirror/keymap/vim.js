 ...
 * Code structure:
 *  1. Default keymap
 *  2. VArialble declarations and short basic helpers
  ...
  var Vim = function () {
    ...
    function makePrompt(prefix, desc) {
      return dom(
        ...
        dom("span", { $fontFamily: "monospace", $whiteSpace: "pre" }, prefix, dom("input", { type: "text", autocorrect: "off", autocapitalize: "off", spellcheck: "false" })),
