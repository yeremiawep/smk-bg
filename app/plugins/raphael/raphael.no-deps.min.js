        ...
        void 0 ===
          (n = function (t) {
              ...
              return function i() {
                ...
                return s[o](a)
                  ? ((function (t, e) {
                    ...
                    r ? r(s[a]) : s[a])
                  : (l.length >= 1e3 && delete s[l.shift()], l.push(a), (s[a] = t[c](e, n)), r ? r(s[a]) : s[a]);
              };
            }
            (e.color = function (t) {
              var r;
              ...
              (e.hsl2rgb = function (t, e, r, i) {
                ...
                return (
                  ...
                  (o = (l = 2 * e * (r < 0.5 ? r : 1 - r)) * (1 - B(((t = ((t *= 360) % 360) / 60) % 2) - 1))),
                  (n = a = s = r - l / 2),
                  lt((n += [l, o, 0, 0, o, l][(t = ~~t)]), (a += [o, l, l, o, 0, 0][t]), (s += [0, 0, o, l, l, o][t]), i)
                );
              }),
            ...
            (e.getRGB = ht(function (t) {
              if (!t || (t = x(t)).indexOf("-") + 1) return { r: -1, g: -1, b: -1, hex: "none", error: 1, toString: ut };
              ...
              var r,
                ...
                h = t.match(E);
              return h
                ? (h[2] && ((n = z(h[2].substring(5), 16)), (i = z(h[2].substring(3, 5), 16)), (r = z(h[2].substring(1, 3), 16))),
                  h[3] && ((n = z((s = h[3].charAt(3)) + s, 16)), (i = z((s = h[3].charAt(2)) + s, 16)), (r = z((s = h[3].charAt(1)) + s, 16))),
                  h[4] &&
                    ((l = h[4][v](I)),
                    (r = F(l[0])),
                    "%" == l[0].slice(-1) && (r *= 2.55),
                  ...
                  h[5]
                    ...
                    ? ((l = h[6][v](I)),
                      ...
                      l[3] && "%" == l[3].slice(-1) && (a /= 100),
                      e.hsl2rgb(r, i, n, a))
                    : (((h = { r: r, g: i, b: n, toString: ut }).hex = "#" + (16777216 | n | (i << 8) | (r << 16)).toString(16).slice(1)), e.is(a, "finite") && (h.opacity = a), h))
                  ...
                  n.length ||
                    x(t).replace(V, function (t, e, r) {
                      ...
                      if (
                        ...
                        "m" == s && a.length > 2 && (n.push([e][f](a.splice(0, 2))), (s = "l"), (e = "m" == e ? "l" : "L")),
                        "r" == s)
                      )
                        n.push([e][f](a));
            ...
            var yt = (e.pathBBox = function (t) {
              ...
              Ct = function (t, e, r, i, n, a, s, o, l) {
                var h = 1 - l;
                return { x: C(h, 3) * t + 3 * C(h, 2) * l * r + 3 * h * l * l * n + C(l, 3) * s, y: C(h, 3) * e + 3 * C(h, 2) * l * i + 3 * h * l * l * a + C(l, 3) * o };
              },
                ...
                function (t, e) {
                  ...
                  for (
                    var i = _t(t),
                      ...
                      h = function (t, e, r, a, s) {
                        t &&
                          ...
                          "M" == t[s][0] &&
                          "M" != e[s][0] &&
                          (e.splice(s, 0, ["M", a.x, a.y]), (r.bx = 0), (r.by = 0), (r.x = t[s][1]), (r.y = t[s][2]), (v = w(i.length, (n && n.length) || 0)));
                      },
                      u = [],
                      p = [],
                      d = "",
                    ...
                    i[x] && (d = i[x][0]),
                      ...
                      "A" != u[x] && "C" == d && (u[x] = "C"),
                      l(i, x),
                      n && (n[x] && (d = n[x][0]), "C" != d && ((p[x] = d), x && (g = p[x - 1])), (n[x] = o(n[x], s, g)), "A" != p[x] && "C" == d && (p[x] = "C"), l(n, x)),
                      h(i, n, a, s, x),
                      h(n, i, s, a, x);
                    var y = i[x],
                      m = n && n[x],
                ...
                (e._extractTransform = function (t, r) {
                  ...
                  if (((h.transform = a || []), a))
                    for (var c = 0, f = a.length; c < f; c++) {
                      ...
                      "t" == w && 3 == _
                        ? k
                          ? ((p = B.x(0, 0)), (g = B.y(0, 0)), (v = B.x(b[1], b[2])), (y = B.y(b[1], b[2])), u.translate(v - p, y - g))
                          : u.translate(b[1], b[2])
                        : "r" == w
                        ? 2 == _
                          ? ((m = m || t.getBBox(1)), u.rotate(b[1], m.x + m.width / 2, m.y + m.height / 2), (s += b[1]))
                          : 4 == _ && (k ? ((v = B.x(b[2], b[3])), (y = B.y(b[2], b[3])), u.rotate(b[1], v, y)) : u.rotate(b[1], b[2], b[3]), (s += b[1]))
                        : "s" == w
                        ? 2 == _ || 3 == _
                          ? ((m = m || t.getBBox(1)), u.scale(b[1], b[_ - 1], m.x + m.width / 2, m.y + m.height / 2), (o *= b[1]), (l *= b[_ - 1]))
                          : 5 == _ && (k ? ((v = B.x(b[3], b[4])), (y = B.y(b[3], b[4])), u.scale(b[1], b[2], v, y)) : u.scale(b[1], b[2], b[3], b[4]), (o *= b[1]), (l *= b[2]))
                ...
                (t.add = function (t, e, r, i, n, a) {
                  ...
                  (t.split = function () {
                    ...
                    var a = -n[0][1],
                      s = n[1][1];
                    return (
                      s < 0 ? ((t.rotate = e.deg(_.acos(s))), a < 0 && (t.rotate = 360 - t.rotate)) : (t.rotate = e.deg(_.asin(a))),
                  ...
                  (t.toTransformString = function (t) {
                    ...
                    return e.isSimple
                      ? ((e.scalex = +e.scalex.toFixed(4)),
                        ...
                        (e.dx || e.dy ? "t" + [e.dx, e.dy] : d) + (1 != e.scalex || 1 != e.scaley ? "s" + [e.scalex, e.scaley, 0, 0] : d) + (e.rotate ? "r" + [e.rotate, 0, 0] : d))
            ...
            for (
              var Ft = function () {
                ...
                Ot = function (e) {
                  for (
                    var r, i = e.clientX, n = e.clientY, a = l.doc.documentElement.scrollTop || l.doc.body.scrollTop, s = l.doc.documentElement.scrollLeft || l.doc.body.scrollLeft, o = Dt.length;
                    o--;
              ...
              !(function (t) {
                (e[t] = Wt[t] =
                  function (r, i) {
                    return e.is(r, "function") && ((this.events = this.events || []), this.events.push({ name: t, f: r, unbind: It(this.shape || this.node || l.doc, t, r, i || this) })), this;
                  }),
                  (e["un" + t] = Wt["un" + t] =
                    function (r) {
            ...
            (Wt.drag = function (r, i, n, a, s, o) {
              ...
              (Wt.undrag = function () {
                for (var r = Yt.length; r--; ) Yt[r].el == this && (this.unmousedown(Yt[r].start), Yt.splice(r, 1), t.unbind("raphael.drag.*." + this.id));
            ...
            (i.getElementByPoint = function (t, e) {
              ...
              if (l.win.opera && "svg" == c.tagName) {
                var f =
                    ...
                    { y: i.top + (l.win.pageYOffset || s.scrollTop || a.scrollTop) - o, x: i.left + (l.win.pageXOffset || s.scrollLeft || a.scrollLeft) - h }),
                  p = u.createSVGRect();
              ...
              (Wt.getBBox = function (t) {
                ...
                var e = this._;
                return t
                  ? ((!e.dirty && e.bboxwt) || ((this.realPath = Z[this.type](this)), (e.bboxwt = yt(this.realPath)), (e.bboxwt.toString = Ht), (e.dirty = 0)), e.bboxwt)
                      ...
                      (function (t, e, r, i, n, a, s, o, l) {
                        if (!(l < 0 || dt(t, e, r, i, n, a, s, o) < l)) {
                          var h,
                            u = 0.5,
                            c = 1 - u;
                          for (h = dt(t, e, r, i, n, a, s, o, c); B(h - l) > 0.01; ) h = dt(t, e, r, i, n, a, s, o, (c += (h < l ? 1 : -1) * (u /= 2)));
                          return c;
                        }
                      })(t, r, i, n, a, s, o, l, h)
                    );
            ...
            var Jt = (e.easing_formulas = {
              ...
              bounce: function (t) {
                var e = 7.5625,
                  r = 2.75;
                return t < 1 / r ? e * t * t : t < 2 / r ? e * (t -= 1.5 / r) * t + 0.75 : t < 2.5 / r ? e * (t -= 2.25 / r) * t + 0.9375 : e * (t -= 2.625 / r) * t + 0.984375;
              },
            });
              ...
              ee = function () {
                for (var r = +new Date(), i = 0; i < Kt.length; i++) {
                  ...
                  if (!n.el.removed && !n.paused) {
                    ...
                    if (
                      (n.initstatus
                        ? ((l = ((n.initstatus * n.anim.top - n.prev) / (n.percent - n.prev)) * h), (n.status = n.initstatus), delete n.initstatus, n.stop && Kt.splice(i--, 1))
                        ...
                        for (var b in c)
                          if (c[o](b)) {
                            switch (q[b]) {
                              ...
                              case "transform":
                                if (p[b].real)
                                  for (a = [], _ = 0, w = c[b].length; _ < w; _++) for (a[_] = [c[b][_][0]], k = 1, B = c[b][_].length; k < B; k++) a[_][k] = c[b][_][k] + m * h * p[b][_][k];
                                else {
                                  var C = function (t) {
                ...
                if (c) (c.initstatus = s), (c.start = new Date() - c.ms * s);
                  ...
                  for (var S in u)
                    if (u[o](S) && (q[o](S) || i.paper.customAttributes[o](S)))
                      switch (((b[S] = i.attr(S)), null == b[S] && (b[S] = j[S]), (_[S] = u[S]), q[S])) {
                        case T:
                          w[S] = (_[S] - b[S]) / m;
                          break;
                        case "colour":
                        ...
                        case "transform":
                          ...
                          if (R)
                            ...
                            (b[S] = [I.a, I.b, I.c, I.d, I.e, I.f]),
                              Et(D, _[S]),
                              (_[S] = D._.transform),
                              (w[S] = [(D.matrix.a - I.a) / m, (D.matrix.b - I.b) / m, (D.matrix.c - I.c) / m, (D.matrix.d - I.d) / m, (D.matrix.e - I.e) / m, (D.matrix.f - I.f) / m]);
                          }
                          break;
                        case "csv":
                          var O = x(u[S])[v](n),
                  ...
                  if (
                    ...
                    Kt.push(k),
                    s && !c && !p && ((k.stop = !0), (k.start = new Date() - m * s), 1 == Kt.length))
                  )
                    return ee();
            ...
            return (
              (fe.attr = function (t, r) {
                if (t && e.is(t, A) && e.is(t[0], "object")) for (var i = 0, n = t.length; i < n; i++) this.items[i].attr(t[i]);
        ...
        void 0 ===
          (n = function (t) {
            if (!t || t.svg) {
              ...
              var x = function (i, n) {
                  if (n) for (var a in ("string" == typeof i && (i = x(i)), n)) n[e](a) && ("xlink:" == a.substring(0, 6) ? i.setAttributeNS(p, a.substring(6), r(n[a])) : i.setAttribute(a, r(n[a])));
                ...
                v = function (e, n) {
                  ...
                  if (!m) {
                    ...
                    if (((u = u.replace(/[\(\)\s,\xb0#]/g, "_")), e.gradient && u != e.gradient.id && (g.defs.removeChild(e.gradient), delete e.gradient), !e.gradient)) {
                      (m = x(h + "Gradient", { id: u })),
                        (e.gradient = m),
                        x(m, "radial" == h ? { fx: f, fy: p } : { x1: _[0], y1: _[1], x2: _[2], y2: _[3], gradientTransform: e.matrix.invert() }),
                        g.defs.appendChild(m);
                      for (var B = 0, C = k.length; B < C; B++)
                        m.appendChild(
                          x("stop", { offset: k[B].offset ? k[B].offset : B ? "100%" : "0%", "stop-color": k[B].color || "#fff", "stop-opacity": isFinite(k[B].opacity) ? k[B].opacity : 1 })
                        );
                    }
                  }
                ...
                b = function (i, n, a) {
                  if ("path" == i.type) {
                    ...
                    if (
                      ("open" == w ? ((k += 2), (B += 2), (C += 2), (l = 1), (h = a ? 4 : 1), (u = { fill: "none", stroke: m.stroke })) : ((h = l = k / 2), (u = { fill: m.stroke, stroke: "none" })),
                      i._.arrows
                        ? a
                      ...
                      M
                        ...
                        : ((M = x(x("marker"), { id: T, markerHeight: B, markerWidth: k, orient: "auto", refX: h, refY: B / 2 })),
                          (A = x(x("use"), {
                            "xlink:href": "#" + S,
                      ...
                      a ? ((s = i._.arrows.startdx * b || 0), (o = t.getTotalLength(m.path) - E * b)) : ((s = E * b), (o = t.getTotalLength(m.path) - (i._.arrows.enddx * b || 0))),
                        ((u = {})["marker-" + v] = "url(#" + T + ")"),
                      ...
                      a ? ((s = i._.arrows.startdx * b || 0), (o = t.getTotalLength(m.path) - s)) : ((s = 0), (o = t.getTotalLength(m.path) - (i._.arrows.enddx * b || 0))),
                      ...
                      switch (((u[d] = g), d)) {
                        ...
                        case "path":
                          "path" == i.type &&
                            ...
                            (i._.dirty = 1),
                            i._.arrows && ("startString" in i._.arrows && b(i, i._.arrows.startString), "endString" in i._.arrows && b(i, i._.arrows.endString, 1)));
                          break;
                        case "width":
                        ...
                        case "fill":
                          ...
                          if (P.error) {
                            ...
                            delete a.gradient,
                              ...
                              !t.is(u["fill-opacity"], "undefined") && t.is(a["fill-opacity"], "undefined") && x(l, { "fill-opacity": u["fill-opacity"] });
                          P[e]("opacity") && x(l, { "fill-opacity": P.opacity > 1 ? P.opacity / 100 : P.opacity });
                        case "stroke":
                          (P = t.getRGB(g)),
                            l.setAttribute(d, P.hex),
                            "stroke" == d && P[e]("opacity") && x(l, { "stroke-opacity": P.opacity > 1 ? P.opacity / 100 : P.opacity }),
                  ...
                  if ("text" == i.type && (a[e]("text") || a[e]("font") || a[e]("font-size") || a[e]("x") || a[e]("y"))) {
                    ...
                    if (a[e]("text")) {
                      ...
                      for (var h, u = r(a.text).split("\n"), f = [], p = 0, d = u.length; p < d; p++)
                        (h = x("tspan")), p && x(h, { dy: 1.2 * l, x: s.x }), h.appendChild(t._g.doc.createTextNode(u[p])), o.appendChild(h), (f[p] = h);
                    } else for (p = 0, d = (f = o.getElementsByTagName("tspan")).length; p < d; p++) p ? x(f[p], { dy: 1.2 * l, x: s.x }) : x(f[0], { dy: 0 });
              ...
              (S.prototype = T),
                ...
                (T.scale = function (t, e, n, a) {
                  if (this.removed) return this;
                  if (((t = r(t).split(h)).length - 1 && ((e = i(t[1])), (n = i(t[2])), (a = i(t[3]))), (t = i(t[0])), null == e && (e = t), null == a && (n = a), null == n || null == a))
                ...
                (t._engine.create = function () {
                  ...
                  return (
                    (n = n || 0),
                    (a = a || 0),
                    x(l, { height: (o = o || 342), version: 1.1, width: (s = s || 512), xmlns: "http://www.w3.org/2000/svg", "xmlns:xlink": "http://www.w3.org/1999/xlink" }),
                    1 == r
                      ? ((l.style.cssText = h + "position:absolute;left:" + n + "px;top:" + a + "px"), t._g.doc.body.appendChild(l), (i = 1))
                      : ((l.style.cssText = h + "position:relative"), r.firstChild ? r.insertBefore(l, r.firstChild) : r.appendChild(l)),
                ...
                (t._engine.setViewBox = function (t, e, r, i, n) {
                  ...
                  for (
                    null == t ? (this._vbSize && (h = 1), delete this._vbSize, (a = "0 0 " + this.width + f + this.height)) : ((this._vbSize = h), (a = t + f + e + f + r + f + i)),
                      x(this.canvas, { viewBox: a, preserveAspectRatio: p });
                    h && c;

                  )
                    (o = "stroke-width" in c.attrs ? c.attrs["stroke-width"] : 1), c.attr({ "stroke-width": o }), (c._.dirty = 1), (c._.dirtyT = 1), (c = c.prev);
            ...
            if (!t || t.vml) {
                ...
                w = function (t, e, r, i, n, a) {
                  ...
                  if (((f.visibility = "hidden"), e && r)) {
                    ...
                    if ((e < 0 && (d += "x"), r < 0 && (d += " y") && (p = -1), (f.flip = d), (u.coordorigin = i * -g + c + n * -x), h || s.fillsize)) {
                      ...
                      (m = m && m[0]),
                        u.removeChild(m),
                        h && ((v = _(a, o.x(h[0], h[1]), o.y(h[0], h[1]))), (m.position = v.dx * p + c + v.dy * p)),
                ...
                C = function (n, l) {
                  ...
                  if (
                    ...
                    ((l.path && "path" == n.type) || _) &&
                      ...
                      (n._.dirty = 1),
                      "image" == n.type && ((n._.fillpos = [g.x, g.y]), (n._.fillsize = [g.width, g.height]), w(n, 1, 1, 0, 0, 0))),
                ...
                S = function (e, a, s) {
                  ...
                  if (
                    ...
                    (a = (a = r(a).replace(t._radial_gradient, function (t, e, r) {
                      return (
                        (l = "radial"), e && r && ((e = i(e)), (r = i(r)), o(e - 0.5, 2) + o(r - 0.5, 2) > 0.25 && (r = n.sqrt(0.25 - o(e - 0.5, 2)) * (2 * (r > 0.5) - 1) + 0.5), (h = e + c + r)), f
                      );
                    })).split(/\s*\-\s*/)),
                    "linear" == l)
                  ) {
              ...
              (T.prototype = A),
                ...
                (A.scale = function (t, e, n, a) {
                  if (this.removed) return this;
                  if (
                    ((t = r(t).split(h)).length - 1 && ((e = i(t[1])), (n = i(t[2])), (a = i(t[3])), isNaN(n) && (n = null), isNaN(a) && (a = null)),
                    (t = i(t[0])),
                    null == e && (e = t),
                    null == a && (n = a),
                    null == n || null == a)
                ...
                (A.toBack = function () {
                  return this.removed
                    ? this
                    : (this.node.parentNode.firstChild != this.node && (this.node.parentNode.insertBefore(this.node, this.node.parentNode.firstChild), t._toback(this, this.paper)), this);
                }),
                ...
                (t._engine.setViewBox = function (e, r, i, n, a) {
                  ...
                  var s,
                    ...
                    u = l.height;
                  return (
                    a && (i * (s = u / n) < h && (e -= (h - i * s) / 2 / s), n * (o = h / i) < u && (r -= (u - n * o) / 2 / o)),
                ...
                (t._engine.create = function () {
                  ...
                  return (
                    ...
                    1 == r ? (t._g.doc.body.appendChild(l), (h.left = a + "px"), (h.top = s + "px"), (h.position = "absolute")) : r.firstChild ? r.insertBefore(l, r.firstChild) : r.appendChild(l),
