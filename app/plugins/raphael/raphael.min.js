          ...
          (n = function (t) {
            ...
            (e.getRGB = ht(function (t) {
              ...
              var r,
                ...
                h = t.match(E);
              return h
                ? (h[2] && ((n = F(h[2].substring(5), 16)), (i = F(h[2].substring(3, 5), 16)), (r = F(h[2].substring(1, 3), 16))),
                  h[3] && ((n = F((s = h[3].charAt(3)) + s, 16)), (i = F((s = h[3].charAt(2)) + s, 16)), (r = F((s = h[3].charAt(1)) + s, 16))),
                  h[4] &&
                    ((l = h[4][v](D)),
                    (r = z(l[0])),
                    "%" == l[0].slice(-1) && (r *= 2.55),
            ...
            for (
              var zt = function () {
                ...
                Ot = function (e) {
                  for (
                    var r, i = e.clientX, n = e.clientY, a = l.doc.documentElement.scrollTop || l.doc.body.scrollTop, s = l.doc.documentElement.scrollLeft || l.doc.body.scrollLeft, o = qt.length;
                    o--;
              ...
              !(function (t) {
                (e[t] = Wt[t] =
                  function (r, i) {
                    return e.is(r, "function") && ((this.events = this.events || []), this.events.push({ name: t, f: r, unbind: Dt(this.shape || this.node || l.doc, t, r, i || this) })), this;
                  }),
                  (e["un" + t] = Wt["un" + t] =
                    function (r) {
