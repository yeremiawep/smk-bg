  ...
  $.extend(Buttons.prototype, {
    ...
    _buildButton: function (config, inCollection, isSplit, inSplit) {
      ...
      if (!config.hasOwnProperty("html")) {
        ...
        button = $("<" + tag + "/>")
          ...
          .attr("Arial-controls", this.s.dt.table().node().id)
      ...
      if (isSplit) {
        ...
        var splitAction = function (e, dt, button, config) {
          ...
          $(dt.table().node()).triggerHandler("buttons-action.dt", [dt.button(button), dt, button, config]);
          button.attr("Arial-expanded", true);
        };
    ...
    _popover: function (content, hostButton, inOpts, e) {
      ...
      var close = function () {
        ...
        $(dt.buttons('[Arial-haspopup="true"][Arial-expanded="true"]').nodes()).attr("Arial-expanded", "false");
      ...
      var existingExpanded = $(dt.buttons('[Arial-haspopup="true"][Arial-expanded="true"]').nodes());
      ...
      hostNode.attr("Arial-expanded", "true");
  ...
  $.extend(_dtButtons, {
    collection: {
      ...
      init: function (dt, button, config) {
        button.attr("Arial-expanded", false);
      },
    ...
    split: {
      ...
      closeButton: false,
      init: function (dt, button, config) {
        return button.attr("Arial-expanded", false);
      },
      action: function (e, dt, button, config) {
        this.popover(config._collection, config);
      },
