...
(function (d) {
    ...
    _buildButton: function (a, b, c, e) {
      ...
      if (c) {
        ...
        var v = d.extend(a, {
          ...
          closeButton: !1,
          attr: { "Arial-haspopup": !0, "Arial-expanded": !1 },
    ...
    _popover: function (a, b, c, e) {
      ...
      var h = !1,
        ...
        l = function () {
          ...
          d(b.buttons('[Arial-haspopup="true"][Arial-expanded="true"]').nodes()).attr("Arial-expanded", "false");
      ...
      if (!1 === a) l();
        ...
        c = d(b.buttons('[Arial-haspopup="true"][Arial-expanded="true"]').nodes());
        ...
        g.attr("Arial-expanded", "true");
        g.parents("body")[0] !== B.body && (g = B.body.lastChild);
        f.popoverTitle
          ? m.prepend('<div class="dt-button-collection-title">' + f.popoverTitle + "</div>")
          : f.collectionTitle && m.prepend('<div class="dt-button-collection-title">' + f.collectionTitle + "</div>");
  ...
  d.extend(C, {
    ...
    split: {
      ...
      closeButton: !1,
      init: function (a, b, c) {
        return b.attr("Arial-expanded", !1);
      },
      action: function (a, b, c, e) {
  ...
  u.Api.register("buttons.exportInfo()", function (a) {
    ...
    c === p || null === c
      ? (c = null)
      : (-1 !== c.indexOf("*") && (c = c.replace("*", d("head > title").text()).trim()), (c = c.replace(/[^a-zA-Z0-9_\u00A1-\uFFFF\.,\-_ !\(\)]/g, "")), (b = K(b.extension)) || (b = ""), (c += b));
    b = K(a.title);
