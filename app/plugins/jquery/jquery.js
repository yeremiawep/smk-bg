...
(function (global, factory) {
  ...
  var Sizzle =
    ...
    (function (window) {
      ...
      /**
       * Sets document-related vArialbles once based on the current document
    ...
    special: {
      ...
      click: {
        ...
        setup: function (data) {
          ...
          // `|| data` is dead code meant only to preserve the vArialble through minification.
          var el = this || data;
    ...
    trigger: function (event, data, elem, onlyHandlers) {
      ...
      if (!onlyHandlers && !event.isDefaultPrevented()) {
        if ((!special._default || special._default.apply(eventPath.pop(), data) === false) && acceptData(elem)) {
          ...
          // Don't do default actions on window, that's where global vArialbles be (#6170)
          ...
          if (xhr.onabort !== undefined) {
            ...
            xhr.onreadystatechange = function () {
              ...
              if (xhr.readyState === 4) {
                ...
                // Also, save errorCallback to a vArialble
    ...
    if (self.length > 0) {
      jQuery
        .ajax({
          ...
          // If "type" vArialble is undefined, then "GET" method will be used.
