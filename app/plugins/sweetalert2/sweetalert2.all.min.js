!(function (e, t) {
  ...
  const t = "SweetAlert2:",
    ...
    T = (e) => {
      ...
      for (const n in e)
        (t = n), B(t) || a('Unknown parameter "'.concat(t, '"')), e.toast && ((t = n), P.includes(t) && a('The parameter "'.concat(t, '" is incompatible with toasts'))), (t = n), E(t) && o(t, E(t));
      var t;
    };
  var e = (e) => {
    const t = {};
  ...
  const X = { previousBodyPadding: null },
    ...
    fe = '\n <div Arial-labelledby="'
      .concat(p.title, '" Arial-describedby="')
    ...
    Ce = (e) => {
      const t = g();
      t.setAttribute("role", e.toast ? "alert" : "dialog"), t.setAttribute("Arial-live", e.toast ? "polite" : "assertive"), e.toast || t.setAttribute("Arial-modal", "true");
    },
    ke = (e) => {
  ...
  function Ee(e, t, n) {
    se(e, n["show".concat(y(t), "Button")], "inline-block"),
      ...
      e.setAttribute("Arial-label", n["".concat(t, "ButtonArialLabel")]),
      (e.className = p[t]),
  ...
  const Te = (e, t) => {
    ...
    i &&
      ...
      (o = i),
      (n = t.position) in p ? u(o, p[n]) : (a('The "position" parameter is not valid, defaulting to "center"'), u(o, p.center)),
      (n = i),
  ...
  const Se = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
      ...
      Se.forEach((e) => {
        ...
        r.input &&
          (c &&
            ((e) => {
              if (!Ie[e.input])
                return v('Unexpected type of input! Expected "text", "email", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "'.concat(e.input, '"'));
              const t = De(e.input),
                n = Ie[e.input](t, e);
              d(n),
                setTimeout(() => {
        ...
        Ie.url =
          (e, t) => (
            "string" == typeof t.inputValue || "number" == typeof t.inputValue
              ...
              : A(t.inputValue) || a('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(typeof t.inputValue, '"')),
            Me(e, e, t),
            je(e, t),
            (e.type = t.input),
            e
    ...
    Ve = (e, t) => {
      const n = _();
      l(n, t.closeButtonHtml), Q(n, t, "closeButton"), se(n, t.showCloseButton), n.setAttribute("Arial-label", t.closeButtonArialLabel);
    },
    Ne = (e, t) => {
      ...
      return e && t.icon === e.icon
        ...
        ? t.icon && -1 === Object.keys(S).indexOf(t.icon)
          ? (v('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(t.icon, '"')), h(n))
    ...
    ze = (e, t) => {
      var n;
      (e.textContent = ""),
        t.iconHtml ? l(e, Ke(t.iconHtml)) : "success" === t.icon ? l(e, Ue) : "error" === t.icon ? l(e, We) : ((n = { question: "?", warning: "!", info: "i" }), l(e, Ke(n[t.icon])));
    },
    _e = (e, t) => {
      if (t.iconColor) {
    ...
    Xe = (e, t) => {
      var n = m();
      const o = g();
      t.toast ? (ae(n, "width", t.width), (o.style.width = "100%"), o.insertBefore(R(), j())) : ae(o, "width", t.width),
    ...
    Qe = () => {
      ...
      e.forEach((e) => {
        e === m() || e.contains(m()) || (e.hasAttribute("Arial-hidden") && e.setAttribute("data-previous-Arial-hidden", e.getAttribute("Arial-hidden")), e.setAttribute("Arial-hidden", "true"));
      });
    },
    et = () => {
      const e = i(document.body.children);
      e.forEach((e) => {
        e.hasAttribute("data-previous-Arial-hidden")
          ? (e.setAttribute("Arial-hidden", e.getAttribute("data-previous-Arial-hidden")), e.removeAttribute("data-previous-Arial-hidden"))
          : e.removeAttribute("Arial-hidden");
      });
    },
    ...
    ot = (e) => {
      ...
      return (
        i(e.querySelectorAll("swal-button")).forEach((e) => {
          lt(e, ["type", "color", "Arial-label"]);
          var t = e.getAttribute("type");
          (n["".concat(t, "ButtonText")] = e.innerHTML),
            (n["show".concat(y(t), "Button")] = !0),
            e.hasAttribute("color") && (n["".concat(t, "ButtonColor")] = e.getAttribute("color")),
            e.hasAttribute("Arial-label") && (n["".concat(t, "ButtonArialLabel")] = e.getAttribute("Arial-label"));
        }),
        n
      );
    },
    ...
    at = (e) => {
      ...
      return (
        n && (lt(n, ["type", "color"]), n.hasAttribute("type") && (t.icon = n.getAttribute("type")), n.hasAttribute("color") && (t.iconColor = n.getAttribute("color")), (t.iconHtml = n.innerHTML)), t
      );
    },
    rt = (e) => {
      const n = {},
  ...
  function dt(e) {
    (t = e).inputValidator ||
      ...
      ((n = e).target && ("string" != typeof n.target || document.querySelector(n.target)) && ("string" == typeof n.target || n.target.appendChild)) ||
  ...
  const mt = () => {
    ...
    ft = (e) => {
      ...
      return (
        ...
        (n === o || !(ue(o) || "INPUT" === n.tagName || "TEXTAREA" === n.tagName || (ue(D()) && D().contains(n))))
      );
    },
    bt = () => {
      var e;
    ...
    At = (e) => {
      ...
      d(n), t.setAttribute("data-loading", !0), t.setAttribute("Arial-busy", !0), t.focus();
    },
    Pt = (t, n) => {
      const o = g(),
      ...
      C(n.inputOptions) || A(n.inputOptions)
        ...
        ? i(n.inputOptions)
        : v("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(typeof n.inputOptions));
    },
    Bt = (t, n) => {
      const o = t.getInput();
      h(o),
      ...
      if (i)
        if ((i.stopKeydownPropagation && n.stopPropagation(), "Enter" === n.key))
          (e = e),
            (a = n),
            (t = i),
            w(t.allowEnterKey) && !a.isComposing && a.target && e.getInput() && a.target.outerHTML === e.getInput().outerHTML && (["textarea", "file"].includes(t.input) || (Nt(), a.preventDefault()));
        else if ("Tab" !== n.key) {
  ...
  function $t() {
    ...
    if (t) {
      ...
      h(n.loader),
        Z() ? t.icon && d(j()) : ((t = n), (e = t.popup.getElementsByClassName(t.loader.getAttribute("data-button-to-replace"))).length ? d(e[0], "inline-block") : le() && h(t.actions)),
        oe([n.popup, n.actions], p.loading),
        n.popup.removeAttribute("Arial-busy"),
  ...
  function Qt(e, t, n, o) {
    Z() ? on(e, o) : (he(n).then(() => on(e, o)), f.keydownTarget.removeEventListener("keydown", f.keydownHandler, { capture: f.keydownListenerCapture }), (f.keydownHandlerAdded = !1)),
  ...
  var ln = Object.freeze({
    ...
    showValidationMessage: function (e) {
      ...
      o && (o.setAttribute("Arial-invalid", !0), o.setAttribute("Arial-describedby", p["validation-message"]), te(o), u(o, p.inputerror));
    },
    resetValidationMessage: function () {
      var e = b.domCache.get(this);
      e.validationMessage && h(e.validationMessage);
      const t = this.getInput();
      t && (t.removeAttribute("Arial-invalid"), t.removeAttribute("Arial-describedby"), oe(t, p.inputerror));
    },
    ...
    _destroy: function () {
      ...
      t
        ? (e.popup && f.swalCloseEventFinishedCallback && (f.swalCloseEventFinishedCallback(), delete f.swalCloseEventFinishedCallback),
  ...
  const pn = (l, u, d) =>
      new Promise((e, t) => {
        ...
        Gt.swalPromiseResolve.set(l, e),
          ...
          "select" === (t = d).input || "radio" === t.input
            ? Pt(a, t)
            : ["text", "email", "number", "tel", "textarea"].includes(t.input) && (C(t.inputValue) || A(t.inputValue)) && (At(V()), Bt(a, t));
        {
          var r = d;
          const s = m(),
            c = g();
    ...
    gn = (e) => {
      var t = { popup: g(), container: m(), actions: U(), confirmButton: V(), denyButton: N(), cancelButton: F(), loader: R(), closeButton: _(), validationMessage: q(), progressSteps: H() };
