    ...
    a.extend(a.validator, {
      ...
      prototype: {
        ...
        resetForm: function () {
          ...
          var b = this.elements().removeData("previousValue").removeAttr("Arial-invalid");
            ...
            : ((h = a("<" + this.settings.errorElement + ">")
              ...
              h.is("label")
                ...
                : 0 === h.parents("label[for='" + this.escapeCssMeta(i) + "']").length &&
                  ...
                  a(b).attr("Arial-describedby", j),
                  (e = this.groups[b.name]),
                  e &&
                    ((g = this),
                    a.each(g.groups, function (b, c) {
                      c === e && a("[name='" + g.escapeCssMeta(b) + "']", g.currentForm).attr("Arial-describedby", h.attr("id"));
                    })))),
          ...
          a.each(["rangelength", "range"], function () {
            ...
            b[this] &&
              (Array.isArray(b[this])
                ...
                : "string" == typeof b[this] && ((a = b[this].replace(/[\[\]]/g, "").split(/[\s,]+/)), (b[this] = [Number(a[0]), Number(a[1])])));
          }),
