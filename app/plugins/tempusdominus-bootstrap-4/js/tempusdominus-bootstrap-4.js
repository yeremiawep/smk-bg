        ...
        if (!targetMoment) {
          ...
          if (!this._options.allowMultidate || this._dates.length === 1 || isClear) {
            ...
            outpValue =
              (oldDate &&
                outpValue
                  .replace("" + oldDate.format(this.actualFormat) + this._options.multidateSeparator, "")
        ...
        if (this._options.promptTimeOnDateChange) {
          if (!e.oldDate && this._options.useCurrent) {
            ...
            (e.oldDate.format("YYYY-MM-DD") === e.date.format("YYYY-MM-DD") ||
              (e.oldDate.format("YYYY-MM-DD") !== e.date.format("YYYY-MM-DD") && e.oldDate.format("HH:mm:ss") !== e.date.format("HH:mm:ss")))
          ) {
    ...
    var TempusDominusBootstrap4 = /*#__PURE__*/ (function (_DateTimePicker) {
      ...
      _proto2._getDatePickerTemplate = function _getDatePickerTemplate() {
        var headTemplate = $("<thead>").append(
            $("<tr>")
              .append($("<th>").addClass("prev").attr("data-action", "previous").append(this._iconTag(this._options.icons.previous)))
              .append(
                $("<th>")
              ...
              .append($("<th>").addClass("next").attr("data-action", "next").append(this._iconTag(this._options.icons.next)))
          ),
          contTemplate = $("<tbody>").append($("<tr>").append($("<td>").attr("colspan", "" + (this._options.calendarWeeks ? "8" : "7"))));
        return [
          $("<div>")
            .addClass("datepicker-days")
            .append($("<table>").addClass("table table-sm").append(headTemplate).append($("<tbody>"))),
      ...
      _proto2._updateDecades = function _updateDecades() {
        ...
        while (!startDecade.isAfter(endDecade, "y")) {
          ...
          html +=
            ...
            (lastPickedDate && lastPickedDate.isAfter(startDecade) && lastPickedDate.year() <= endDecadeYear ? " active" : "") +
      ...
      _proto2.widgetPositioning = function widgetPositioning(_widgetPositioning) {
        ...
        if ({}.toString.call(_widgetPositioning) !== "[object Object]") {
          throw new TypeError("widgetPositioning() expects an object vArialble");
        }

        if (_widgetPositioning.horizontal) {
          if (typeof _widgetPositioning.horizontal !== "string") {
            throw new TypeError("widgetPositioning() horizontal vArialble must be a string");
          }
        ...
        if (_widgetPositioning.vertical) {
          if (typeof _widgetPositioning.vertical !== "string") {
            throw new TypeError("widgetPositioning() vertical vArialble must be a string");
          }
