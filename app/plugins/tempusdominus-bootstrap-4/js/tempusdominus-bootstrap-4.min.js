    ...
    (x = (function (d) {
      ...
      return (
        ...
        (i.widgetPositioning = function (t) {
          ...
          if ("[object Object]" !== {}.toString.call(t)) throw new TypeError("widgetPositioning() expects an object vArialble");
          if (t.horizontal) {
            if ("string" != typeof t.horizontal) throw new TypeError("widgetPositioning() horizontal vArialble must be a string");
          ...
          if (t.vertical) {
            if ("string" != typeof t.vertical) throw new TypeError("widgetPositioning() vertical vArialble must be a string");
