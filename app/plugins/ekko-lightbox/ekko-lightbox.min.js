      ...
      g = (function () {
        function d(c, e) {
          ...
          var h = '<h4 class="modal-title">' + (this._config.title || "&nbsp;") + "</h4>",
            i = '<button type="button" class="close" data-dismiss="modal" Arial-label="' + this._config.strings.close + '"><span Arial-hidden="true">&times;</span></button>',
          ...
          a(this._config.doc.body).append('<div id="' + this._modalId + '" class="ekko-lightbox modal fade" tabindex="-1" tabindex="-1" role="dialog" Arial-hidden="true">' + m + "</div>"),
              ...
              },
              {
                ...
                value: function (b) {
                  return b < 0 || b > this._$galleryItems.length - 1
                    ? this
                    : ((this._galleryIndex = b), this.updateNavigation(), (this._$element = a(this._$galleryItems.get(this._galleryIndex))), void this._handle());
                },
              },
              {
                key: "navigateLeft",
