    ...
    return (
      (() => {
        ...
        var Re = Ne('<div class="note-editor note-frame card"/>'),
          ...
          Fe = Ne('<textarea class="note-codable" Arial-multiline="true"/>'),
          De = Ne('<div class="note-editable card-block" contentEditable="true" role="textbox" Arial-multiline="true"/>'),
          He = Ne(
            [
          ...
          We = Ne('<div class="modal note-modal" Arial-hidden="false" tabindex="-1" role="dialog"/>', function (t, e) {
                ...
                [
                  ...
                  e.title
                    ? '<div class="modal-header"><h4 class="modal-title">' +
                      e.title +
                      '</h4><button type="button" class="btn-close" data-bs-dismiss="modal" Arial-label="Close" Arial-hidden="true"></button></div>'
                    : "",
