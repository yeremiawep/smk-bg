    ...
    return (
      (() => {
        ...
        const v = {
          ...
          rect2bnd: function (t) {
            var o = e()(document);
            return { top: t.top + o.scrollTop(), left: t.left + o.scrollLeft(), width: t.right - t.left, height: t.bottom - t.top };
          },
        ...
        function nt(t, e) {
          ...
          if (O(t.node) === t.offset) {
            ...
            if (((n = 0), j((o = t.node.childNodes[t.offset])))) return j(t.node.nextSibling) ? null : { node: t.node.nextSibling, offset: n };
            ...
            (n = [
                    ...
                    ht.walkPoint(
                      ...
                      function (e) {
                        ...
                        ht.isEditable(e.node) ||
                          (n ? (ht.isLeftEdgePoint(e) && s.push(e.node), ht.isRightEdgePoint(e) && y.contains(s, e.node) && (i = e.node)) : (i = o ? ht.ancestor(e.node, t) : e.node),
                          i && t(i) && a.push(i));
                      },
                      !0
                    ),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    ...
                    ht.isText(this.sc) && !ht.isEdgePoint(this.getStartPoint()) && ((o.sc = this.sc.splitText(this.so)), (o.so = 0), e && ((o.ec = o.sc), (o.eo = this.eo - this.so))),
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  return (
                    o.rightNode
                      ? (o.rightNode.parentNode.insertBefore(t, o.rightNode), ht.isEmpty(o.rightNode) && ht.isPara(t) && o.rightNode.parentNode.removeChild(o.rightNode))
              ...
              },
              {
                key: "paraBookmark",
                value: function (t) {
                  return { s: { path: y.tail(ht.makeOffsetPath(y.head(t), this.sc)), offset: this.so }, e: { path: y.tail(ht.makeOffsetPath(y.last(t), this.ec)), offset: this.eo } };
                },
              },
              {
                key: "getClientRects",
        ...
        const kt = {
          ...
          createFromNode: function (t) {
            ...
            return (
              ...
              ht.isBR(n) ? ((i = ht.listPrev(n).length - 1), (n = n.parentNode)) : ht.isVoid(n) && ((i = ht.listPrev(n).length), (n = n.parentNode)),
              this.create(e, o, n, i)
            );
          },
                  ...
                  return (
                    e().each(t, function (t, r) {
                      ...
                      if ("LI" === l.parentNode.nodeName)
                        ...
                        (r = o ? ht.listDescendant(d, ht.isLi) : y.from(d.childNodes).filter(ht.isLi)),
              ...
              },
              {
                ...
                value: function (t, o) {
                  ...
                  if (i) {
                    ...
                    var r = null;
                    if (
                      (1 === this.options.blockquoteBreakingLevel ? (r = ht.ancestor(i, ht.isBlockquote)) : 2 === this.options.blockquoteBreakingLevel && (r = ht.lastAncestor(i, ht.isBlockquote)), r)
                    ) {
                ...
                value: function (t, o) {
                  for (
                    var n = ht.ancestor(t.commonAncestor(), ht.isCell),
                      ...
                      a = e()("<tr" + r + "></tr>"),
                      s = new Rt(n, Rt.where.Row, Rt.requestAction.Add, e()(i).closest("table")[0]).getActionList(),
                      l = 0;
                    l < s.length;
                    l++
                  ) {
                ...
                value: function (t) {
                  for (
                    var o = ht.ancestor(t.commonAncestor(), ht.isCell),
                      ...
                      r = n[0].rowIndex,
                      a = new Rt(o, Rt.where.Row, Rt.requestAction.Delete, e()(n).closest("table")[0]).getActionList(),
                      s = 0;
                    s < a.length;
                    s++
                  )
                ...
                value: function (t) {
                  for (
                    var o = ht.ancestor(t.commonAncestor(), ht.isCell),
                      n = e()(o).closest("tr"),
                      i = n.children("td, th").index(e()(o)),
                      r = new Rt(o, Rt.where.Column, Rt.requestAction.Delete, e()(n).closest("table")[0]).getActionList(),
                      a = 0;
                    a < r.length;
                    a++
                  )
              ...
              (this.createLink = this.wrapCommand(function (t) {
                ...
                if (!(l > 0 && n.isLimited(l))) {
                  ...
                  "string" == typeof o && (o = o.trim()),
                    n.options.onCreateLink ? (o = n.options.onCreateLink(o)) : a && (o = /^([A-Za-z][A-Za-z0-9+-.]*\:|#|\/)/.test(o) ? o : n.options.defaultProtocol + o);
                  var u = [];
                  if (c) {
            ...
            (n = [
              ...
              },
              {
                ...
                value: function (t, e) {
                  return (
                    (t = t || 0),
                    (void 0 === e || !(wt.isMove(e.keyCode) || wt.isNavigation(e.keyCode) || e.ctrlKey || e.metaKey || y.contains([wt.code.BACKSPACE, wt.code.DELETE], e.keyCode))) &&
              ...
              },
              {
                ...
                value: function (t) {
                  t
                    ? (this.lastRange = t)
                    : ((this.lastRange = kt.create(this.editable)), 0 === e()(this.lastRange.sc).closest(".note-editable").length && (this.lastRange = kt.createFromBodyElement(this.editable)));
                },
              },
              {
                key: "getLastRange",
              ...
              },
              {
                ...
                value: function (t, o) {
                  ...
                  e()
                    ...
                    .then(function (t) {
                      i.beforeCommand(),
                        "function" == typeof o ? o(t) : ("string" == typeof o && t.attr("data-filename", o), t.css("width", Math.min(i.$editable.width(), t.width()))),
                        t.show(),
                ...
                value: function (t) {
                  ...
                  e().each(t, function (t, n) {
                    ...
                    o.options.maximumImageFileSize && o.options.maximumImageFileSize < n.size
                      ? o.context.triggerEvent("image.upload.error", o.lang.image.maximumFileSizeError)
                      : (function (t) {
                          return e()
                            .Deferred(function (o) {
                              e()
                ...
                value: function (t) {
                  ...
                  if (o && o.items && o.items.length) {
                    ...
                    "file" === n.kind && -1 !== n.type.indexOf("image/")
                      ? (this.context.invoke("editor.insertImagesOrCallback", [n.getAsFile()]), t.preventDefault())
                      : "string" === n.kind && this.context.invoke("editor.isLimited", o.getData("Text").length) && t.preventDefault();
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (this.documentEventHandlers.onDragenter = function (e) {
                    ...
                    i || o.length || !r || (t.$editor.addClass("dragover"), t.$dropzone.width(t.$editor.width()), t.$dropzone.height(t.$editor.height()), n.text(t.lang.image.dragImageHere)),
                      (o = o.add(e.target));
                  }),
          ...
          return (
            ...
            (n = [
              ...
              },
              {
                ...
                value: function (t) {
                  return (
                    Object.prototype.hasOwnProperty.call(this.fontInstalledMap, t) || (this.fontInstalledMap[t] = f.isFontInstalled(t) || y.contains(this.options.fontNamesIgnoreCheck, t)),
                      ...
                      children: [
                        this.button({
                          ...
                          click: function (t) {
                            ...
                            n && i
                              ? r.context.invoke("editor.color", { backColor: o.attr("data-backColor"), foreColor: o.attr("data-foreColor") })
                              : n
                              ? r.context.invoke("editor.color", { backColor: o.attr("data-backColor") })
                              : i && r.context.invoke("editor.color", { foreColor: o.attr("data-foreColor") });
                          },
                          callback: function (t) {
                        ...
                        this.ui.dropdown({
                          ...
                          callback: function (t) {
                            t.find(".note-holder").each(function (t, o) {
                              ...
                              n.append(
                                r.ui
                                  .palette({ colors: r.options.colors, colorsName: r.options.colorsName, eventName: n.data("event"), container: r.options.container, tooltip: r.options.tooltip })
                                  .render()
                              );
                            });
                            ...
                            t.find(".note-holder-custom").each(function (t, n) {
                              ...
                              t.find("input[type=color]").each(function (o, n) {
                                e()(n).change(function () {
                                  ...
                                  o.css("background-color", n).attr("Arial-label", n).attr("data-value", n).attr("data-original-title", n), o.click();
                                });
                              });
                          },
                          click: function (o) {
                            ...
                            if ("openPalette" === a) {
                              var l = n.find("#" + s),
                                ...
                                d = l.val();
                              u.css("background-color", d).attr("Arial-label", d).attr("data-value", d).attr("data-original-title", d), c.prepend(u), l.click();
                            } else {
                ...
                value: function () {
                  ...
                  this.context.memo("button.justifyLeft", v.invoke(r, "render")),
                    ...
                    this.context.memo("button.redo", function () {
                      return t
                        .button({ contents: t.ui.icon(t.options.icons.redo), tooltip: t.lang.history.redo + t.representShortcut("redo"), click: t.context.createInvokeHandler("editor.redo") })
                        .render();
                    }),
                    this.context.memo("button.undo", function () {
                      return t
                        .button({ contents: t.ui.icon(t.options.icons.undo), tooltip: t.lang.history.undo + t.representShortcut("undo"), click: t.context.createInvokeHandler("editor.undo") })
                        .render();
                    }),
                ...
                value: function () {
                  ...
                  this.context.memo("button.resizeFull", function () {
                    ...
                    this.context.memo("button.resizeQuarter", function () {
                      return t
                        .button({ contents: '<span class="note-fontsize-10">25%</span>', tooltip: t.lang.image.resizeQuarter, click: t.context.createInvokeHandler("editor.resize", "0.25") })
                        .render();
                    }),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.context.memo("button.addRowUp", function () {
                    return t
                      .button({ className: "btn-md", contents: t.ui.icon(t.options.icons.rowAbove), tooltip: t.lang.table.addRowAbove, click: t.context.createInvokeHandler("editor.addRow", "top") })
                      .render();
                  }),
                    ...
                    this.context.memo("button.deleteRow", function () {
                      return t
                        .button({ className: "btn-md", contents: t.ui.icon(t.options.icons.rowRemove), tooltip: t.lang.table.delRow, click: t.context.createInvokeHandler("editor.deleteRow") })
                        .render();
                    }),
                    this.context.memo("button.deleteCol", function () {
                      return t
                        .button({ className: "btn-md", contents: t.ui.icon(t.options.icons.colRemove), tooltip: t.lang.table.delCol, click: t.context.createInvokeHandler("editor.deleteCol") })
                        .render();
                    }),
                    this.context.memo("button.deleteTable", function () {
                      return t
                        .button({ className: "btn-md", contents: t.ui.icon(t.options.icons.trash), tooltip: t.lang.table.delTable, click: t.context.createInvokeHandler("editor.deleteTable") })
                        .render();
                    });
                },
              },
              ...
              },
              {
                ...
                value: function () {
                  ...
                  !this.isFollowing && a > l && a < c - n
                    ? ((this.isFollowing = !0), this.$editable.css({ marginTop: this.$toolbar.outerHeight() }), this.$toolbar.css({ position: "fixed", top: r, width: o, zIndex: 1e3 }))
                    : this.isFollowing &&
                      (a < l || a > c) &&
                      ...
                      o.ui.onDialogShown(o.$dialog, function () {
                        ...
                        s.prop("checked", c),
                          r.one("click", function (r) {
                            r.preventDefault(), e.resolve({ range: t.range, url: i.val(), text: n.val(), isNewWindow: a.is(":checked"), checkProtocol: s.is(":checked") }), o.ui.hideDialog(o.$dialog);
                          });
                      }),
                ...
                value: function (t, o) {
                  if (ht.isImg(t)) {
                    var n = e()(t).offset(),
                      ...
                      r = {};
                    this.options.popatmouse ? ((r.left = o.pageX - 20), (r.top = o.pageY)) : (r = n),
                      (r.top -= i.top),
                      (r.left -= i.left),
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  if (n && 11 === n[1].length) {
                    ...
                    var $ = 0;
                    "undefined" !== u[6] && ($ = u[6]),
                      (o = e()('<iframe allowfullscreen sandbox="allow-same-origin allow-scripts allow-popups">')
                        .attr("frameborder", 0)
                        .attr("src", "//" + u[1] + "/videos/embed/" + u[2] + "?loop=" + T + "&autoplay=" + E + "&muted=" + $ + (x > 0 ? "&start=" + x : "") + (S > 0 ? "&end=" + b : ""))
                        .attr("width", "560")
                        .attr("height", "315"));
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  if (!o.range || (o.range.isCollapsed() && !t)) this.hide();
                    ...
                    (n.top -= i.top),
                      (n.left -= i.left),
                      this.$popover.css({ display: "block", left: Math.max(n.left, 0) + -5, top: n.top + 5 }),
              ...
              },
              {
                ...
                value: function (t, o) {
                  ...
                  return o.map(function (o) {
                    ...
                    return i.append(n.template ? n.template(o) : o + ""), i.data({ index: t, item: o }), i;
                  });
                },
              },
              {
        ...
        const Re = (function () {
          function t(o, n) {
            if (
              ...
              (this.$node = o),
              (this.options = e().extend({}, { title: "", target: n.container, trigger: "hover focus", placement: "bottom" }, n)),
              (this.$tooltip = e()(['<div class="note-tooltip">', '<div class="note-tooltip-arrow"></div>', '<div class="note-tooltip-content"></div>', "</div>"].join(""))),
        ...
        var Be = Ie('<div class="note-editor note-frame"></div>'),
          ...
          Oe = Ie('<textarea class="note-codable" Arial-multiline="true"></textarea>'),
          je = Ie('<div class="note-editable" contentEditable="true" role="textbox" Arial-multiline="true"></div>'),
          Ue = Ie(
            [
          ...
          qe = Ie('<button type="button" class="note-btn" tabindex="-1"></button>', function (t, o) {
            o &&
              o.tooltip &&
              (t.attr({ "Arial-label": o.tooltip }),
              t.data("_lite_tooltip", new Re(t, { title: o.tooltip, container: o.container })).on("click", function (t) {
                e()(t.currentTarget).data("_lite_tooltip").hide();
              })),
              o.contents && t.html(o.contents),
              o && o.data && "dropdown" === o.data.toggle && t.data("_lite_dropdown", new Fe(t, { container: o.container })),
            ...
            var n = Array.isArray(o.items)
              ? o.items.map(function (t) {
                  var n = "string" == typeof t ? t : t.value || "",
                    ...
                    r = e()('<a class="note-dropdown-item" href="#" data-value="' + n + '" role="listitem" Arial-label="' + n + '"></a>');
                  return r.html(i).data("item", t), r;
                })
              : o.items;
            t.html(n).attr({ "Arial-label": o.title }),
          ...
          Ge = Ie('<div class="note-dropdown-menu note-check" role="list"></div>', function (t, o) {
            var n = Array.isArray(o.items)
              ? o.items.map(function (t) {
                  var n = "string" == typeof t ? t : t.value || "",
                    i = o.template ? o.template(t) : t,
                    r = e()('<a class="note-dropdown-item" href="#" data-value="' + n + '" role="listitem" Arial-label="' + t + '"></a>');
          ...
          Ze = function (t, e) {
            return Ve(
              [
                qe({ className: "dropdown-toggle", contents: t.title + " " + lo("note-icon-caret"), tooltip: t.tooltip, data: { toggle: "dropdown" } }),
                _e({ className: t.className, items: t.items, template: t.template, itemClick: t.itemClick }),
              ],
              { callback: e }
            ).render();
          },
          Xe = function (t, e) {
            return Ve(
              [
                qe({ className: "dropdown-toggle", contents: t.title + " " + lo("note-icon-caret"), tooltip: t.tooltip, data: { toggle: "dropdown" } }),
                Ge({ className: t.className, checkClassName: t.checkClassName, items: t.items, template: t.template, itemClick: t.itemClick }),
              ],
              { callback: e }
            ).render();
          },
          Qe = function (t) {
            return Ve([
              qe({ className: "dropdown-toggle", contents: t.title + " " + lo("note-icon-caret"), tooltip: t.tooltip, data: { toggle: "dropdown" } }),
              _e([Ve({ className: "note-align", children: t.items[0] }), Ve({ className: "note-list", children: t.items[1] })]),
            ]).render();
          },
          Je = function (t) {
            return Ve(
          ...
          eo = function (t, o) {
            return Ve({
              ...
              children: [
                ...
                qe({ className: "dropdown-toggle", contents: lo("note-icon-caret"), tooltip: t.lang.color.more, data: { toggle: "dropdown" } }),
                _e({
                  items: [
                    "<div>",
                  ...
                  callback: function (n) {
                    n.find(".note-holder").each(function () {
                      ...
                      "fore" === o
                        ...
                        : "back" === o && (n.find(".btn-foreground-color").hide(), n.css({ "min-width": "210px" }));
                  },
                  click: function (n) {
                    var i = e()(n.target),
                      r = i.data("event"),
          ...
          oo = Ie('<div class="note-modal" Arial-hidden="false" tabindex="-1" role="dialog"></div>', function (t, e) {
            e.fade && t.addClass("fade"),
              t.attr({ "Arial-label": e.title }),
              t.html(
                [
          ...
          so = Ie('<div class="checkbox"></div>', function (t, e) {
            t.html(
              [
                ...
                e.checked ? " checked" : "",
                ' Arial-checked="' + (e.checked ? "true" : "false") + '"/>',
                e.text ? e.text : "",
                "</label>",
              ].join("")
            );
