        ...
        var markup = Array.isArray(options.items)
          ? options.items
              .map(function (item) {
                ...
                return '<li Arial-label="' + value + '"><a href="#" ' + (dataValue + dataOption) + ">" + content + "</a></li>";
              })
              .join("")
          : options.items;
        ...
        var markup = Array.isArray(options.items)
          ? options.items
              .map(function (item) {
                var value = typeof item === "string" ? item : item.value || "";
                var content = options.template ? options.template(item) : item;
                return '<li Arial-label="' + item + '"><a href="#" data-value="' + value + '">' + icon(options.checkClassName) + " " + content + "</a></li>";
              })
              .join("")
          : options.items;
        $node.html(markup).attr({
