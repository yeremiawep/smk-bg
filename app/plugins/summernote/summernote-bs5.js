...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  return /******/ (() => {
    ...
    (() => {
      ...
      var codable = renderer.create('<textarea class="note-codable" Arial-multiline="true"/>');
      var editable = renderer.create('<div class="note-editable card-block" contentEditable="true" role="textbox" Arial-multiline="true"/>');
      ...
      var dialog = renderer.create('<div class="modal note-modal" Arial-hidden="false" tabindex="-1" role="dialog"/>', function ($node, options) {
        if (options.fade) {
          $node.addClass("fade");
        }
          ...
          [
            ...
            options.title
              ? '<div class="modal-header">' +
                ...
                options.title +
                "</h4>" +
                '<button type="button" class="btn-close" data-bs-dismiss="modal" Arial-label="Close" Arial-hidden="true"></button>' +
                "</div>"
              : "",
      ...
      var popover = renderer.create(
        ['<div class="note-popover popover show">', '<div class="popover-arrow"></div>', '<div class="popover-body note-children-container"></div>', "</div>"].join(""),
