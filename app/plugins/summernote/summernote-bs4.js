...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  return /******/ (() => {
    ...
    (() => {
      ...
      var editable = renderer.create('<div class="note-editable card-block" contentEditable="true" role="textbox" Arial-multiline="true"></div>');
        ...
        var markup = Array.isArray(options.items)
          ? options.items
              .map(function (item) {
                ...
                return '<a class="dropdown-item" href="#" ' + (dataValue + dataOption) + ' role="listitem" Arial-label="' + value + '">' + content + "</a>";
              })
              .join("")
          : options.items;
        ...
        var markup = Array.isArray(options.items)
          ? options.items
              .map(function (item) {
                var value = typeof item === "string" ? item : item.value || "";
                var content = options.template ? options.template(item) : item;
                return '<a class="dropdown-item" href="#" data-value="' + value + '" role="listitem" Arial-label="' + item + '">' + icon(options.checkClassName) + " " + content + "</a>";
              })
              .join("")
          : options.items;
        $node.html(markup).attr({
      ...
      var dialog = renderer.create('<div class="modal note-modal" Arial-hidden="false" tabindex="-1" role="dialog"></div>', function ($node, options) {
        if (options.fade) {
          $node.addClass("fade");
        }
          ...
          [
            ...
            options.title
              ? '<div class="modal-header">' +
                ...
                options.title +
                "</h4>" +
                '<button type="button" class="close" data-dismiss="modal" Arial-label="Close" Arial-hidden="true">&times;</button>' +
                "</div>"
              : "",
      ...
      var popover = renderer.create(
        ['<div class="note-popover popover in">', '<div class="arrow"></div>', '<div class="popover-content note-children-container"></div>', "</div>"].join(""),
      ...
      var summernote_bs4_checkbox = renderer.create('<div class="form-check"></div>', function ($node, options) {
        $node.html(
          [
            ...
            ' Arial-label="' + (options.text ? options.text : "") + '"',
