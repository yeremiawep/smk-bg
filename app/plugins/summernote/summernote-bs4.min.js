    ...
    return (
      (() => {
            ...
            (o = [
                    ...
                    ht.walkPoint(
                      ...
                      function (e) {
                        ...
                        ht.isEditable(e.node) ||
                          (o ? (ht.isLeftEdgePoint(e) && s.push(e.node), ht.isRightEdgePoint(e) && k.contains(s, e.node) && (i = e.node)) : (i = n ? ht.ancestor(e.node, t) : e.node),
                          i && t(i) && a.push(i));
                      },
                      !0
                    ),
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  return (
                    n.rightNode
                      ? (n.rightNode.parentNode.insertBefore(t, n.rightNode), ht.isEmpty(n.rightNode) && ht.isPara(t) && n.rightNode.parentNode.removeChild(n.rightNode))
            ...
            (o = [
              ...
              },
              {
                ...
                value: function (t) {
                  t
                    ? (this.lastRange = t)
                    : ((this.lastRange = yt.create(this.editable)), 0 === e()(this.lastRange.sc).closest(".note-editable").length && (this.lastRange = yt.createFromBodyElement(this.editable)));
                },
              },
              {
                key: "getLastRange",
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (this.documentEventHandlers.onDragenter = function (e) {
                    ...
                    i || n.length || !r || (t.$editor.addClass("dragover"), t.$dropzone.width(t.$editor.width()), t.$dropzone.height(t.$editor.height()), o.text(t.lang.image.dragImageHere)),
                      (n = n.add(e.target));
                  }),
          ...
          return (
            ...
            (o = [
              ...
              },
              {
                ...
                value: function (t) {
                  return (
                    Object.prototype.hasOwnProperty.call(this.fontInstalledMap, t) || (this.fontInstalledMap[t] = f.isFontInstalled(t) || k.contains(this.options.fontNamesIgnoreCheck, t)),
                        ...
                        this.ui.dropdown({
                          ...
                          callback: function (t) {
                            t.find(".note-holder").each(function (t, n) {
                              ...
                              o.append(
                                r.ui
                                  .palette({ colors: r.options.colors, colorsName: r.options.colorsName, eventName: o.data("event"), container: r.options.container, tooltip: r.options.tooltip })
                                  .render()
                              );
                            });
                            ...
                            t.find(".note-holder-custom").each(function (t, o) {
                              ...
                              t.find("input[type=color]").each(function (n, o) {
                                e()(o).change(function () {
                                  ...
                                  n.css("background-color", o).attr("Arial-label", o).attr("data-value", o).attr("data-original-title", o), n.click();
                                });
                              });
                          },
                          click: function (n) {
                ...
                value: function (t, n) {
                  if (ht.isImg(t)) {
                    var o = e()(t).offset(),
                      ...
                      r = {};
                    this.options.popatmouse ? ((r.left = n.pageX - 20), (r.top = n.pageY)) : (r = o),
                      (r.top -= i.top),
                      (r.left -= i.left),
          ...
          return (
            ...
            (o = [
              ...
              },
              {
                ...
                value: function (t) {
                  var n,
                    o = t.match(/\/\/(?:(?:www|m)\.)?(?:youtu\.be\/|youtube\.com\/(?:embed\/|v\/|watch\?v=|watch\?.+&v=))([\w|-]{11})(?:(?:[\?&]t=)(\S+))?$/),
        ...
        var Re = Ne('<div class="note-editor note-frame card"></div>'),
          ...
          Fe = Ne('<textarea class="note-codable" Arial-multiline="true"></textarea>'),
          De = Ne('<div class="note-editable card-block" contentEditable="true" role="textbox" Arial-multiline="true"></div>'),
          He = Ne(
            [
            ...
            var n = Array.isArray(e.items)
              ? e.items
                  .map(function (t) {
                    ...
                    return (
                      '<a class="dropdown-item" href="#" ' + ('data-value="' + n + '"' + (void 0 !== i ? ' data-option="' + i + '"' : "")) + ' role="listitem" Arial-label="' + n + '">' + o + "</a>"
                    );
                  })
                  .join("")
              : e.items;
            t.html(n).attr({ "Arial-label": e.title }), e && e.codeviewKeepButton && t.addClass("note-codeview-keep");
          }),
          Ue = function (t) {
            return t;
          },
            ...
            var n = Array.isArray(e.items)
              ? e.items
                  .map(function (t) {
                    var n = "string" == typeof t ? t : t.value || "",
                      o = e.template ? e.template(t) : t;
                    return '<a class="dropdown-item" href="#" data-value="' + n + '" role="listitem" Arial-label="' + t + '">' + qe(e.checkClassName) + " " + o + "</a>";
                  })
                  .join("")
              : e.items;
            t.html(n).attr({ "Arial-label": e.title }), e && e.codeviewKeepButton && t.addClass("note-codeview-keep");
          }),
          We = Ne('<div class="modal note-modal" Arial-hidden="false" tabindex="-1" role="dialog"></div>', function (t, e) {
                ...
                [
                  ...
                  e.title
                    ? '<div class="modal-header"><h4 class="modal-title">' +
                      e.title +
                      '</h4><button type="button" class="close" data-dismiss="modal" Arial-label="Close" Arial-hidden="true">&times;</button></div>'
                    : "",
              ...
              button: function (n, o) {
                return Ne('<button type="button" class="note-btn btn btn-light btn-sm" tabindex="-1"></button>', function (n, o) {
                  o &&
                    o.tooltip &&
                    n
                      .attr({ title: o.tooltip, "Arial-label": o.tooltip })
