...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  return /******/ (() => {
    ...
    /******/ var __webpack_modules__ = {
      /***/ 9770: /***/ (__unused_webpack_module, __unused_webpack___webpack_exports__, __webpack_require__) => {
    ...
    (() => {
                      ...
                      if (position === "top") {
                        ...
                        if (isTopFromRowSpan) {
                          var newTd = external_jQuery_default()("<div></div>")
                            .append(external_jQuery_default()("<td" + tdAttributes + ">" + dom.blank + "</td>").removeAttr("rowspan"))
                            .html();
                          html.append(newTd);
                          break;
                        }
                      ...
                      callback: function callback($dropdown) {
                        ...
                        $dropdown.find("input[type=color]").each(function (idx, item) {
                          external_jQuery_default()(item).change(function () {
                            ...
                            $chip.css("background-color", color).attr("Arial-label", color).attr("data-value", color).attr("data-original-title", color);
                            $chip.click();
                          });
                        });
                      },
          ...
          },
          {
            ...
            value: function createVideoNode(url) {
              ...
              if (ytMatch && ytMatch[1].length === 11) {
                ...
                $video = external_jQuery_default()("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>")
                  .attr("frameborder", 0)
                ...
                $video = external_jQuery_default()('<iframe allowfullscreen sandbox="allow-same-origin allow-scripts allow-popups">')
                  .attr("frameborder", 0)
                  .attr(
                    "src",
                    "//" +
      ...
      external_jQuery_default().summernote = external_jQuery_default().extend(external_jQuery_default().summernote, {
        ...
        options: {
          ...
          fontNames: ["Ariall", "Ariall Black", "Comic Sans MS", "Courier New", "Helvetica Neue", "Helvetica", "Impact", "Lucida Grande", "Tahoma", "Times New Roman", "Verdana"],
      ...
      var codable = renderer.create('<textarea class="note-codable" Arial-multiline="true"></textarea>');
      var editable = renderer.create('<div class="note-editable" contentEditable="true" role="textbox" Arial-multiline="true"></div>');
      var statusbar = renderer.create(
        [
          '<output class="note-status-output" role="status" Arial-live="polite"></output>',
          '<div class="note-statusbar" role="status">',
          '<div class="note-resizebar" Arial-label="resize">',
      ...
      var airEditable = renderer.create(
        ['<div class="note-editable" contentEditable="true" role="textbox" Arial-multiline="true"></div>', '<output class="note-status-output" role="status" Arial-live="polite"></output>'].join("")
      );
      ...
      var dropdown = renderer.create('<div class="note-dropdown-menu" role="list"></div>', function ($node, options) {
        var markup = Array.isArray(options.items)
          ? options.items.map(function (item) {
              ...
              var $temp = external_jQuery_default()('<a class="note-dropdown-item" href="#" data-value="' + value + '" role="listitem" Arial-label="' + value + '"></a>');
              $temp.html(content).data("item", item);
              return $temp;
            })
          : options.items;
        $node.html(markup).attr({
          "Arial-label": options.title,
        });
      ...
      var dropdownCheck = renderer.create('<div class="note-dropdown-menu note-check" role="list"></div>', function ($node, options) {
        var markup = Array.isArray(options.items)
          ? options.items.map(function (item) {
              var value = typeof item === "string" ? item : item.value || "";
              var content = options.template ? options.template(item) : item;
              var $temp = external_jQuery_default()('<a class="note-dropdown-item" href="#" data-value="' + value + '" role="listitem" Arial-label="' + item + '"></a>');
      ...
      var dialog = renderer.create('<div class="note-modal" Arial-hidden="false" tabindex="-1" role="dialog"></div>', function ($node, options) {
        if (options.fade) {
          $node.addClass("fade");
        }
        ...
        $node.html(
          [
            ...
            options.title
              ? '<div class="note-modal-header"><button type="button" class="close" Arial-label="Close" Arial-hidden="true"><i class="note-icon-close"></i></button><h4 class="note-modal-title">' +
                options.title +
                "</h4></div>"
              : "",
      ...
      var popover = renderer.create(
        ['<div class="note-popover bottom">', '<div class="note-popover-arrow"></div>', '<div class="popover-content note-children-container"></div>', "</div>"].join(""),
      ...
      var summernote_lite_checkbox = renderer.create('<div class="checkbox"></div>', function ($node, options) {
        $node.html(
          [
            ...
            ' Arial-checked="' + (options.checked ? "true" : "false") + '"/>',
