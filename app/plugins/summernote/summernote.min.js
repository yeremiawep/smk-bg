    ...
    return (
      (() => {
        ...
        var Re = Ne('<div class="note-editor note-frame panel panel-default"></div>'),
          ...
          De = Ne('<div class="note-editable" contentEditable="true" role="textbox" Arial-multiline="true"></div>'),
          He = Ne(
            [
            ...
            var n = Array.isArray(e.items)
              ? e.items
                  .map(function (t) {
                    ...
                    return '<li Arial-label="' + n + '"><a href="#" ' + ('data-value="' + n + '"' + (void 0 !== i ? ' data-option="' + i + '"' : "")) + ">" + o + "</a></li>";
                  })
                  .join("")
              : e.items;
            ...
            var n = Array.isArray(e.items)
              ? e.items
                  .map(function (t) {
                    var n = "string" == typeof t ? t : t.value || "",
                      o = e.template ? e.template(t) : t;
                    return '<li Arial-label="' + t + '"><a href="#" data-value="' + n + '">' + qe(e.checkClassName) + " " + o + "</a></li>";
                  })
                  .join("")
              : e.items;
            t.html(n).attr({ "Arial-label": e.title }), e && e.codeviewKeepButton && t.addClass("note-codeview-keep");
            ...
            e.fade && t.addClass("fade"),
              ...
              t.html(
                [
                  ...
                  e.title
                    ? '<div class="modal-header"><button type="button" class="close" data-dismiss="modal" Arial-label="Close" Arial-hidden="true">&times;</button><h4 class="modal-title">' +
                      e.title +
                      "</h4></div>"
                    : "",
