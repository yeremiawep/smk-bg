...
function te(e, t) {
  const { popper: o, reference: n } = e.offsets,
    ...
    m = t ? i : p;
  return { left: l(1 == d % 2 && 1 == s % 2 && !a && t ? o.left - 1 : o.left), top: m(o.top), bottom: m(o.bottom), right: l(o.right) };
}
...
function re(e, t) {
  ...
  return (w = Math.max(Math.min(i[s] - h, w), 0)), (e.arrowElement = o), (e.offsets.arrow = { [a]: Math.round(w), [l]: "" }), e;
}
function pe(e) {
  ...
  return (
    p.forEach((d, s) => {
      ...
      const f = e.offsets.popper,
        ...
        y = !!t.flipVArialtions && ((w && "start" === r && h) || (w && "end" === r && c) || (!w && "start" === r && u) || (!w && "end" === r && g)),
        E = !!t.flipVArialtionsByContent && ((w && "start" === r && c) || (w && "end" === r && h) || (!w && "start" === r && g) || (!w && "end" === r && u)),
        x = y || E;
      (m || b || x) &&
        ((e.flipped = !0),
        (m || b) && (n = p[s + 1]),
...
function ce(e, t, o, n) {
  ...
  return (
    (f = f.map((e, n) => {
      ...
      let p = !1;
      return e
        .reduce((e, t) => ("" === e[e.length - 1] && -1 !== ["+", "-"].indexOf(t) ? ((e[e.length - 1] = t), (p = !0), e) : p ? ((e[e.length - 1] += t), (p = !1), e) : e.concat(t)), [])
        .map((e) => he(e, i, t, o));
    })),
    f.forEach((e, t) => {
      e.forEach((o, n) => {
...
var Ee = {
    ...
    preventOverflow: { order: 300, enabled: !0, fn: ge, priority: ["left", "right", "top", "bottom"], padding: 5, boundariesElement: "scrollParent" },
    keepTogether: { order: 400, enabled: !0, fn: me },
    arrow: { order: 500, enabled: !0, fn: re, element: "[x-arrow]" },
    flip: { order: 600, enabled: !0, fn: le, behavior: "flip", padding: 5, boundariesElement: "viewport", flipVArialtions: !1, flipVArialtionsByContent: !1 },
  ...
  xe = { placement: "bottom", positionFixed: !1, eventsEnabled: !0, removeOnDestroy: !1, onCreate: () => {}, onUpdate: () => {}, modifiers: Ee };
class ve {
  constructor(e, t, o = {}) {
