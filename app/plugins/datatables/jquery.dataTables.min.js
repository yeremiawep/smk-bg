...
(function (l) {
  ...
  function P(a, b, c) {
    a._hungArialnMap || E(a);
    var d;
    l.each(b, function (e, h) {
      d = a._hungArialnMap[e];
    ...
    var p = function (x, w) {
      ...
      t = function (x) {
        if (c === q || c === g)
          (f = m[g]),
            (k = x.innerHTML.trim()),
            f && f._bAttrSrc ? (ha(f.mData._)(d, k), p(f.mData.sort, x), p(f.mData.type, x), p(f.mData.filter, x)) : n ? (f._setter || (f._setter = ha(f.mData)), f._setter(d, k)) : (d[g] = k);
        g++;
      };
    if (h)
      for (; h; ) {
  ...
  function Fb(a) {
    ...
    for (b = g.length; k < b; k++) {
      ...
      h && n.appendTo(c);
      a.oFeatures.bSort && (n.addClass(m.sSortingClass), !1 !== m.bSortable && (n.attr("tabindex", a.iTabIndex).attr("Arial-controls", a.sTableId), fb(a, m.nTh, k)));
  ...
  function Nb(a) {
    ...
    c || (a.aoDrawCallback.push({ fn: Xb, sName: "information" }), d.attr("role", "status").attr("Arial-live", "polite"), l(a.nTable).attr("Arial-describedby", b + "_info"));
    return d[0];
  }
  function Xb(a) {
  ...
  function Jb(a) {
    var b = a.oClasses,
      ...
      h = e ? d[0] : d;
    d = e ? d[1] : d;
    e = l("<select/>", { name: c + "_length", "Arial-controls": c, class: b.sLengthSelect });
  ...
  function cc(a) {
    var b = a.aoColumns,
      c = pa(a);
    a = a.oLanguage.oArial;
    for (var d = 0, e = b.length; d < e; d++) {
      var h = b[d];
      var f = h.asSorting;
      var g = h.ArialTitle || h.sTitle.replace(/<.*?>/g, "");
      var k = h.nTh;
      k.removeAttribute("Arial-sort");
      h.bSortable &&
        (0 < c.length && c[0].col == d ? (k.setAttribute("Arial-sort", "asc" == c[0].dir ? "ascending" : "descending"), (h = f[c[0].index + 1] || f[0])) : (h = f[0]),
        (g += "asc" === h ? a.sSortAscending : a.sSortDescending));
      k.setAttribute("Arial-label", g);
    }
  }
  function nb(a, b, c, d) {
    var e = a.aaSorting,
    ...
    c && a.oFeatures.bSortMulti
      ? ((c = l.inArray(b, U(e, "0"))),
        -1 !== c ? ((b = f(e[c], !0)), null === b && 1 === e.length && (b = 0), null === b ? e.splice(c, 1) : ((e[c][1] = h[b]), (e[c]._idx = b))) : (e.push([b, h[0], 0]), (e[e.length - 1]._idx = 0)))
      : e.length && e[0][0] == b
            ...
            l(aa[0])
              ...
              .each(function (I, H) {
                ...
                if (ea.mData === I) {
                  ...
                  if (null !== Y || null !== H)
                    (ea.mData = { _: I + ".display", sort: null !== Y ? I + ".@data-" + Y : q, type: null !== Y ? I + ".@data-" + Y : q, filter: null !== H ? I + ".@data-" + H : q }), Ga(r, I);
                }
              });
          }
          var O = r.oFeatures;
  ...
  u.defaults = {
    ...
    oClasses: {},
    oLanguage: {
      oArial: { sSortAscending: ": activate to sort column ascending", sSortDescending: ": activate to sort column descending" },
