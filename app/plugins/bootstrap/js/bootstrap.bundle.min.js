      ...
      return (
        (e.toggle = function () {
          ...
          this._element.hasAttribute("disabled") ||
            ...
            (e && this._element.setAttribute("Arial-pressed", !this._element.classList.contains(m)), t && i.default(this._element).toggleClass(m));
        }),
        (e.dispose = function () {
  ...
  i
    ...
    i.default(window).on("load.bs.button.data-api", function () {
      ...
      for (var r = 0, a = (t = [].slice.call(document.querySelectorAll('[data-toggle="button"]'))).length; r < a; r++) {
        var s = t[r];
        "true" === s.getAttribute("Arial-pressed") ? s.classList.add(m) : s.classList.remove(m);
      }
    }),
    ...
    O = (function () {
      ...
      return (
        ...
        (e._slide = function (t, e) {
          ...
          if (
            (t === C ? ((n = "carousel-item-left"), (o = "carousel-item-next"), (r = "left")) : ((n = "carousel-item-right"), (o = "carousel-item-prev"), (r = "right")), f && i.default(f).hasClass(T))
          )
            this._isSliding = !1;
    ...
    W = (function () {
      ...
      return (
          ...
          if (
            ...
            if ((i.default(this._element).trigger(r), !r.isDefaultPrevented())) {
              ...
              i.default(this._element).removeClass(F).addClass(R),
                ...
                this._triggerArray.length && i.default(this._triggerArray).removeClass(H).attr("Arial-expanded", !0),
            ...
            if ((i.default(this._element).trigger(e), !e.isDefaultPrevented())) {
              ...
              if (o > 0)
                for (var r = 0; r < o; r++) {
                  ...
                  null !== s && (i.default([].slice.call(document.querySelectorAll(s))).hasClass(P) || i.default(a).addClass(H).attr("Arial-expanded", !1));
                }
        ...
        (e._addArialAndCollapsedClass = function (t, e) {
          ...
          e.length && i.default(e).toggleClass(H, !n).attr("Arial-expanded", n);
        }),
            ...
            return (
              a.forEach(function (s, l) {
                ...
                var u = t.offsets.popper,
                  ...
                  b = !!e.flipVArialtions && ((v && "start" === r && h) || (v && "end" === r && p) || (!v && "start" === r && m) || (!v && "end" === r && g)),
                  y = !!e.flipVArialtionsByContent && ((v && "start" === r && p) || (v && "end" === r && h) || (!v && "start" === r && g) || (!v && "end" === r && m)),
                  E = b || y;
                (c || _ || E) &&
                  ((t.flipped = !0),
                  (c || _) && (i = a[l + 1]),
            ...
            if ((i.default(r).trigger(o), !o.isDefaultPrevented())) {
              if (!this._inNavbar && e) {
                ...
                "parent" === this._config.reference
                  ? (a = r)
                  : u.isElement(this._config.reference) && ((a = this._config.reference), "undefined" != typeof this._config.reference.jquery && (a = this._config.reference[0])),
                ...
                if (
                  ...
                  i.default(a).trigger(f),
                    f.isDefaultPrevented() ||
                      ...
                      n[o].setAttribute("Arial-expanded", "false"),
      ...
      return (
        ...
        (e.show = function () {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            r.setAttribute("id", a), this.element.setAttribute("Arial-describedby", a), this.setContent(), this.config.animation && i.default(r).addClass(Pe);
      ...
      return (
        ...
        (e._transitionComplete = function (t, e, n) {
          if (e) {
            ...
            o && i.default(o).removeClass(dn), "tab" === e.getAttribute("role") && e.setAttribute("Arial-selected", !1);
          }
          i.default(t).addClass(dn), "tab" === t.getAttribute("role") && t.setAttribute("Arial-selected", !0), u.reflow(t), t.classList.contains(cn) && t.classList.add(hn);
          var r = t.parentNode;
