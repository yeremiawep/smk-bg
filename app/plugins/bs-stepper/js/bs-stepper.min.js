  ...
  var r = { ACTIVE: "active", LINEAR: "linear", BLOCK: "dstepper-block", NONE: "dstepper-none", FADE: "fade", VERTICAL: "vertical" },
    ...
    l = function (t, e, n, s) {
      n.forEach(function (e) {
        ...
        n.setAttribute("Arial-selected", "false"), t.classList.contains(r.LINEAR) && n.setAttribute("disabled", "disabled");
      }),
        e.classList.add(r.ACTIVE);
      var i = e.querySelector(s.selectors.trigger);
      i.setAttribute("Arial-selected", "true"), t.classList.contains(r.LINEAR) && i.removeAttribute("disabled");
    },
