...
(function (global, factory) {
  ...
  var showStep = function showStep(stepperNode, step, stepList, options) {
    stepList.forEach(function (step) {
      ...
      trigger.setAttribute("Arial-selected", "false"); // if stepper is in linear mode, set disabled attribute on the trigger
    ...
    currentTrigger.setAttribute("Arial-selected", "true"); // if stepper is in linear mode, remove disabled attribute on current
