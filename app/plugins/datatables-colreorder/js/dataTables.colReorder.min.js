...
(function (e) {
  ...
  function t(a, b, d) {
    for (var f = [], e = 0, c = a.childNodes.length; e < c; e++) 1 == a.childNodes[e].nodeType && f.push(a.childNodes[e]);
    b = f[b];
  ...
  e.fn.dataTableExt.oApi.fnColReorder = function (a, b, d, f, h) {
    ...
    if (b != d)
      if (0 > b || b >= i) this.oApi._fnLog(a, 1, "ColReorder 'from' index is out of bounds: " + b);
      else if (0 > d || d >= i) this.oApi._fnLog(a, 1, "ColReorder 'to' index is out of bounds: " + d);
      else {
        j = [];
        c = 0;
        for (g = i; c < g; c++) j[c] = c;
        ...
        for (g = i; c < g; c++)
          (k = a.aoColumns[c]),
            "number" == typeof k.mData ? (k.mData = m[k.mData]) : e.isPlainObject(k.mData) && (n(k.mData, "_", m), n(k.mData, "filter", m), n(k.mData, "sort", m), n(k.mData, "type", m));
  ...
  var i = function (a, b) {
    ...
    !0 === b && (b = {});
    var f = e.fn.dataTable.camelToHungArialn;
  ...
  e.extend(i.prototype, {
    ...
    _fnConstruct: function () {
      ...
      for (f = 0; f < b; f++) f > this.s.fixed - 1 && f < b - this.s.fixedRight && this._fnMouseListener(f, this.s.dt.aoColumns[f].nTh), (this.s.dt.aoColumns[f]._ColReorder_iOrigCol = f);
    ...
    _fnStateSave: function (a) {
      ...
      a.ColReorder = [];
      if (a.aaSorting) {
        for (b = 0; b < a.aaSorting.length; b++) a.aaSorting[b][0] = h[a.aaSorting[b][0]]._ColReorder_iOrigCol;
    ...
    _fnCreateDragNode: function () {
      ...
      this.dom.drag = e(h.cloneNode(!1))
        ...
        .css({ position: "absolute", top: 0, left: 0, width: e(b).outerWidth(), height: e(b).outerHeight() })
        .appendTo("body");
      this.dom.pointer = e("<div></div>")
        ...
        .css({
          ...
          height: a ? e("div.dataTables_scroll", this.s.dt.nTableWrapper).height() : e(this.s.dt.nTable).height(),
        })
        .appendTo("body");
    },
  ...
  e.fn.DataTable.ColReorder = i;
  "function" == typeof e.fn.dataTable && "function" == typeof e.fn.dataTableExt.fnVersionCheck && e.fn.dataTableExt.fnVersionCheck("1.10.8")
