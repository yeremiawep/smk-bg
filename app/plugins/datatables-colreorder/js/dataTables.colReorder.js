...
(function (factory) {
  ...
  $.fn.dataTableExt.oApi.fnColReorder = function (oSettings, iFrom, iTo, drop, invalidateRows) {
    ...
    // Update 1.10 optimised sort class removal vArialble
  ...
  var ColReorder = function (dt, opts) {
    ...
    // Convert from camelCase to HungArialn, just as DataTables does
    var camelToHungArialn = $.fn.dataTable.camelToHungArialn;
    if (camelToHungArialn) {
      camelToHungArialn(ColReorder.defaults, ColReorder.defaults, true);
      camelToHungArialn(ColReorder.defaults, opts || {});
    }
