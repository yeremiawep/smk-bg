    ...
    (function (a) {
      function e(b, c) {
        ...
        if (this.sliderElem) s = !0;
          ...
          (u.className = "slider-track"),
            ...
            p.setAttribute("Arial-valuemin", this.options.min),
            p.setAttribute("Arial-valuemax", this.options.max),
            (q = document.createElement("div")),
            (q.className = "slider-handle max-slider-handle"),
            q.setAttribute("role", "slider"),
            q.setAttribute("Arial-valuemin", this.options.min),
            q.setAttribute("Arial-valuemax", this.options.max),
            u.appendChild(n),
            u.appendChild(m),
            u.appendChild(o),
          ...
          if (
            (z && this.options.labelledby[0] && p.setAttribute("Arial-labelledby", this.options.labelledby[0]),
            z && this.options.labelledby[1] && q.setAttribute("Arial-labelledby", this.options.labelledby[1]),
            !z && this.options.labelledby && (p.setAttribute("Arial-labelledby", this.options.labelledby), q.setAttribute("Arial-labelledby", this.options.labelledby)),
            (this.ticks = []),
        ...
        if (
          ...
          Array.isArray(this.options.ticks) &&
            ...
            (g || (this.options.max = Math.max.apply(Math, this.options.ticks)), f || (this.options.min = Math.min.apply(Math, this.options.ticks))),
          ...
          "none" === this.options.selection
            ...
            : ("after" === this.options.selection || "before" === this.options.selection) &&
              (this._removeClass(this.trackLow, "hide"), this._removeClass(this.trackSelection, "hide"), this._removeClass(this.trackHigh, "hide")),
          (this.handle1 = p || this.handle1),
          (this.handle2 = q || this.handle2),
          s === !0)
        )
          for (this._removeClass(this.handle1, "round triangle"), this._removeClass(this.handle2, "round triangle hide"), i = 0; i < this.ticks.length; i++)
            this._removeClass(this.ticks[i], "round triangle hide");
        var L = ["round", "triangle", "custom"],
          M = -1 !== L.indexOf(this.options.handle);
        if (M)
          for (this._addClass(this.handle1, this.options.handle), this._addClass(this.handle2, this.options.handle), i = 0; i < this.ticks.length; i++)
      ...
      (d = function (a, b) {
        ...
        (d.prototype = {
          ...
          destroy: function () {
            this._removeSliderEventHandlers(),
              ...
              a && (this._unbindJQueryEventHandlers(), f === b && this.$element.removeData(f), this.$element.removeData(c));
          },
          disable: function () {
            return (
          ...
          refresh: function (d) {
            ...
            return (
              ...
              a && (f === b ? (a.data(this.element, b, this), a.data(this.element, c, this)) : a.data(this.element, c, this)),
              this
            );
          },
          relayout: function () {
          ...
          _hideTooltip: function () {
            this._state.inDrag === !1 &&
              ...
              (this._removeClass(this.tooltip, "show"), this._removeClass(this.tooltip_min, "show"), this._removeClass(this.tooltip_max, "show")),
              (this._state.over = !1);
          },
              ...
              addMouseEnter: function (a, b, c) {
                var d = function () {
                  var d = a._copyState(),
                    ...
                    f = void 0;
                  void 0 !== c
                    ? ((e = a.options.ticks[c]), (f = (a.options.ticks_positions.length > 0 && a.options.ticks_positions[c]) || a._toPercentage(a.options.ticks[c])))
                    : (f = a._toPercentage(e)),
                    (d.value[0] = e),
                    (d.percentage[0] = f),
          ...
          _layout: function () {
            ...
            if (
              ((a = this.options.reversed
                ? [100 - this._state.percentage[0], this.options.range ? 100 - this._state.percentage[1] : this._state.percentage[1]]
              ...
              isNaN(b) ? this.handle1.setAttribute("Arial-valuetext", b) : this.handle1.removeAttribute("Arial-valuetext"),
              ...
              isNaN(b) ? this.handle2.setAttribute("Arial-valuetext", b) : this.handle2.removeAttribute("Arial-valuetext"),
              ...
              for (var c = 0; c < this.options.rangeHighlights.length; c++) {
                ...
                g
                  ? "vertical" === this.options.orientation
                    ? ((this.rangeHighlightElements[c].style.top = g.start + "%"), (this.rangeHighlightElements[c].style.height = g.size + "%"))
                    : (this.options.rtl ? (this.rangeHighlightElements[c].style.right = g.start + "%") : (this.rangeHighlightElements[c].style.left = g.start + "%"),
            ...
            if (Array.isArray(this.options.ticks) && this.options.ticks.length > 0) {
              ...
              if (this.tickLabelContainer) {
                ...
                if (0 === this.options.ticks_positions.length)
                  "vertical" !== this.options.orientation && (this.tickLabelContainer.style[h] = -j / 2 + "px"), (k = this.tickLabelContainer.offsetHeight);
                else for (l = 0; l < this.tickLabelContainer.childNodes.length; l++) this.tickLabelContainer.childNodes[l].offsetHeight > k && (k = this.tickLabelContainer.childNodes[l].offsetHeight);
              ...
              for (var l = 0; l < this.options.ticks.length; l++) {
                ...
                this.options.reversed && (m = 100 - m),
                  ...
                  this.options.range
                    ...
                    : "before" === this.options.selection && m <= a[0] && this._addClass(this.ticks[l], "in-selection"),
                  this.tickLabels[l] &&
                    ((this.tickLabels[l].style[i] = j + "px"),
                    "vertical" !== this.options.orientation && void 0 !== this.options.ticks_positions[l]
                      ? ((this.tickLabels[l].style.position = "absolute"), (this.tickLabels[l].style[this.stylePos] = m + "%"), (this.tickLabels[l].style[h] = -j / 2 + "px"))
                      : "vertical" === this.options.orientation &&
                        (this.options.rtl ? (this.tickLabels[l].style.marginRight = this.sliderElem.offsetWidth + "px") : (this.tickLabels[l].style.marginLeft = this.sliderElem.offsetWidth + "px"),
                    ...
                    this.options.range
                      ? m >= a[0] && m <= a[1] && (this._addClass(this.tickLabels[l], "label-in-selection"), (m === a[0] || a[1]) && this._addClass(this.tickLabels[l], "label-is-selection"))
                      : ("after" === this.options.selection && m >= a[0]
                          ? this._addClass(this.tickLabels[l], "label-in-selection")
                          : "before" === this.options.selection && m <= a[0] && this._addClass(this.tickLabels[l], "label-in-selection"),
            ...
            if (c) {
              ...
              if (this.ticksAreValid && this.options.lock_to_ticks) {
                ...
                (i = this.options.ticks.indexOf(this._state.value[a])),
                  -1 === i && ((i = 0), window.console.warn("(lock_to_ticks) _keydown: index should not be -1")),
                  (i += c),
          ...
          _adjustPercentageForRangeSliders: function (a) {
            if (this.options.range) {
              ...
              0 === this._state.dragged && this._applyToFixedAndParseFloat(this._state.percentage[1], b) < c
                ...
                : 1 === this._state.dragged && this._applyToFixedAndParseFloat(this._state.percentage[0], b) > c
                ...
                : 1 === this._state.keyCtrl &&
                  ...
                  ((this._state.percentage[1] = this._state.percentage[0]), (this._state.keyCtrl = 0), this.handle1.focus());
            }
          },
          _mouseup: function (a) {
            if (!this._state.enabled) return !1;
            ...
            return (
              this.options.range
                ? ((b.data = [this.options.min, this.options.max]),
                  this._setValues(0, b),
                  this._setValues(1, b),
                  a && ((b.data[0] = this._snapToClosestTick(b.data[0])), (b.data[1] = this._snapToClosestTick(b.data[1]))))
                : ((b.data = this._toValue(this._state.percentage[0])), (b.data = parseFloat(b.data)), (b.data = this._applyPrecision(b.data)), a && (b.data = this._snapToClosestTick(b.data))),
              b.data
            );
          },
        ...
        a &&
          a.fn &&
          (a.fn.slider
            ? (windowIsDefined && window.console.warn("bootstrap-slider.js - WARNING: $.fn.slider namespace is already bound. Use the $.fn.bootstrapSlider namespace instead."), (f = c))
            : (a.bridget(b, d), (f = b)),
          a.bridget(c, d),
          a(function () {
