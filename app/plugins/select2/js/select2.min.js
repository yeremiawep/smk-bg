...
!(function (n) {
  ...
  var e = (function () {
      ...
      function l(e, t) {
        ...
        if (e) {
          for (
            s = (e = e.split("/")).length - 1, y.nodeIdCompat && b.test(e[s]) && (e[s] = e[s].replace(b, "")), "." === e[0].charAt(0) && h && (e = h.slice(0, h.length - 1).concat(e)), u = 0;
            u < e.length;
            u++
          )
        ...
        e.define("select2/results", ["jquery", "./utils"], function (h, f) {
          ...
          return (
            ...
            (r.prototype.render = function () {
              ...
              return this.options.get("multiple") && e.attr("Arial-multiselectable", "true"), (this.$results = e);
            }),
            ...
            (r.prototype.displayMessage = function (e) {
              ...
              var n = h('<li role="alert" Arial-live="assertive" class="select2-results__option"></li>'),
            ...
            (r.prototype.highlightFirstItem = function () {
              var e = this.$results.find(".select2-results__option[Arial-selected]"),
                t = e.filter("[Arial-selected=true]");
            ...
            (r.prototype.setClasses = function () {
              ...
              this.data.current(function (e) {
                ...
                t.$results.find(".select2-results__option[Arial-selected]").each(function () {
                  var e = h(this),
                    t = f.GetData(this, "data"),
                    n = "" + t.id;
                  (null != t.element && t.element.selected) || (null == t.element && -1 < h.inArray(n, r)) ? e.attr("Arial-selected", "true") : e.attr("Arial-selected", "false");
                });
              });
            }),
            ...
            (r.prototype.option = function (e) {
              ...
              var n = { role: "option", "Arial-selected": "false" },
                r = window.Element.prototype.matches || window.Element.prototype.msMatchesSelector || window.Element.prototype.webkitMatchesSelector;
              for (var i in (((null != e.element && r.call(e.element, ":disabled")) || (null == e.element && e.disabled)) && (delete n["Arial-selected"], (n["Arial-disabled"] = "true")),
              null == e.id && delete n["Arial-selected"],
              null != e._resultId && (t.id = e._resultId),
              e.title && (t.title = e.title),
              e.children && ((n.role = "group"), (n["Arial-label"] = e.text), delete n["Arial-selected"]),
              n)) {
                var o = n[i];
                t.setAttribute(i, o);
              }
            ...
            (r.prototype.bind = function (t, e) {
              ...
              this.$results.attr("id", n),
                ...
                t.on("open", function () {
                  l.$results.attr("Arial-expanded", "true"), l.$results.attr("Arial-hidden", "false"), l.setClasses(), l.ensureHighlightVisible();
                }),
                t.on("close", function () {
                  l.$results.attr("Arial-expanded", "false"), l.$results.attr("Arial-hidden", "true"), l.$results.removeAttr("Arial-activedescendant");
                }),
                ...
                t.on("results:select", function () {
                  ...
                  if (0 !== e.length) {
                    ...
                    "true" == e.attr("Arial-selected") ? l.trigger("close", {}) : l.trigger("select", { data: t });
                  }
                }),
                t.on("results:previous", function () {
                  var e = l.getHighlightedResults(),
                    t = l.$results.find("[Arial-selected]"),
                    n = t.index(e);
                  if (!(n <= 0)) {
                    var r = n - 1;
                    0 === e.length && (r = 0);
                ...
                this.$results.on("mouseup", ".select2-results__option[Arial-selected]", function (e) {
                  var t = h(this),
                    n = f.GetData(this, "data");
                  "true" !== t.attr("Arial-selected")
                    ? l.trigger("select", { originalEvent: e, data: n })
                    : l.options.get("multiple")
                    ? l.trigger("unselect", { originalEvent: e, data: n })
                    : l.trigger("close", {});
                }),
                this.$results.on("mouseenter", ".select2-results__option[Arial-selected]", function (e) {
            ...
            (r.prototype.ensureHighlightVisible = function () {
              ...
              if (0 !== e.length) {
                var t = this.$results.find("[Arial-selected]").index(e),
        ...
        e.define("select2/selection/base", ["jquery", "../utils", "../keys"], function (n, r, i) {
          ...
          return (
            ...
            (o.prototype.render = function () {
              var e = n('<span class="select2-selection" role="combobox"  Arial-haspopup="true" Arial-expanded="false"></span>');
              return (
                (this._tabindex = 0),
            ...
            (o.prototype.bind = function (e, t) {
              ...
              (this.container = e),
                ...
                e.on("results:focus", function (e) {
                  n.$selection.attr("Arial-activedescendant", e.data._resultId);
                }),
                e.on("selection:update", function (e) {
                  n.update(e.data);
                }),
                e.on("open", function () {
                  n.$selection.attr("Arial-expanded", "true"), n.$selection.attr("Arial-owns", r), n._attachCloseHandler(e);
                }),
                e.on("close", function () {
                  n.$selection.attr("Arial-expanded", "false"),
                    n.$selection.removeAttr("Arial-activedescendant"),
                    n.$selection.removeAttr("Arial-owns"),
                    n.$selection.trigger("focus"),
                    n._detachCloseHandler(e);
                }),
                e.on("enable", function () {
                  n.$selection.attr("tabindex", n._tabindex), n.$selection.attr("Arial-disabled", "false");
                }),
                e.on("disable", function () {
                  n.$selection.attr("tabindex", "-1"), n.$selection.attr("Arial-disabled", "true");
                });
            }),
        ...
        e.define("select2/selection/single", ["jquery", "./base", "../utils", "../keys"], function (e, t, n, r) {
          ...
          return (
            ...
            (i.prototype.bind = function (t, e) {
              ...
              this.$selection.find(".select2-selection__rendered").attr("id", r).attr("role", "textbox").attr("Arial-readonly", "true"),
                this.$selection.attr("Arial-labelledby", r),
        ...
        e.define("select2/selection/search", ["jquery", "../utils", "../keys"], function (r, a, l) {
          ...
          return (
            (e.prototype.render = function (e) {
              var t = r(
                '<li class="select2-search select2-search--inline"><input class="select2-search__field" type="search" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false" role="searchbox" Arial-autocomplete="list" /></li>'
              );
            ...
            (e.prototype.bind = function (e, t, n) {
              ...
              e.call(this, t, n),
                t.on("open", function () {
                  r.$search.attr("Arial-controls", i), r.$search.trigger("focus");
                }),
                t.on("close", function () {
                  r.$search.val(""), r.$search.removeAttr("Arial-controls"), r.$search.removeAttr("Arial-activedescendant"), r.$search.trigger("focus");
                }),
                ...
                t.on("results:focus", function (e) {
                  e.data._resultId ? r.$search.attr("Arial-activedescendant", e.data._resultId) : r.$search.removeAttr("Arial-activedescendant");
                }),
        ...
        e.define("select2/dropdown/search", ["jquery", "../utils"], function (o, e) {
          ...
          return (
            (t.prototype.render = function (e) {
              var t = e.call(this),
                n = o(
                  '<span class="select2-search select2-search--dropdown"><input class="select2-search__field" type="search" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false" role="searchbox" Arial-autocomplete="list" /></span>'
                );
              ...
              e.call(this, t, n),
                ...
                t.on("open", function () {
                  r.$search.attr("tabindex", 0),
                    r.$search.attr("Arial-controls", i),
                    r.$search.trigger("focus"),
                    window.setTimeout(function () {
                      r.$search.trigger("focus");
                    }, 0);
                ...
                t.on("close", function () {
                  r.$search.attr("tabindex", -1), r.$search.removeAttr("Arial-controls"), r.$search.removeAttr("Arial-activedescendant"), r.$search.val(""), r.$search.trigger("blur");
                }),
                t.on("focus", function () {
        ...
        e.define("select2/dropdown/infiniteScroll", ["jquery"], function (n) {
          ...
          return (
            ...
            (e.prototype.createLoadingMore = function () {
              var e = n('<li class="select2-results__option select2-results__option--load-more"role="option" Arial-disabled="true"></li>'),
        ...
        e.define("select2/core", ["jquery", "./options", "./utils", "./keys"], function (o, c, u, r) {
          ...
          return (
            ...
            (d.prototype.render = function () {
              var e = o('<span class="select2 select2-container"><span class="selection"></span><span class="dropdown-wrapper" Arial-hidden="true"></span></span>');
              return (
