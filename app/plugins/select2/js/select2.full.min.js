        ...
        e.define("select2/results", ["jquery", "./utils"], function (h, f) {
          ...
          return (
              ...
              this.data.current(function (e) {
                ...
                t.$results.find(".select2-results__option[Arial-selected]").each(function () {
                  var e = h(this),
                    ...
                    n = "" + t.id;
                  (null != t.element && t.element.selected) || (null == t.element && -1 < h.inArray(n, i)) ? e.attr("Arial-selected", "true") : e.attr("Arial-selected", "false");
                });
              });
            }),
            ...
            (i.prototype.option = function (e) {
              ...
              for (var r in (((null != e.element && i.call(e.element, ":disabled")) || (null == e.element && e.disabled)) && (delete n["Arial-selected"], (n["Arial-disabled"] = "true")),
          ...
          return (
            ...
            (o.prototype.bind = function (e, t) {
              ...
              (this.container = e),
                ...
                e.on("open", function () {
                  n.$selection.attr("Arial-expanded", "true"), n.$selection.attr("Arial-owns", i), n._attachCloseHandler(e);
                }),
                e.on("close", function () {
        ...
        e.define("select2/selection/single", ["jquery", "./base", "../utils", "../keys"], function (e, t, n, i) {
          ...
          return (
            ...
            (r.prototype.bind = function (t, e) {
              ...
              this.$selection.find(".select2-selection__rendered").attr("id", i).attr("role", "textbox").attr("Arial-readonly", "true"),
                this.$selection.attr("Arial-labelledby", i),
        ...
        e.define("select2/selection/search", ["jquery", "../utils", "../keys"], function (i, a, l) {
          ...
          return (
            ...
            (e.prototype.bind = function (e, t, n) {
              ...
              e.call(this, t, n),
                t.on("open", function () {
                  i.$search.attr("Arial-controls", r), i.$search.trigger("focus");
                }),
                t.on("close", function () {
                  i.$search.val(""), i.$search.removeAttr("Arial-controls"), i.$search.removeAttr("Arial-activedescendant"), i.$search.trigger("focus");
                }),
                ...
                t.on("results:focus", function (e) {
                  e.data._resultId ? i.$search.attr("Arial-activedescendant", e.data._resultId) : i.$search.removeAttr("Arial-activedescendant");
                }),
              ...
              e.call(this, t, n),
                ...
                t.on("open", function () {
                  i.$search.attr("tabindex", 0),
                    i.$search.attr("Arial-controls", r),
                    i.$search.trigger("focus"),
                    window.setTimeout(function () {
                      i.$search.trigger("focus");
                    }, 0);
                ...
                t.on("close", function () {
                  i.$search.attr("tabindex", -1), i.$search.removeAttr("Arial-controls"), i.$search.removeAttr("Arial-activedescendant"), i.$search.val(""), i.$search.trigger("blur");
                }),
                t.on("focus", function () {
