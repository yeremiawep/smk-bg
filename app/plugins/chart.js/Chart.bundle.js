...
*/
  ...
  var helpers = {
    ...
    /**
     * Returns a unique id, sequentially generated from a global vArialble.
     * @returns {number}
     * @function
     */
    uid: (function () {
  ...
  defaults._set("global", {
    ...
    defaultFontFamily: "'Helvetica Neue', 'Helvetica', 'Ariall', sans-serif",
    defaultFontSize: 12,
  ...
  var Scale = core_element.extend({
    ...
    update: function (maxWidth, maxHeight, margins) {
      ...
      // VArialbles set in _configure are needed for calculateTickRotation, and
  ...
  var scale_time = core_scale.extend({
    ...
    buildTicks: function () {
      ...
      me._unit =
        timeOpts.unit || (tickOpts.autoSkip ? determineUnitForAutoTicks(timeOpts.minUnit, me.min, me.max, capacity) : determineUnitForFormatting(me, ticks.length, timeOpts.minUnit, me.min, me.max));
  ...
  var moment = createCommonjsModule(function (module, exports) {
    (function (global, factory) {
      ...
      // substring from most specific to least, but move to the next array item if it's a more specific vArialnt than the current root
