...
!(function (t, e) {
  ...
  var E = {
      ...
      toPadding: function (t) {
        var e, n, i, a;
        return (
          S.isObject(t) ? ((e = +t.top || 0), (n = +t.right || 0), (i = +t.bottom || 0), (a = +t.left || 0)) : (e = n = i = a = +t || 0),
  ...
  var st = K.extend({
      ...
      draw: function () {
        ...
        if ((e.save(), (e.fillStyle = n.backgroundColor), (e.strokeStyle = n.borderColor), a.fullCircles)) {
          for (
            a.endAngle = a.startAngle + at, e.beginPath(), e.arc(a.x, a.y, a.outerRadius, a.startAngle, a.endAngle), e.arc(a.x, a.y, a.innerRadius, a.endAngle, a.startAngle, !0), e.closePath(), t = 0;
            t < a.fullCircles;
            ++t
          )
            e.fill();
      ...
      calculateBarValuePixels: function (t, e, n) {
        ...
        if (v || (void 0 === v && void 0 !== b))
          for (i = 0; i < _ && (a = g[i]).index !== t; ++i)
            a.stack === b &&
              ((r = void 0 === (u = h._parseValue(f[a.index].data[e])).start ? u.end : u.min >= 0 && u.max >= 0 ? u.max : u.min), ((p.min < 0 && r < 0) || (p.max >= 0 && r > 0)) && (x += r));
        return (
  ...
  var qe = K.extend({
      ...
      getCaretPosition: function (t, e, n) {
        ...
        else if (("left" === h ? ((i = (a = f + d + u) - u), (r = a + u)) : "right" === h ? ((i = (a = f + p - d - u) - u), (r = a + u)) : ((i = (a = n.caretX) - u), (r = a + u)), "top" === c))
          (s = (o = g) - u), (l = o);
        else {
          (s = (o = g + m) + u), (l = o);
          var v = r;
  ...
  H.extend(tn.prototype, {
    ...
    resize: function (t) {
      ...
      if (
        ...
        ((i.width = e.width = r), (i.height = e.height = o), (i.style.width = r + "px"), (i.style.height = o + "px"), H.retinaScale(e, n.devicePixelRatio), !t)
      ) {
  ...
  function pn(t, e) {
    return H.extend(
      H.options._parseFont({ fontFamily: un(e.fontFamily, t.fontFamily), fontSize: un(e.fontSize, t.fontSize), fontStyle: un(e.fontStyle, t.fontStyle), lineHeight: un(e.lineHeight, t.lineHeight) }),
        ...
        (i = S[n] || {}),
          (ln(i.label) && n < S.length) ||
            ...
            void 0 !== (a = hn(b, i._index || n, w)) &&
              ...
              A.push({ tx1: o, ty1: s, tx2: l, ty2: u, x1: d, y1: h, x2: c, y2: f, width: g, color: p, borderDash: m, borderDashOffset: v })));
      ...
      buildTicks: function () {
        var t = this,
          ...
          a = (t.ticks = (function (t, e) {
            ...
            0 === r
              ? ((n = Math.floor(On(e.minNotZero))), (i = Math.floor(e.minNotZero / Math.pow(10, n))), a.push(r), (r = i * Math.pow(10, n)))
  ...
  var wi = {
      ...
      afterDatasetsUpdate: function (t, e) {
        ...
        for (i = 0; i < o; ++i)
          (r = null),
            (a = (n = t.getDatasetMeta(i)).dataset) && a._model && a instanceof kt.Line && (r = { visible: t.isDatasetVisible(i), fill: mi(a, i, o), chart: t, el: a }),
            (n.$filler = r),
            l.push(r);
