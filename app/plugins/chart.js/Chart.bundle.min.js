...
!(function (t, e) {
      ...
      (a.rgb.hsl = function (t) {
        ...
        (a.rgb.hsv = function (t) {
          ...
          return (
            0 === d
              ? (a = r = 0)
              : ((r = d / u), (e = h(o)), (n = h(s)), (i = h(l)), o === u ? (a = i - n) : s === u ? (a = 1 / 3 + e - i) : l === u && (a = 2 / 3 + n - e), a < 0 ? (a += 1) : a > 1 && (a -= 1)),
            [360 * a, 100 * r, 100 * u]
          );
        }),
  ...
  var C = {
      ...
      easeInElastic: function (t) {
        ...
        return 0 === t
          ...
          : 1 === t
          ? 1
          : (n || (n = 0.3), i < 1 ? ((i = 1), (e = n / 4)) : (e = (n / (2 * Math.PI)) * Math.asin(1 / i)), -i * Math.pow(2, 10 * (t -= 1)) * Math.sin(((t - e) * (2 * Math.PI)) / n));
      },
      easeOutElastic: function (t) {
        ...
        return 0 === t
          ...
          : 1 === t
          ? 1
          : (n || (n = 0.3), i < 1 ? ((i = 1), (e = n / 4)) : (e = (n / (2 * Math.PI)) * Math.asin(1 / i)), i * Math.pow(2, -10 * t) * Math.sin(((t - e) * (2 * Math.PI)) / n) + 1);
      },
  ...
  var E = {
      ...
      toPadding: function (t) {
        var e, n, i, a;
        return (
          D.isObject(t) ? ((e = +t.top || 0), (n = +t.right || 0), (i = +t.bottom || 0), (a = +t.left || 0)) : (e = n = i = a = +t || 0),
      ...
      resolve: function (t, e, n, i) {
        ...
        for (a = 0, r = t.length; a < r; ++a)
          if (void 0 !== (o = t[a]) && (void 0 !== e && "function" == typeof o && ((o = o(e)), (s = !1)), void 0 !== n && D.isArray(o) && ((o = o[n]), (s = !1)), void 0 !== o))
  ...
  var B = D,
    ...
    Z = {
      ...
      overrideTextDirection: function (t, e) {
        var n, i;
        ("ltr" !== e && "rtl" !== e) ||
          ((i = [(n = t.canvas.style).getPropertyValue("direction"), n.getPropertyPriority("direction")]), n.setProperty("direction", e, "important"), (t.prevTextDirection = i));
      },
  ...
  var lt = X.extend({
      ...
      draw: function () {
        ...
        if ((e.save(), (e.fillStyle = n.backgroundColor), (e.strokeStyle = n.borderColor), a.fullCircles)) {
          for (
            a.endAngle = a.startAngle + rt, e.beginPath(), e.arc(a.x, a.y, a.outerRadius, a.startAngle, a.endAngle), e.arc(a.x, a.y, a.innerRadius, a.endAngle, a.startAngle, !0), e.closePath(), t = 0;
            t < a.fullCircles;
            ++t
          )
            e.fill();
      ...
      calculateBarValuePixels: function (t, e, n) {
        ...
        if (v || (void 0 === v && void 0 !== b))
          for (i = 0; i < _ && (a = g[i]).index !== t; ++i)
            a.stack === b &&
              ((r = void 0 === (u = h._parseValue(f[a.index].data[e])).start ? u.end : u.min >= 0 && u.max >= 0 ? u.max : u.min), ((m.min < 0 && r < 0) || (m.max >= 0 && r > 0)) && (y += r));
        return (
  ...
  B.extend(en.prototype, {
    ...
    resize: function (t) {
      ...
      if (
        ...
        ((i.width = e.width = r), (i.height = e.height = o), (i.style.width = r + "px"), (i.style.height = o + "px"), B.retinaScale(e, n.devicePixelRatio), !t)
      ) {
  ...
  function pn(t, e) {
    return B.extend(
      B.options._parseFont({ fontFamily: dn(e.fontFamily, t.fontFamily), fontSize: dn(e.fontSize, t.fontSize), fontStyle: dn(e.fontStyle, t.fontStyle), lineHeight: dn(e.lineHeight, t.lineHeight) }),
  ...
  var xn = X.extend({
    ...
    _parseValue: function (t) {
      var e, n, i, a;
      return (
        ln(t) ? ((e = +this.getRightValue(t[0])), (n = +this.getRightValue(t[1])), (i = Math.min(e, n)), (a = Math.max(e, n))) : ((e = void 0), (n = t = +this.getRightValue(t)), (i = t), (a = t)),
        ...
        (i = S[n] || {}),
          (un(i.label) && n < S.length) ||
            ...
            void 0 !== (a = cn(b, i._index || n, k)) &&
              ...
              P.push({ tx1: o, ty1: s, tx2: l, ty2: u, x1: d, y1: h, x2: c, y2: f, width: g, color: m, borderDash: p, borderDashOffset: v })));
      ...
      buildTicks: function () {
        var t = this,
          ...
          a = (t.ticks = (function (t, e) {
            ...
            0 === r
              ? ((n = Math.floor(Ln(e.minNotZero))), (i = Math.floor(e.minNotZero / Math.pow(10, n))), a.push(r), (r = i * Math.pow(10, n)))
        ...
        if (
          ...
          for (
            a.save(),
              a.lineWidth = l,
              a.strokeStyle = u,
              a.setLineDash && (a.setLineDash(Vn([s.borderDash, o.borderDash, []])), (a.lineDashOffset = Vn([s.borderDashOffset, o.borderDashOffset, 0]))),
      ...
      e.exports = (function () {
                      ...
                      : (function (t) {
                          ...
                          s(e)
                            ...
                            ? (function (t) {
                                var e = Se.exec(t._i);
                                null === e
                                  ? (De(t), !1 === t._isValid && (delete t._isValid, Oe(t), !1 === t._isValid && (delete t._isValid, a.createFromInputFallback(t))))
                                  : (t._d = new Date(+e[1]));
                              })(t)
                            : r(e)
          ...
          return (
            Ee(t)
              ...
              : "object" == typeof u &&
                ...
                (a =
                  r.isValid() && o.isValid()
                    ? ((o = Ue(o, r)), r.isBefore(o) ? (s = Je(r, o)) : (((s = Je(o, r)).milliseconds = -s.milliseconds), (s.months = -s.months)), s)
        ...
        function Qe(t, e) {
          return function (n, i) {
            ...
            return (
              null === i ||
                isNaN(+i) ||
                (T(e, "moment()." + e + "(period, number) is deprecated. Please use moment()." + e + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."),
                (a = n),
                (n = i),
                (i = a)),
        ...
        function tn(t, e, n, i) {
          var r = e._milliseconds,
            ...
            s = Ve(e._months);
          t.isValid() &&
            ((i = null == i || i), s && Yt(t, At(t, "Month") + s * n), o && Ft(t, "Date", At(t, "Date") + o * n), r && t._d.setTime(t._d.valueOf() + r * n), i && a.updateOffset(t, o || s));
        }
        (Xe.fn = ze.prototype),
          (Xe.invalid = function () {
            return Xe(NaN);
        ...
        (Mn.add = en),
          ...
          (Mn.isBetween = function (t, e, n, i) {
            var a = _(t) ? t : Le(t),
              r = _(e) ? e : Le(e);
            return (
              !!(this.isValid() && a.isValid() && r.isValid()) && ("(" === (i = i || "()")[0] ? this.isAfter(a, n) : !this.isBefore(a, n)) && (")" === i[1] ? this.isBefore(r, n) : !this.isAfter(r, n))
            );
          }),
          (Mn.isSame = function (t, e) {
            ...
            return (
              ...
              ("millisecond" === (e = R(e) || "millisecond") ? this.valueOf() === i.valueOf() : ((n = i.valueOf()), this.clone().startOf(e).valueOf() <= n && n <= this.clone().endOf(e).valueOf()))
            );
          }),
            ...
            for (this._weekdaysParse || ((this._weekdaysParse = []), (this._minWeekdaysParse = []), (this._shortWeekdaysParse = []), (this._fullWeekdaysParse = [])), i = 0; i < 7; i++) {
              if (
                ...
                this._weekdaysParse[i] ||
                  ((r = "^" + this.weekdays(a, "") + "|^" + this.weekdaysShort(a, "") + "|^" + this.weekdaysMin(a, "")), (this._weekdaysParse[i] = new RegExp(r.replace(".", ""), "i"))),
  ...
  var Si = {
      ...
      afterDatasetsUpdate: function (t, e) {
        ...
        for (i = 0; i < o; ++i)
          (r = null),
            (a = (n = t.getDatasetMeta(i)).dataset) && a._model && a instanceof kt.Line && (r = { visible: t.isDatasetVisible(i), fill: bi(a, i, o), chart: t, el: a }),
            (n.$filler = r),
            l.push(r);
      ...
      beforeDatasetsDraw: function (t) {
        ...
        for (n = l.length - 1; n >= 0; --n)
          (e = l[n].$filler) &&
            ...
            o && s && r.length && (B.canvas.clipArea(u, t.chartArea), Mi(u, r, o, a, s, i._loop), B.canvas.unclipArea(u)));
      },
    },
        ...
        if (((a.font = r.string), u)) {
          ...
          (a.textAlign = "left"),
            ...
            B.each(t.legendItems, function (t, e) {
              ...
              (0 === e || d[d.length - 1] + i + 2 * n.padding > l.width) && ((h += o + n.padding), (d[d.length - (e > 0 ? 0 : 1)] = 0)),
      ...
      if (n.display) {
        ...
        (e.fillStyle = B.valueOrDefault(n.fontColor, Y.global.defaultFontColor)),
          ...
          t.isHorizontal()
            ...
            : ((a = "left" === n.position ? h + l : f - l), (r = d + (c - d) / 2), (i = c - d), (u = Math.PI * ("left" === n.position ? -0.5 : 0.5))),
          e.save(),
          e.translate(a, r),
          e.rotate(u),
          (e.textAlign = "center"),
