...
!(function (t) {
      ...
      _setOptionClasses: function (t) {
        ...
        for (e in t)
          (s = this.classesElementLookup[e]),
            t[e] !== this.options.classes[e] && s && s.length && ((i = V(s.get())), this._removeClass(s, e), i.addClass(this._classes({ element: i, keys: e, classes: t, add: !0 })));
      },
            ...
            (m.fn[a] = function (t) {
              ...
              return "undefined" === i
                ...
                : ("function" === i && (i = P((t = t.call(this, o)))),
                  null == t && r.empty ? this : ("string" === i && (e = f.exec(t)) && (t = o + parseFloat(e[2]) * ("+" === e[1] ? 1 : -1)), (n[r.idx] = t), this[s](n)));
            });
        });
    }),
    (m.hook = function (t) {
  ...
  (y = V.effects),
    ...
    V.effects.define("highlight", "show", function (t, e) {
      ...
      "hide" === t.mode && (s.opacity = 0),
        ...
        i.css({ backgroundImage: "none", backgroundColor: t.color || "#ffff99" }).animate(s, { queue: !1, duration: t.duration, easing: t.easing, complete: e });
    }),
    ...
    (V.ui.formResetMixin = {
      ...
      _bindFormResetHandler: function () {
        ...
        (this.form = this.element._form()),
          this.form.length &&
            ((t = this.form.data("ui-form-reset-instances") || []).length || this.form.on("reset.ui-form-reset", this._formResetHandler), t.push(this), this.form.data("ui-form-reset-instances", t));
      },
  ...
  (V.ui.keyCode = {
      ...
      return this.length
        ? this[0].labels && this[0].labels.length
          ...
          : ((e = this.eq(0).parents("label")),
            (t = this.attr("id")) &&
              ((i = (i = this.eq(0).parents().last()).add((i.length ? i : this).siblings())), (t = "label[for='" + V.escapeSelector(t) + "']"), (e = e.add(i.find(t).addBack(t)))),
            this.pushStack(e))
        : this.pushStack([]);
    }),
    ...
    V.widget("ui.accordion", {
      ...
      _destroy: function () {
        ...
        this.element.removeAttr("role"),
          ...
          this._destroyIcons(),
          (t = this.headers.next().css("display", "").removeAttr("role Arial-hidden Arial-labelledby").removeUniqueId()),
      ...
      _setOptionDisabled: function (t) {
        this._super(t),
          this.element.attr("Arial-disabled", t),
        ...
        (this.active = this._findActive(t.active)),
          ...
          this.headers
            ...
            .each(function () {
              ...
              t.attr("Arial-controls", s), i.attr("Arial-labelledby", e);
            })
            .next()
            .attr("role", "tabpanel"),
          this.headers.not(this.active).attr({ "Arial-selected": "false", "Arial-expanded": "false", tabIndex: -1 }).next().attr({ "Arial-hidden": "true" }).hide(),
          this.active.length ? this.active.attr({ "Arial-selected": "true", "Arial-expanded": "true", tabIndex: 0 }).next().attr({ "Arial-hidden": "false" }) : this.headers.eq(0).attr("tabIndex", 0),
          this._createIcons(),
      ...
      _toggle: function (t) {
        ...
        this.prevShow.add(this.prevHide).stop(!0, !0),
          ...
          i.attr({ "Arial-hidden": "true" }),
          i.prev().attr({ "Arial-selected": "false", "Arial-expanded": "false" }),
          e.length && i.length
            ? i.prev().attr({ tabIndex: -1, "Arial-expanded": "false" })
            : e.length &&
              this.headers
                .filter(function () {
                ...
                .attr("tabIndex", -1),
          e.attr("Arial-hidden", "false").prev().attr({ "Arial-selected": "true", "Arial-expanded": "true", tabIndex: 0 });
      },
            ...
            ? t.length
              ? ((s = t.show().outerHeight()),
                ...
                void t.hide().animate(this.showProps, {
                  ...
                  step: function (t, e) {
                    (e.now = Math.round(t)),
                      "height" !== e.prop ? "content-box" === l && (r += e.now) : "content" !== a.options.heightStyle && ((e.now = Math.round(s - i.outerHeight() - r)), (r = 0));
                  },
                }))
    ...
    V.widget("ui.menu", {
      ...
      _destroy: function () {
        var t = this.element.find(".ui-menu-item").removeAttr("role Arial-disabled").children(".ui-menu-item-wrapper").removeUniqueId().removeAttr("tabIndex role Arial-haspopup");
        this.element.removeAttr("Arial-activedescendant").find(".ui-menu").addBack().removeAttr("role Arial-labelledby Arial-expanded Arial-hidden Arial-disabled tabIndex").removeUniqueId().show(),
      ...
      _activate: function (t) {
        this.active && !this.active.is(".ui-state-disabled") && (this.active.children("[Arial-haspopup='true']").length ? this.expand(t) : this.select(t));
      },
      refresh: function () {
        var t,
          e,
        ...
        this._toggleClass("ui-menu-icons", null, !!this.element.find(".ui-icon").length),
          (e = i
            .filter(":not(.ui-menu)")
            .hide()
            .attr({ role: this.options.role, "Arial-hidden": "true", "Arial-expanded": "false" })
            .each(function () {
              var t = V(this),
                e = t.prev(),
                i = V("<span>").data("ui-menu-submenu-caret", !0);
              s._addClass(i, "ui-menu-icon", "ui-icon " + n), e.attr("Arial-haspopup", "true").prepend(i), t.attr("Arial-labelledby", e.attr("id"));
            })),
          ...
          t.filter(".ui-state-disabled").attr("Arial-disabled", "true"),
      ...
      _setOptionDisabled: function (t) {
        this._super(t), this.element.attr("Arial-disabled", String(t)), this._toggleClass(null, "ui-state-disabled", !!t);
      },
      focus: function (t, e) {
        var i;
        this.blur(t, t && "focus" === t.type),
          ...
          this.options.role && this.element.attr("Arial-activedescendant", i.attr("id")),
      ...
      _open: function (t) {
        ...
        clearTimeout(this.timer),
          this.element.find(".ui-menu").not(t.parents(".ui-menu")).hide().attr("Arial-hidden", "true"),
          t.show().removeAttr("Arial-hidden").attr("Arial-expanded", "true").position(e);
      },
      ...
      _close: function (t) {
        (t = t || (this.active ? this.active.parent() : this.element)).find(".ui-menu").hide().attr("Arial-hidden", "true").attr("Arial-expanded", "false");
      },
      ...
      _move: function (t, e, i) {
        var s;
        ((s = this.active ? ("first" === t || "last" === t ? this.active["first" === t ? "prevAll" : "nextAll"](".ui-menu-item").last() : this.active[t + "All"](".ui-menu-item").first()) : s) &&
          s.length &&
          this.active) ||
  ...
  V.widget("ui.autocomplete", {
    ...
    _create: function () {
      ...
      (this.isMultiLine = e || (!t && this._isContentEditable(this.element))),
        ...
        this._on(this.menu.element, {
          ...
          menufocus: function (t, e) {
            ...
            (i = e.item.data("ui-autocomplete-item")),
              ...
              (i = e.item.attr("Arial-label") || i.value) && String.prototype.trim.call(i).length && (this.liveRegion.children().hide(), V("<div>").text(i).appendTo(this.liveRegion));
          },
        ...
        (this.liveRegion = V("<div>", { role: "status", "Arial-live": "assertive", "Arial-relevant": "additions" }).appendTo(this.document[0].body)),
      ...
      _updateIcon: function (t) {
        ...
        this.options.icon
          ? (this.icon || ((this.icon = V("<span>")), (this.iconSpace = V("<span> </span>")), this._addClass(this.iconSpace, "ui-checkboxradio-icon-space")),
            "checkbox" === this.type
              ? ((e += t ? "ui-icon-check ui-state-checked" : "ui-icon-blank"), this._removeClass(this.icon, null, t ? "ui-icon-blank" : "ui-icon-check"))
              : (e += "ui-icon-blank"),
  ...
  V.widget("ui.button", {
    ...
    _updateIcon: function (t, e) {
      ...
      this.icon
        ...
        : ((this.icon = V("<span>")), this._addClass(this.icon, "ui-button-icon", "ui-icon"), this.options.showLabel || this._addClass("ui-button-icon-only")),
    ...
    V.extend(st.prototype, {
      ...
      _enableDatepicker: function (e) {
        ...
        i.hasClass(this.markerClassName) &&
          ("input" === (t = e.nodeName.toLowerCase())
            ...
            : ("div" !== t && "span" !== t) ||
              ((i = i.children("." + this._inlineClass)).children().removeClass("ui-state-disabled"), i.find("select.ui-datepicker-month, select.ui-datepicker-year").prop("disabled", !1)),
      ...
      _disableDatepicker: function (e) {
        ...
        i.hasClass(this.markerClassName) &&
          ("input" === (t = e.nodeName.toLowerCase())
            ...
            : ("div" !== t && "span" !== t) ||
              ((i = i.children("." + this._inlineClass)).children().addClass("ui-state-disabled"), i.find("select.ui-datepicker-month, select.ui-datepicker-year").prop("disabled", !0)),
          (this._disabledInputs = V.map(this._disabledInputs, function (t) {
            return t === e ? null : t;
          })),
        ...
        "input" !== (t = t.target || t).nodeName.toLowerCase() && (t = V("input", t.parentNode)[0]),
          V.datepicker._isDisabledDatepicker(t) ||
            ...
            V.datepicker._curInst &&
              ...
              (V.datepicker._curInst.dpDiv.stop(!0, !0), n && V.datepicker._datepickerShowing && V.datepicker._hideDatepicker(V.datepicker._curInst.input[0])),
      ...
      _generateHTML: function (t) {
        var e,
          ...
          U = t.drawYear;
        if ((K < 0 && ((K += 12), U--), q))
          for (e = this._daylightSavingAdjust(new Date(q.getFullYear(), q.getMonth() - L[0] * L[1] + 1, q.getDate())), e = j && e < j ? j : e; this._daylightSavingAdjust(new Date(U, K, 1)) > e; )
            --K < 0 && ((K = 11), U--);
        for (
          t.drawMonth = K,
            t.drawYear = U,
      ...
      _generateMonthYearHeader: function (t, e, i, s, n, o, a, r) {
        ...
        if (o || !f) y += "<span class='ui-datepicker-month'>" + a[e] + "</span>";
          ...
          for (
            l = s && s.getFullYear() === i, h = n && n.getFullYear() === i, y += "<select class='ui-datepicker-month' Arial-label='" + _ + "' data-handler='selectMonth' data-event='change'>", c = 0;
            c < 12;
            c++
          )
          ...
          if (((t.yearshtml = ""), o || !g)) b += "<span class='ui-datepicker-year'>" + i + "</span>";
            ...
            for (
              a = this._get(t, "yearRange").split(":"),
                ...
                t.yearshtml += "<select class='ui-datepicker-year' Arial-label='" + v + "' data-handler='selectYear' data-event='change'>";
              d <= p;
              d++
            )
  ...
  V.widget("ui.draggable", V.ui.mouse, {
    ...
    _getParentOffset: function () {
      ...
      return (
        ...
        {
          top: (t = this._isRootNode(this.offsetParent[0]) ? { top: 0, left: 0 } : t).top + (parseInt(this.offsetParent.css("borderTopWidth"), 10) || 0),
        ...
        for (
          ...
          (l = (r = i.snapElements[v].left - i.margins.left) + i.snapElements[v].width),
            ...
            g < r - p || l + p < f || _ < h - p || c + p < m || !V.contains(i.snapElements[v].item.ownerDocument, i.snapElements[v].item)
              ? (i.snapElements[v].snapping && i.options.snap.release && i.options.snap.release.call(i.element, t, V.extend(i._uiHash(), { snapItem: i.snapElements[v].item })),
  ...
  V.widget("ui.dialog", {
    ...
    _createWrapper: function () {
      (this.uiDialog = V("<div>").hide().attr({ tabIndex: -1, role: "dialog" }).appendTo(this._appendTo())),
        ...
        this.element.find("[Arial-describedby]").length || this.uiDialog.attr({ "Arial-describedby": this.element.uniqueId().attr("id") });
    },
    _createTitlebar: function () {
      ...
      (this.uiDialogTitlebar = V("<div>")),
        ...
        this.uiDialog.attr({ "Arial-labelledby": t.attr("id") });
    },
    _title: function (t) {
    ...
    _setOption: function (t, e) {
      ...
      "disabled" !== t &&
        ...
        "resizable" === t &&
          ((i = s.is(":data(ui-resizable)")) && !e && s.resizable("destroy"), i && "string" == typeof e && s.resizable("option", "handles", e), i || !1 === e || this._makeResizable()),
  ...
  V.ui.droppable,
    V.widget("ui.progressbar", {
      ...
      _create: function () {
        (this.oldValue = this.options.value = this._constrainedValue()),
          this.element.attr({ role: "progressbar", "Arial-valuemin": this.min }),
      ...
      _destroy: function () {
        this.element.removeAttr("role Arial-valuemin Arial-valuemax Arial-valuenow"), this.valueDiv.remove();
      },
      value: function (t) {
      ...
      _setOptionDisabled: function (t) {
        this._super(t), this.element.attr("Arial-disabled", t), this._toggleClass(null, "ui-state-disabled", !!t);
      },
      ...
      _refreshValue: function () {
        ...
        this.valueDiv.toggle(this.indeterminate || t > this.min).width(e.toFixed(0) + "%"),
          ...
          this.indeterminate
            ? (this.element.removeAttr("Arial-valuenow"), this.overlayDiv || ((this.overlayDiv = V("<div>").appendTo(this.valueDiv)), this._addClass(this.overlayDiv, "ui-progressbar-overlay")))
            : (this.element.attr({ "Arial-valuemax": this.options.max, "Arial-valuenow": t }), this.overlayDiv && (this.overlayDiv.remove(), (this.overlayDiv = null))),
    ...
    V.widget("ui.selectmenu", [
      V.ui.formResetMixin,
      {
        ...
        _drawMenu: function () {
          var i = this;
          (this.menu = V("<ul>", { "Arial-hidden": "true", "Arial-labelledby": this.ids.button, id: this.ids.menu })),
              ...
              .menu({
                ...
                focus: function (t, e) {
                  ...
                  null != i.focusIndex && e.index !== i.focusIndex && (i._trigger("focus", t, { item: e }), i.isOpen || i._select(e, t)),
                    ...
                    i.button.attr("Arial-activedescendant", i.menuItems.eq(e.index).attr("id"));
                },
              })
              .menu("instance")),
        ...
        _refreshMenu: function () {
          ...
          this.menu.empty(),
            ...
            (this._rendered = !0),
            t.length && ((t = this._getSelectedItem()), this.menuInstance.focus(null, t), this._setArial(t.data("ui-selectmenu-item")), this._setOption("disabled", this.element.prop("disabled")));
        },
        open: function (t) {
          this.options.disabled ||
        ...
        _setArial: function (t) {
          t = this.menuItems.eq(t.index).attr("id");
          this.button.attr({ "Arial-labelledby": t, "Arial-activedescendant": t }), this.menu.attr("Arial-activedescendant", t);
        },
        _setOption: function (t, e) {
          var i;
        ...
        _setOptionDisabled: function (t) {
          this._super(t),
            ...
            this.button.attr("Arial-disabled", t),
    ...
    V.widget("ui.slider", V.ui.mouse, {
      ...
      _slide: function (t, e, i) {
        ...
        this._hasMultipleValues() &&
          ((s = this.values(e ? 0 : 1)), (n = this.values(e)), 2 === this.options.values.length && !0 === this.options.range && (i = 0 === e ? Math.min(s, i) : Math.max(s, i)), (o[e] = i)),
      ...
      _contactContainers: function (t) {
        ...
        if ((this.innermostContainer = c))
          if (1 === this.containers.length) this.containers[u].containerCache.over || (this.containers[u]._trigger("over", t, this._uiHash(this)), (this.containers[u].containerCache.over = 1));
            ...
            for (
              i = 1e4, s = null, n = (l = c.floating || this._isFloating(this.currentItem)) ? "left" : "top", o = l ? "width" : "height", h = l ? "pageX" : "pageY", e = this.items.length - 1;
              0 <= e;
              e--
            )
  ...
  V.widget("ui.spinner", {
    ...
    _refresh: function () {
      this.element.attr({ "Arial-valuemin": this.options.min, "Arial-valuemax": this.options.max, "Arial-valuenow": this._parse(this.element.val()) });
    },
    isValid: function () {
      var t = this.value();
    ...
    _destroy: function () {
      this.element.prop("disabled", !1).removeAttr("autocomplete role Arial-valuemin Arial-valuemax Arial-valuenow"), this.uiSpinner.replaceWith(this.element);
    },
  ...
  V.widget("ui.tabs", {
        ...
        null === i &&
          (s &&
            this.tabs.each(function (t, e) {
              if (V(e).attr("Arial-controls") === s) return (i = t), !1;
            }),
    ...
    _tabKeydown: function (t) {
      ...
      if (!this._handlePageNav(t)) {
        ...
        t.preventDefault(),
          ...
          t.ctrlKey ||
            t.metaKey ||
            (e.attr("Arial-selected", "false"),
            this.tabs.eq(i).attr("Arial-selected", "true"),
    ...
    _refresh: function () {
      this._setOptionDisabled(this.options.disabled),
        ...
        this.tabs.not(this.active).attr({ "Arial-selected": "false", "Arial-expanded": "false", tabIndex: -1 }),
        this.panels.not(this._getPanelForTab(this.active)).hide().attr({ "Arial-hidden": "true" }),
        this.active.length
          ? (this.active.attr({ "Arial-selected": "true", "Arial-expanded": "true", tabIndex: 0 }),
            this._addClass(this.active, "ui-tabs-active", "ui-state-active"),
            this._getPanelForTab(this.active).show().attr({ "Arial-hidden": "false" }))
      ...
      (this.tablist = this._getList().attr("role", "tablist")),
        ...
        this.anchors.each(function (t, e) {
          var i,
            ...
            a = V(e).closest("li"),
            r = a.attr("Arial-controls");
          l._isLocal(e)
            ? ((n = (i = e.hash).substring(1)), (s = l.element.find(l._sanitizeSelector(i))))
            : ((n = a.attr("Arial-controls") || V({}).uniqueId()[0].id),
              (s = l.element.find((i = "#" + n))).length || (s = l._createPanel(n)).insertAfter(l.panels[t - 1] || l.tablist),
              s.attr("Arial-live", "polite")),
            s.length && (l.panels = l.panels.add(s)),
            r && a.data("ui-tabs-Arial-controls", r),
            a.attr({ "Arial-controls": n, "Arial-labelledby": o }),
            s.attr("Arial-labelledby", o);
        }),
    ...
    _setOptionDisabled: function (t) {
      ...
      for (Array.isArray(t) && (t.length ? t.length === this.anchors.length && (t = !0) : (t = !1)), i = 0; (e = this.tabs[i]); i++)
        (e = V(e)),
          !0 === t || -1 !== V.inArray(i, t)
            ? (e.attr("Arial-disabled", "true"), this._addClass(e, null, "ui-state-disabled"))
            : (e.removeAttr("Arial-disabled"), this._removeClass(e, null, "ui-state-disabled"));
    ...
    _toggle: function (t, e) {
      ...
      (this.running = !0),
        ...
        n.attr("Arial-hidden", "true"),
        e.oldTab.attr({ "Arial-selected": "false", "Arial-expanded": "false" }),
        s.length && n.length
          ...
          : s.length &&
            this.tabs
              ...
              .attr("tabIndex", -1),
        s.attr("Arial-hidden", "false"),
        e.newTab.attr({ "Arial-selected": "true", "Arial-expanded": "true", tabIndex: 0 });
    },
    _activate: function (t) {
    ...
    _destroy: function () {
      this.xhr && this.xhr.abort(),
        ...
        this.tabs.add(this.panels).each(function () {
          V.data(this, "ui-tabs-destroy") ? V(this).remove() : V(this).removeAttr("role tabIndex Arial-live Arial-busy Arial-selected Arial-labelledby Arial-hidden Arial-expanded");
        }),
        this.tabs.each(function () {
          var t = V(this),
            e = t.data("ui-tabs-Arial-controls");
          e ? t.attr("Arial-controls", e).removeData("ui-tabs-Arial-controls") : t.removeAttr("Arial-controls");
        }),
        this.panels.show(),
    ...
    load: function (t, s) {
      t = this._getIndex(t);
      function n(t, e) {
        "abort" === e && o.panels.stop(!1, !0), o._removeClass(i, "ui-tabs-loading"), a.removeAttr("Arial-busy"), t === o.xhr && delete o.xhr;
      }
      var o = this,
        i = this.tabs.eq(t),
  ...
  V.widget("ui.tooltip", {
    ...
    _addDescribedBy: function (t, e) {
      var i = (t.attr("Arial-describedby") || "").split(/\s+/);
      i.push(e), t.data("ui-tooltip-id", e).attr("Arial-describedby", String.prototype.trim.call(i.join(" ")));
    },
    _removeDescribedBy: function (t) {
      var e = t.data("ui-tooltip-id"),
        i = (t.attr("Arial-describedby") || "").split(/\s+/),
        e = V.inArray(e, i);
      -1 !== e && i.splice(e, 1), t.removeData("ui-tooltip-id"), (i = String.prototype.trim.call(i.join(" "))) ? t.attr("Arial-describedby", i) : t.removeAttr("Arial-describedby");
    },
    _create: function () {
      this._on({ mouseover: "open", focusin: "open" }),
        (this.tooltips = {}),
        (this.parents = {}),
        (this.liveRegion = V("<div>").attr({ role: "log", "Arial-live": "assertive", "Arial-relevant": "additions" }).appendTo(this.document[0].body)),
        this._addClass(this.liveRegion, null, "ui-helper-hidden-accessible"),
