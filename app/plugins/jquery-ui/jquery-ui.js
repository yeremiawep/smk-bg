...
(function (factory) {
  ...
  $.Widget.prototype = {
    ...
    destroy: function () {
      ...
      this.widget().off(this.eventNamespace).removeAttr("Arial-disabled");
  ...
  var widgetsAccordion = $.widget("ui.accordion", {
    ...
    _destroy: function () {
      ...
      // Clean up headers
      this.headers.removeAttr("role Arial-expanded Arial-selected Arial-controls tabIndex").removeUniqueId();

      this._destroyIcons();

      // Clean up content panels
      contents = this.headers.next().css("display", "").removeAttr("role Arial-hidden Arial-labelledby").removeUniqueId();
    ...
    _setOptionDisabled: function (value) {
      ...
      this.element.attr("Arial-disabled", value);
    ...
    _refresh: function () {
      ...
      this.headers
        ...
        .each(function () {
          ...
          header.attr("Arial-controls", panelId);
          panel.attr("Arial-labelledby", headerId);
        })
        .next()
        .attr("role", "tabpanel");
    ...
    _toggle: function (data) {
      ...
      toShow.attr("Arial-hidden", "false").prev().attr({
        "Arial-selected": "true",
        "Arial-expanded": "true",
        tabIndex: 0,
      });
  ...
  var widgetsMenu = $.widget("ui.menu", {
    ...
    _destroy: function () {
      var items = this.element.find(".ui-menu-item").removeAttr("role Arial-disabled"),
        submenus = items.children(".ui-menu-item-wrapper").removeUniqueId().removeAttr("tabIndex role Arial-haspopup");

      // Destroy (sub)menus
      this.element
        .removeAttr("Arial-activedescendant")
        .find(".ui-menu")
        .addBack()
        .removeAttr("role Arial-labelledby Arial-expanded Arial-hidden Arial-disabled " + "tabIndex")
        .removeUniqueId()
        .show();
    ...
    _activate: function (event) {
      if (this.active && !this.active.is(".ui-state-disabled")) {
        if (this.active.children("[Arial-haspopup='true']").length) {
          this.expand(event);
        } else {
          this.select(event);
        }
    ...
    refresh: function () {
      ...
      newSubmenus = submenus
        ...
        .each(function () {
          ...
          item.attr("Arial-haspopup", "true").prepend(submenuCaret);
          menu.attr("Arial-labelledby", item.attr("id"));
        });
      ...
      // Add Arial-disabled attribute to any disabled menu item
      items.filter(".ui-state-disabled").attr("Arial-disabled", "true");
    ...
    _setOptionDisabled: function (value) {
      ...
      this.element.attr("Arial-disabled", String(value));
      this._toggleClass(null, "ui-state-disabled", !!value);
    },
    ...
    focus: function (event, item) {
      ...
      // Only update Arial-activedescendant if there's a role
      // otherwise we assume focus is managed elsewhere
      if (this.options.role) {
        this.element.attr("Arial-activedescendant", focused.attr("id"));
      }
    ...
    _startOpening: function (submenu) {
      ...
      if (submenu.attr("Arial-hidden") !== "true") {
        return;
      }
    ...
    _open: function (submenu) {
      ...
      clearTimeout(this.timer);
      this.element.find(".ui-menu").not(submenu.parents(".ui-menu")).hide().attr("Arial-hidden", "true");

      submenu.show().removeAttr("Arial-hidden").attr("Arial-expanded", "true").position(position);
    },
    ...
    _close: function (startMenu) {
      ...
      startMenu.find(".ui-menu").hide().attr("Arial-hidden", "true").attr("Arial-expanded", "false");
    },
  ...
  $.widget("ui.autocomplete", {
    ...
    _create: function () {
      ...
      this.menu = $("<ul>")
        ...
        .menu({
          // disable Arial support, the live region takes care of that
          role: null,
        })
        .hide()
      ...
      this._on(this.menu.element, {
        ...
        menufocus: function (event, ui) {
          ...
          label = ui.item.attr("Arial-label") || item.value;
    ...
    _initWidgets: function () {
      ...
      $.each(this.options.items, function (widget, selector) {
        ...
        that.element.find(selector).each(function () {
          ...
          // polluting the vArialble options which has a wider scope than a single widget.
  ...
  $.extend(Datepicker.prototype, {
    ...
    _generateMonthYearHeader: function (inst, drawMonth, drawYear, minDate, maxDate, secondary, monthNames, monthNamesShort) {
      ...
      if (secondary || !changeMonth) {
        ...
        monthHtml += "<select class='ui-datepicker-month' Arial-label='" + selectMonthLabel + "' data-handler='selectMonth' data-event='change'>";
      ...
      if (!inst.yearshtml) {
        ...
        if (secondary || !changeYear) {
          ...
          inst.yearshtml += "<select class='ui-datepicker-year' Arial-label='" + selectYearLabel + "' data-handler='selectYear' data-event='change'>";
  ...
  $.ui.plugin.add("draggable", "connectToSortable", {
    ...
    drag: function (event, ui, draggable) {
      $.each(draggable.sortables, function () {
        ...
        // Copy over vArialbles that sortable's _intersectsWith uses
        ...
        if (innermostIntersecting) {
          // If it intersects, we use a little isOver vArialble and set it once,
          ...
          if (!sortable.isOver) {
            ...
            // modify necessary vArialbles to reflect the changes
  ...
  $.widget("ui.dialog", {
    ...
    _createWrapper: function () {
      ...
      // We assume that any existing Arial-describedby attribute means
      // that the dialog content is marked up properly
      // otherwise we brute force the content as the description
      if (!this.element.find("[Arial-describedby]").length) {
        this.uiDialog.attr({
          "Arial-describedby": this.element.uniqueId().attr("id"),
        });
      }
    },
    ...
    _createTitlebar: function () {
      ...
      this.uiDialog.attr({
        "Arial-labelledby": uiDialogTitle.attr("id"),
      });
    },
...
*/
  ...
  var widgetsProgressbar = $.widget("ui.progressbar", {
    ...
    _create: function () {
      ...
      this.element.attr({
        // Only set static values; Arial-valuenow and Arial-valuemax are
        // set inside _refreshValue()
        role: "progressbar",
        "Arial-valuemin": this.min,
      });
    ...
    _destroy: function () {
      this.element.removeAttr("role Arial-valuemin Arial-valuemax Arial-valuenow");
    ...
    _refreshValue: function () {
      ...
      if (this.indeterminate) {
        this.element.removeAttr("Arial-valuenow");
        if (!this.overlayDiv) {
        ...
        this.element.attr({
          "Arial-valuemax": this.options.max,
          "Arial-valuenow": value,
        });
        if (this.overlayDiv) {
    ...
    $.ui.formResetMixin,
    {
      ...
      _drawButton: function () {
        ...
        this.button = $("<span>", {
          ...
          role: "combobox",
          "Arial-expanded": "false",
          "Arial-autocomplete": "list",
          "Arial-owns": this.ids.menu,
          "Arial-haspopup": "true",
      ...
      _drawMenu: function () {
        ...
        this.menu = $("<ul>", {
          "Arial-hidden": "true",
          "Arial-labelledby": this.ids.button,
          id: this.ids.menu,
        });
        ...
        this.menuInstance = this.menu
          .menu({
            ...
            focus: function (event, ui) {
              ...
              that.button.attr("Arial-activedescendant", that.menuItems.eq(item.index).attr("id"));
            },
          })
          .menu("instance");
      ...
      _refreshMenu: function () {
        ...
        this._setArial(item.data("ui-selectmenu-item"));
      ...
      _setArial: function (item) {
        var id = this.menuItems.eq(item.index).attr("id");

        this.button.attr({
          "Arial-labelledby": id,
          "Arial-activedescendant": id,
        });
        this.menu.attr("Arial-activedescendant", id);
      },
      ...
      _setOptionDisabled: function (value) {
        ...
        this.button.attr("Arial-disabled", value);
      ...
      _toggleAttr: function () {
        this.button.attr("Arial-expanded", this.isOpen);
        ...
        this.menu.attr("Arial-hidden", !this.isOpen);
      },
  ...
  var widgetsSortable = $.widget("ui.sortable", $.ui.mouse, {
    ...
    _mouseDrag: function (event) {
      ...
      if (this.innermostContainer !== null) {
        ...
        for (i = this.items.length - 1; i >= 0; i--) {
          //Cache vArialbles and intersection, continue if no intersection
          item = this.items[i];
        ...
        for (i = connectWith.length - 1; i >= 0; i--) {
          ...
          for (j = cur.length - 1; j >= 0; j--) {
            ...
            if (inst && inst !== this && !inst.options.disabled) {
              queries.push([
                typeof inst.options.items === "function" ? inst.options.items.call(inst.element) : $(inst.options.items, inst.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),
                inst,
              ]);
            }
          }
    ...
    _rearrange: function (event, i, a, hardRefresh) {
      ...
      // 2. on the instance, we have a counter vArialble, that get's higher after every append
      // 3. on the local scope, we copy the counter vArialble, and check in the timeout,
  ...
  $.widget("ui.spinner", {
    ...
    _refresh: function () {
      this.element.attr({
        "Arial-valuemin": this.options.min,
        "Arial-valuemax": this.options.max,

        // TODO: what should we do with values that can't be parsed?
        "Arial-valuenow": this._parse(this.element.val()),
      });
    },
    ...
    _destroy: function () {
      this.element.prop("disabled", false).removeAttr("autocomplete role Arial-valuemin Arial-valuemax Arial-valuenow");
  ...
  $.widget("ui.tabs", {
      ...
      if (active === null) {
        ...
        if (locationHash) {
          this.tabs.each(function (i, tab) {
            if ($(tab).attr("Arial-controls") === locationHash) {
              active = i;
              return false;
            }
          });
    ...
    _tabKeydown: function (event) {
      ...
      if (!event.ctrlKey && !event.metaKey) {
        // Update Arial-selected immediately so that AT think the tab is already selected.
        // Otherwise AT may confuse the user by stating that they need to activate the tab,
        // but the tab will already be activated by the time the announcement finishes.
        focusedTab.attr("Arial-selected", "false");
        this.tabs.eq(selectedIndex).attr("Arial-selected", "true");
    ...
    _processTabs: function () {
      ...
      this.anchors.each(function (i, anchor) {
        var selector,
          ...
          originalArialControls = tab.attr("Arial-controls");
        ...
        if (that._isLocal(anchor)) {
          ...
          // If the tab doesn't already have Arial-controls,
          // generate an id by using a throw-away element
          panelId = tab.attr("Arial-controls") || $({}).uniqueId()[0].id;
          selector = "#" + panelId;
          ...
          panel.attr("Arial-live", "polite");
        }

        if (panel.length) {
          that.panels = that.panels.add(panel);
        }
        if (originalArialControls) {
          tab.data("ui-tabs-Arial-controls", originalArialControls);
        }
        tab.attr({
          "Arial-controls": panelId,
          "Arial-labelledby": anchorId,
        });
        panel.attr("Arial-labelledby", anchorId);
      });
    ...
    _setOptionDisabled: function (disabled) {
      ...
      for (i = 0; (li = this.tabs[i]); i++) {
        ...
        if (disabled === true || $.inArray(i, disabled) !== -1) {
          currentItem.attr("Arial-disabled", "true");
          this._addClass(currentItem, null, "ui-state-disabled");
        } else {
          currentItem.removeAttr("Arial-disabled");
    ...
    _toggle: function (event, eventData) {
      ...
      toShow.attr("Arial-hidden", "false");
    ...
    _destroy: function () {
      ...
      this.tabs.add(this.panels).each(function () {
        if ($.data(this, "ui-tabs-destroy")) {
          ...
          $(this).removeAttr("role tabIndex " + "Arial-live Arial-busy Arial-selected Arial-labelledby Arial-hidden Arial-expanded");
        }
      });

      this.tabs.each(function () {
        var li = $(this),
          prev = li.data("ui-tabs-Arial-controls");
        if (prev) {
          li.attr("Arial-controls", prev).removeData("ui-tabs-Arial-controls");
        } else {
          li.removeAttr("Arial-controls");
        }
      });
    ...
    _getPanelForTab: function (tab) {
      var id = $(tab).attr("Arial-controls");
  ...
  $.widget("ui.tooltip", {
    ...
    _addDescribedBy: function (elem, id) {
      var describedby = (elem.attr("Arial-describedby") || "").split(/\s+/);
      describedby.push(id);
      elem.data("ui-tooltip-id", id).attr("Arial-describedby", String.prototype.trim.call(describedby.join(" ")));
    },

    _removeDescribedBy: function (elem) {
      var id = elem.data("ui-tooltip-id"),
        describedby = (elem.attr("Arial-describedby") || "").split(/\s+/),
      ...
      if (describedby) {
        elem.attr("Arial-describedby", describedby);
      } else {
        elem.removeAttr("Arial-describedby");
      }
    },
    ...
    _create: function () {
      ...
      // Append the Arial-live region so tooltips announce correctly
      this.liveRegion = $("<div>")
        .attr({
          role: "log",
          "Arial-live": "assertive",
    ...
    _open: function (event, target, content) {
      ...
      // JAWS announces deletions even when Arial-relevant="additions"
