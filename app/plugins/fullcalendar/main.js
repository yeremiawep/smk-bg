...
var FullCalendar = (function (exports) {
  ...
  function j$2(n, l, u, i, t, o, e, c) {
    ...
    if (null === _) p === d || (c && n.data === d) || (n.data = d);
      ...
      else if (((k = l.props.children), m(n, Array.isArray(k) ? k : [k], l, u, i, t && "foreignObject" !== _, o, e, n.firstChild, c), null != o)) for (k = o.length; k--; ) null != o[k] && s(o[k]);
      c ||
  ...
  // Arial workarounds
  // ----------------------------------------------------------------------------------------------------------------
  function createArialClickAttrs(handler) {
    return __assign({ onClick: handler }, createArialKeyboardAttrs(handler));
  }
  function createArialKeyboardAttrs(handler) {
    return {
      tabIndex: 0,
  ...
  function buildSegCompareObj(seg) {
    ...
    return __assign(__assign(__assign({}, eventDef.extendedProps), eventDef), { id: eventDef.publicId, start: start, end: end, duration: end - start, allDay: Number(eventDef.allDay), _seg: seg });
  }
  ...
  function getSegAnchorAttrs(seg, context) {
    ...
    if (eventInteractive) {
      ...
      return createArialKeyboardAttrs(function (ev) {
  ...
  function triggerDateSelect(selection, pev, context) {
    context.emitter.trigger(
      "select",
      __assign(__assign({}, buildDateSpanApiWithContext(selection, context)), { jsEvent: pev ? pev.origEvent : null, view: context.viewApi || context.calendarApi.view })
    );
  }
  ...
  function buildNavLinkAttrs(context, dateMarker, viewType, isTabbable) {
    ...
    if (options.navLinks) {
      ...
      return __assign(
        ...
        isTabbable ? createArialClickAttrs(handleInteraction) : { onClick: handleInteraction }
      );
    }
    return { "Arial-label": dateStr };
  }
      ...
      return createElement(ViewContextType.Consumer, null, function (context) {
        return createElement(ViewRoot, { viewSpec: context.viewSpec }, function (viewElRef, viewClassNames) {
          ...
          return createElement(
            RenderHook,
            { hookProps: hookProps, classNames: options.classNames, content: options.content, didMount: options.didMount, willUnmount: options.willUnmount, elRef: viewElRef },
  ...
  var DateProfileGenerator = /** @class */ (function () {
    ...
    /* Hidden Days
        ------------------------------------------------------------------------------------------------------------------*/
    // Initializes internal vArialbles related to calculating hidden days-of-week
  ...
  var ViewContainer = /** @class */ (function (_super) {
    ...
    ViewContainer.prototype.render = function () {
      ...
      return createElement(
        "div",
        { "Arial-labelledby": props.labeledById, ref: this.handleEl, className: classNames.join(" "), style: { height: height, paddingBottom: paddingBottom } },
        props.children
      );
    };
  ...
  var CalendarContent = /** @class */ (function (_super) {
    ...
    CalendarContent.prototype.render = function () {
      ...
      return createElement(
        ...
        createElement(ViewContainer, { liquid: viewVGrow, height: viewHeight, aspectRatio: viewAspectRatio, labeledById: viewLabelId }, this.renderView(props), this.buildAppendContent()),
        ...
        function (rootElRef, customClassNames, innerElRef, innerContent) {
          return createElement(
            ...
            createElement(
              ...
              !dayMeta.isDisabled &&
                createElement("a", __assign({ ref: innerElRef, className: ["fc-col-header-cell-cushion", props.isSticky ? "fc-sticky" : ""].join(" ") }, navLinkAttrs), innerContent)
            )
          );
        }
      );
        ...
        function (rootElRef, customClassNames, innerElRef, innerContent) {
          return createElement(
            ...
            createElement(
              ...
              createElement(
                "a",
                { "Arial-label": dateEnv.format(date, WEEKDAY_FORMAT), className: ["fc-col-header-cell-cushion", props.isSticky ? "fc-sticky" : ""].join(" "), ref: innerElRef },
                innerContent
              )
            )
          );
  ...
  var Slicer = /** @class */ (function () {
    ...
    Slicer.prototype._sliceBusinessHours = function (businessHours, dateProfile, nextDayThreshold, context) {
      ...
      return this._sliceEventStore.apply(
        this,
        __spreadArray([expandRecurring(businessHours, computeActiveRange(dateProfile, Boolean(nextDayThreshold)), context), {}, dateProfile, nextDayThreshold], extraArgs)
      ).bg;
    };
  ...
  var SimpleScrollGrid = /** @class */ (function (_super) {
    ...
    SimpleScrollGrid.prototype.render = function () {
      ...
      return createElement(
        ...
        Boolean(!isBuggy && headSectionNodes.length) && createElement.apply(void 0, __spreadArray(["thead", roleAttrs], headSectionNodes)),
        Boolean(!isBuggy && bodySectionNodes.length) && createElement.apply(void 0, __spreadArray(["tbody", roleAttrs], bodySectionNodes)),
        Boolean(!isBuggy && footSectionNodes.length) && createElement.apply(void 0, __spreadArray(["tfoot", roleAttrs], footSectionNodes)),
        isBuggy && createElement.apply(void 0, __spreadArray(__spreadArray(__spreadArray(["tbody", roleAttrs], headSectionNodes), bodySectionNodes), footSectionNodes))
      );
    };
    SimpleScrollGrid.prototype.renderSection = function (sectionConfig, microColGroupNode, isHeader) {
      ...
      return createElement(
        "tr",
        { key: sectionConfig.key, role: "presentation", className: getSectionClassNames(sectionConfig, this.props.liquid).join(" ") },
  ...
  var Popover = /** @class */ (function (_super) {
    ...
    Popover.prototype.render = function () {
      ...
      return createPortal(
        createElement(
          "div",
          __assign({ id: props.id, className: classNames.join(" "), "Arial-labelledby": state.titleId }, props.extraAttrs, { ref: this.handleRootEl }),
          createElement(
            "div",
    ...
    function Calendar(el, optionOverrides) {
      ...
      _this.handleRenderRequest = function () {
        if (_this.isRendering) {
          ...
          render(
            createElement(CalendarRoot, { options: currentData_1.calendarOptions, theme: currentData_1.theme, emitter: currentData_1.emitter }, function (classNames, height, isHeightAuto, forPrint) {
          ...
          if (validMutation) {
            ...
            if (receivingContext_1 === initialContext_1) {
              ...
              initialContext_1.emitter.trigger(
                "eventDrop",
                __assign(__assign(__assign({}, eventChangeArg), transformed), { el: ev.subjectEl, delta: validMutation.datesDelta, jsEvent: ev.origEvent, view: initialView })
              );
              ...
              receivingContext_1.emitter.trigger(
                "drop",
                __assign(__assign({}, buildDatePointApiWithContext(finalHit.dateSpan, receivingContext_1)), { draggedEl: ev.subjectEl, jsEvent: ev.origEvent, view: finalHit.context.viewApi })
              );
      ...
      this.handleDragEnd = function (pev) {
        ...
        if (receivingContext && droppableEvent) {
          ...
          receivingContext.emitter.trigger(
            "drop",
            __assign(__assign({}, buildDatePointApiWithContext(finalHit.dateSpan, receivingContext)), { draggedEl: pev.subjectEl, jsEvent: pev.origEvent, view: finalView })
          );
          if (dragMeta.create) {
  ...
  var TableCellTop = /** @class */ (function (_super) {
    ...
    TableCellTop.prototype.render = function () {
      ...
      return createElement(
        DayCellContent,
        { date: props.date, dateProfile: props.dateProfile, todayRange: props.todayRange, showDayNumber: props.showDayNumber, extraHookProps: props.extraHookProps, defaultContent: renderTopInner },
      ...
      return createElement(
              ...
              allSegs.map(function (seg) {
                ...
                return createElement(
                  ...
                  hasListItemDisplay(seg)
                    ? createElement(
                        TableListItemEvent,
                        __assign({ seg: seg, isDragging: false, isSelected: instanceId === props.eventSelection, defaultDisplayEventEnd: false }, getSegMeta(seg, props.todayRange))
                      )
                    : createElement(
                        TableBlockEvent,
                        __assign(
                          { seg: seg, isDragging: false, isResizing: false, isDateSelecting: false, isSelected: instanceId === props.eventSelection, defaultDisplayEventEnd: false },
        ...
        function (rootElRef, classNames, innerElRef, innerContent, handleClick, title, isExpanded, popoverId) {
          return createElement(
            "a",
            __assign(
              { ref: rootElRef, className: ["fc-daygrid-more-link"].concat(classNames).join(" "), title: title, "Arial-expanded": isExpanded, "Arial-controls": popoverId },
              createArialClickAttrs(handleClick)
            ),
            innerContent
          );
        }
  ...
  var TableCell = /** @class */ (function (_super) {
    ...
    TableCell.prototype.render = function () {
      ...
      return createElement(
        DayCellRoot,
        { date: date, dateProfile: dateProfile, todayRange: props.todayRange, showDayNumber: props.showDayNumber, extraHookProps: props.extraHookProps, elRef: this.handleRootEl },
        function (dayElRef, dayClassNames, rootDataAttrs, isDisabled) {
          return createElement(
            "td",
            __assign(
              { ref: dayElRef, role: "gridcell", className: ["fc-daygrid-day"].concat(dayClassNames, props.extraClassNames || []).join(" ") },
              rootDataAttrs,
              props.extraDataAttrs,
              props.showDayNumber ? { "Arial-labelledby": state.dayNumberId } : {}
            ),
            createElement(
              "div",
              { className: "fc-daygrid-day-frame fc-scrollgrid-sync-inner", ref: props.innerElRef /* different from hook system! RENAME */ },
              props.showWeekNumber &&
                createElement(WeekNumberRoot, { date: date, defaultFormat: DEFAULT_WEEK_NUM_FORMAT$1 }, function (weekElRef, weekClassNames, innerElRef, innerContent) {
          ...
          nodes.push(
            createElement(
              ...
              hasListItemDisplay(seg)
                ? createElement(
                    TableListItemEvent,
                    __assign({ seg: seg, isDragging: isDragging, isSelected: instanceId === eventSelection, defaultDisplayEventEnd: defaultDisplayEventEnd }, getSegMeta(seg, todayRange))
                  )
                : createElement(
                    TableBlockEvent,
                    __assign(
  ...
  var DayTableView = /** @class */ (function (_super) {
    ...
    DayTableView.prototype.render = function () {
      ...
      var headerContent =
        options.dayHeaders && createElement(DayHeader, { ref: this.headerRef, dateProfile: props.dateProfile, dates: dayTableModel.headerDates, datesRepDistinctDays: dayTableModel.rowCnt === 1 });
      ...
      _this.renderHeadAxis = function (rowKey, frameHeight) {
        ...
        if (options.weekNumbers && rowKey === "day") {
          return createElement(WeekNumberRoot, { date: range.start, defaultFormat: DEFAULT_WEEK_NUM_FORMAT }, function (rootElRef, classNames, innerElRef, innerContent) {
            return createElement(
              "th",
              { ref: rootElRef, "Arial-hidden": true, className: ["fc-timegrid-axis", "fc-scrollgrid-shrink"].concat(classNames).join(" ") },
              createElement(
                "div",
        ...
        return createElement("th", { "Arial-hidden": true, className: "fc-timegrid-axis" }, createElement("div", { className: "fc-timegrid-axis-frame", style: { height: frameHeight } }));
      };
            ...
            content: function (arg) {
              return (
                ...
                createElement(
                  ...
                  createElement(
                    "table",
                    { "Arial-hidden": true, style: { height: arg.expandRows ? arg.clientHeight : "" } },
                    arg.tableColGroupNode,
      ...
      return createElement(
        ...
        props.slatMetas.map(function (slatMeta, i) {
          ...
          return createElement(
            ...
            createElement(
              RenderHook,
              { hookProps: hookProps, classNames: options.slotLaneClassNames, content: options.slotLaneContent, didMount: options.slotLaneDidMount, willUnmount: options.slotLaneWillUnmount },
              function (rootElRef, customClassNames, innerElRef, innerContent) {
        ...
        function (rootElRef, classNames, innerElRef, innerContent, handleClick, title, isExpanded, popoverId) {
          return createElement(
            "a",
            {
              ...
              onClick: handleClick,
              title: title,
              "Arial-expanded": isExpanded,
              "Arial-controls": popoverId,
            },
  ...
  var TimeCol = /** @class */ (function (_super) {
        ...
        segPlacements.map(function (segPlacement) {
          ...
          return createElement(
            ...
            createElement(
              TimeColEvent,
              __assign(
                { seg: seg, isDragging: isDragging, isResizing: isResizing, isDateSelecting: isDateSelecting, isSelected: instanceId === eventSelection, isShort: isShort },
    ...
    TimeCol.prototype.renderFillSegs = function (segs, fillType) {
      ...
      var children = segVCoords.map(function (vcoords, i) {
        ...
        return createElement(
          "div",
          { key: buildEventRangeKey(seg.eventRange), className: "fc-timegrid-bg-harness", style: computeSegVStyle(vcoords) },
      ...
      return segs.map(function (seg, i) {
        return createElement(
          ...
          function (rootElRef, classNames, innerElRef, innerContent) {
            return createElement(
              "div",
              { ref: rootElRef, className: ["fc-timegrid-now-indicator-line"].concat(classNames).join(" "), style: { top: slatCoords.computeDateTop(seg.start, date) } },
              innerContent
            );
          }
        );
    ...
    return createElement(
      ...
      sortedFgSegs.map(function (seg) {
        ...
        return createElement(
          ...
          createElement(
            TimeColEvent,
            __assign({ seg: seg, isDragging: false, isResizing: false, isDateSelecting: false, isSelected: instanceId === eventSelection, isShort: false }, getSegMeta(seg, todayRange, nowDate))
          )
        );
      })
    );
          ...
          createElement(
            ...
            createElement(
              ...
              props.axis &&
                createElement(
                  "td",
                  { "Arial-hidden": true, className: "fc-timegrid-col fc-timegrid-axis" },
                  createElement(
                    "div",
                    { className: "fc-timegrid-col-frame" },
                    createElement(
      ...
      return createElement(
        ...
        function (rootElRef, customClassNames, innerElRef, innerContent) {
          return createElement(
            ...
            createElement(
              "th",
              { scope: "colgroup", colSpan: 3, id: cellId, "Arial-labelledby": textId },
  ...
  function renderInnerContent(props) {
    return createElement(
      ...
      props.sideText && /* not keyboard tabbable */ createElement("a", __assign({ "Arial-hidden": true, className: "fc-list-day-side-text" }, props.sideNavLinkAttrs), props.sideText)
    );
  }
      ...
      return createElement(
        ...
        function (rootElRef, classNames, innerElRef, innerContent, hookProps) {
          return createElement(
            ...
            createElement(
              "td",
              { "Arial-hidden": true, className: "fc-list-event-graphic" },
        ...
        return createElement(
          ...
          createElement(
            ...
            createElement(
              ...
              createElement("th", { scope: "col", "Arial-hidden": true }),
  ...
  exports.createArialClickAttrs = createArialClickAttrs;
