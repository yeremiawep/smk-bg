...
var FullCalendar = (function (e) {
      ...
      (e = a.sort(function (e, t) {
        ...
        e.some(function (e) {
          ...
          e.__d &&
            ((i = (o = (t = e).__v).__e),
            (a = t.__P) &&
              ((n = []), ((r = f({}, o)).__v = o.__v + 1), I(a, o, r, t.__n, void 0 !== a.ownerSVGElement, null != o.__h ? [i] : null, n, null == i ? E(o) : i, o.__h), P(n, o), o.__e != i && S(o)));
        });
  }
      ...
      ? (function (e) {
          ...
          if (t) {
            ...
            return {
              ...
              milliseconds:
                n * (60 * (t[3] ? parseInt(t[3], 10) : 0) * 60 * 1e3 + 60 * (t[4] ? parseInt(t[4], 10) : 0) * 1e3 + 1e3 * (t[5] ? parseInt(t[5], 10) : 0) + (t[6] ? parseInt(t[6], 10) : 0)),
            };
          }
          return null;
        })(e)
  ...
  function ar(e, t, n, r, o, i, a) {
    ...
    return u && !d.allDay && (m || y)
      ? ((v = m ? f : v),
        (g = y ? h : g),
        c && d.hasEnd ? s.formatRange(v, g, t, { forcedStartTzo: i ? null : p.forcedStartTzo, forcedEndTzo: a ? null : p.forcedEndTzo }) : s.format(v, t, { forcedTzo: i ? null : p.forcedStartTzo }))
      : "";
  }
  function sr(e, t, n) {
            ...
            if (e.daysOfWeek || e.startTime || e.endTime || e.startRecur || e.endRecur) {
              ...
              return (
                ...
                !r &&
                  e.startTime &&
                  e.endTime &&
                  ((o = e.endTime), (i = e.startTime), (r = { years: o.years - i.years, months: o.months - i.months, days: o.days - i.days, milliseconds: o.milliseconds - i.milliseconds })),
    ...
    return (
      ...
      (e.prototype.updateData = function () {
        var e,
          ...
          v = (this.data = r(
            r(
              r(
                { viewTitle: this.buildTitle(d.dateProfile, h.options, f.dateEnv), calendarApi: c.calendarApi, dispatch: this.dispatch, emitter: this.emitter, getCurrentData: this.getCurrentData },
                f
              ),
              h
            ),
      ...
      (e.prototype.processRawViewOptions = function (e, t, n, o, i) {
        ...
        for (var f in a)
          a[f] === u[f]
            ? (l[f] = c[f])
            : (a[f] === this.currentCalendarOptionsInput[f] ? f in this.currentCalendarOptionsRefined && (l[f] = this.currentCalendarOptionsRefined[f]) : s[f] ? (l[f] = s[f](a[f])) : (p[f] = a[f]),
              (d = !0));
            ...
            if ("title" === u) (i = !1), r.push(_o("h2", { className: "fc-toolbar-title", id: t.titleId }, t.title));
              ...
              h && g.push(n.getClass("buttonActive")),
                r.push(
                  _o(
                    "button",
                    { type: "button", title: "function" == typeof f ? f(t.navUnit) : f, disabled: v, "Arial-pressed": h, className: g.join(" "), onClick: c },
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            ...
            _o("div", { "Arial-labelledby": e.labeledById, ref: this.handleEl, className: r.join(" "), style: { height: o, paddingBottom: i } }, e.children)
          );
        }),
        (t.prototype.componentDidMount = function () {
            ...
            function (t, o, i, a) {
              return _o(
                ...
                _o(
                  ...
                  _o("a", { "Arial-label": n.format(s, ba), className: ["fc-col-header-cell-cushion", e.isSticky ? "fc-sticky" : ""].join(" "), ref: i }, a)
                )
              );
            }
          );
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return Io(
            _o(
              "div",
              r({ id: o.id, className: a.join(" "), "Arial-labelledby": i.titleId }, o.extraAttrs, { ref: this.handleRootEl }),
              _o(
                "div",
  ...
  var Vs = (function (e) {
    ...
    Fs = (function (e) {
      function t(t) {
        ...
        return (
          a.emitter.on("pointerdown", n.handlePointerDown), a.emitter.on("dragstart", n.handleDragStart), a.emitter.on("hitupdate", n.handleHitUpdate), a.emitter.on("pointerup", n.handlePointerUp), n
        );
      }
      return (
        n(t, e),
      ...
      (t.prototype.render = function () {
        ...
        return _o(
          ...
          function (e, t, n, o, i, a, s, l) {
            return _o("a", r({ ref: e, className: ["fc-daygrid-more-link"].concat(t).join(" "), title: a, "Arial-expanded": s, "Arial-controls": l }, He(i)), o);
          }
        );
      }),
      t
          ...
          return _o(us, { date: a, dateProfile: s, todayRange: n.todayRange, showDayNumber: n.showDayNumber, extraHookProps: n.extraHookProps, elRef: this.handleRootEl }, function (e, t, u, c) {
            return _o(
              ...
              r(
                ...
                u,
                n.extraDataAttrs,
                n.showDayNumber ? { "Arial-labelledby": o.dayNumberId } : {}
              ),
              _o(
                "div",
          ...
          (t.renderHeadAxis = function (e, n) {
            ...
            return o.weekNumbers && "day" === e
              ? _o(fs, { date: i.start, defaultFormat: xl }, function (e, t, o, i) {
                  return _o(
                    "th",
                    { ref: e, "Arial-hidden": !0, className: ["fc-timegrid-axis", "fc-scrollgrid-shrink"].concat(t).join(" ") },
                    _o(
                      "div",
              ...
              : _o("th", { "Arial-hidden": !0, className: "fc-timegrid-axis" }, _o("div", { className: "fc-timegrid-axis-frame", style: { height: n } }));
          }),
          (t.renderTableRowAxis = function (e) {
            ...
            return _o(
              ...
              function (t, n, r, o) {
                return _o(
                  "td",
                  { ref: t, "Arial-hidden": !0, className: ["fc-timegrid-axis", "fc-scrollgrid-shrink"].concat(n).join(" ") },
                  _o(
                    "div",
              ...
              chunks: [
                {
                  ...
                  content: function (e) {
                    return _o(
                      ...
                      _o("table", { "Arial-hidden": !0, style: { height: e.expandRows ? e.clientHeight : "" } }, e.tableColGroupNode, _o("tbody", null, _o(kl, { slatMetas: i }))),
                      _o(
                        "div",
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return _o(
            ...
            _o(
              "table",
              { "Arial-hidden": !0, className: t.theme.getClass("table"), style: { minWidth: e.tableMinWidth, width: e.clientWidth, height: e.minHeight } },
              e.tableColGroupNode,
            ...
            _o(
              ...
              _o(
                ...
                t.axis &&
                  _o(
                    "td",
                    { "Arial-hidden": !0, className: "fc-timegrid-col fc-timegrid-axis" },
                    _o(
                      "div",
                      { className: "fc-timegrid-col-frame" },
                      _o(
          ...
          return _o(
            ...
            function (e, n, r, o) {
              return _o(
                ...
                _o("th", { scope: "colgroup", colSpan: 3, id: s, "Arial-labelledby": c }, _o("div", { className: "fc-list-day-cushion " + t.getClass("tableCellShaded"), ref: r }, o))
              );
            }
          );
        }),
  ...
  function uu(e) {
    return _o(
      ...
      e.sideText && _o("a", r({ "Arial-hidden": !0, className: "fc-list-day-side-text" }, e.sideNavLinkAttrs), e.sideText)
    );
  }
          ...
          return _o(
            ...
            function (e, r, l, u, c) {
              return _o(
                ...
                (function (e, t, n, r, o) {
                  ...
                  if (!1 !== i.displayEventTime) {
                    ...
                    if (
                      ...
                      return _o(
                        Yo,
                        { hookProps: c, classNames: i.allDayClassNames, content: i.allDayContent, defaultContent: pu, didMount: i.allDayDidMount, willUnmount: i.allDayWillUnmount },
                        function (e, t, n, i) {
                ...
                _o("td", { "Arial-hidden": !0, className: "fc-list-event-graphic" }, _o("span", { className: "fc-list-event-dot", style: { borderColor: c.borderColor || c.backgroundColor } })),
      ...
      (t.prototype.renderSegList = function (e, t) {
        ...
        return _o(Ca, { unit: "day" }, function (e, n) {
          ...
          return _o(
            ...
            _o("thead", null, _o("tr", null, _o("th", { scope: "col", id: s }, i.timeHint), _o("th", { scope: "col", "Arial-hidden": !0 }), _o("th", { scope: "col", id: l }, i.eventHint))),
            _o("tbody", null, a)
          );
        });
      }),
  ...
  return (
    ...
    (e.getSlotClassNames = function (e, t) {
      ...
      return (
        e.isDisabled ? n.push("fc-slot-disabled") : (e.isToday && (n.push("fc-slot-today"), n.push(t.getClass("today"))), e.isPast && n.push("fc-slot-past"), e.isFuture && n.push("fc-slot-future")), n
      );
    }),
