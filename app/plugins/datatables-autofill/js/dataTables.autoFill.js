...
(function (factory) {
  ...
  $.extend(AutoFill.prototype, {
    ...
    _actionSelector: function (cells) {
      ...
      if (available.length === 1 && this.c.alwaysAsk === false) {
        ...
        $.each(available, function (i, name) {
          list.append(
            $("<li/>")
              .append('<div class="dt-autofill-question">' + actions[name].option(dt, cells) + "<div>")
              .append(
                $('<div class="dt-autofill-button">').append(
                  $('<button class="' + AutoFill.classes.btn + '">' + dt.i18n("autoFill.button", "&gt;") + "</button>").on("click", function () {
    ...
    _drawSelection: function (target, e) {
      ...
      var end = {
        row: this.c.vertical ? dt.rows({ page: "current" }).nodes().indexOf(target.parentNode) : start.row,
    ...
    _focusListener: function () {
      ...
      var focus = this.c.focus !== null ? this.c.focus : dt.init().keys || dt.settings()[0].keytable ? "focus" : "hover";
    ...
    _shiftScroll: function (e) {
      ...
      // this information to the interval. Can't use local vArialbles as they
