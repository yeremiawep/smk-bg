...
(function (global, factory) {
  ...
  else if (typeof module === "object" && typeof module.exports === "object") module.exports = factory(global, global.document, undefined, require("jquery"));
  ...
  var PLUGIN = (function () {
    ...
    function OverlayScrollbarsInstance(pluginTargetElement, options, extensions, globals, autoUpdateLoop) {
                  ...
                  generateDiv(
                    ...
                    generateDiv(
                      ...
                      generateDiv(_classNameResizeObserverItemElement, generateDiv(_classNameResizeObserverItemFinalElement)) +
                        generateDiv(_classNameResizeObserverItemElement, generateDiv({ c: _classNameResizeObserverItemFinalElement, style: "width: 200%; height: 200%" }))
                    )
                  )
                );
      ...
      /**
       * Updates the vArialbles and size of the textarea element, and manages the scroll on new line or new character.
       */
      ...
      function update(updateHints) {
        ...
        var widthAutoObserverDetection =
          _sizeAutoObserverAdded && _hostElement.css(_strFloat) !== "none" /*|| _isTextarea */
            ? MATH.round(sizeAutoObserverElementBCRect.right - sizeAutoObserverElementBCRect.left) === 0 && (!paddingAbsolute ? _hostElementNative[LEXICON.cW] - _paddingX > 0 : true)
            : false;
        ...
        var heightAuto =
          _sizeAutoObserverAdded && sizeAutoCapable && !displayIsHidden
            ? MATH.round(sizeAutoObserverElementBCRect.bottom - sizeAutoObserverElementBCRect.top) === 0 /* && (!paddingAbsolute && (_msieVersion > 9 || !_msieVersion) ? true : true) */
            : false;
        ...
        if (
          ...
          if (!_nativeScrollbarStyling) {
            ...
            var resetXTmp =
              _hasOverflowCache.y && _hideOverflowCache.ys && !ignoreOverlayScrollbarHiding ? (_nativeScrollbarIsOverlaid.y ? _viewportElement.css(isRTLLeft) : -_nativeScrollbarSize.y) : 0;
            var resetBottomTmp =
              _hasOverflowCache.x && _hideOverflowCache.xs && !ignoreOverlayScrollbarHiding ? (_nativeScrollbarIsOverlaid.x ? _viewportElement.css(_strBottom) : -_nativeScrollbarSize.x) : 0;
          ...
          var setOverflowVArialbles = function (horizontal) {
            var scrollbarVars = getScrollbarVars(horizontal);
          ...
          setOverflowVArialbles(true);
          setOverflowVArialbles(false);
              ...
              var textareaScrollAmount = {
                ...
                y: (
                  textareaAutoWrapping
                    ? cursorIsLastPosition || (textareaRowsChanged && (previousOverflowAmount ? currScroll.y === previousOverflowAmount.y : false))
      ...
      function setupStructureDOM(destroy) {
        ...
        _hostElement =
          _hostElement || (_isTextarea ? (_domExists ? _targetElement[strParent]()[strParent]()[strParent]()[strParent]() : FRAMEWORK(generateDiv(_classNameHostTextareaElement))) : _targetElement);
      ...
      function setupScrollbarEvents(isHorizontal) {
        ...
        function onMouseTouchDownContinue(event) {
          ...
          return _sleeping || _destroyed || nativeOverlayScrollbarsAreActive() || !_scrollbarsDragScrollingCache || (isTouchEvent && !getPreparedScrollbarsOption("touchSupport"))
            ? false
        ...
        function onTrackMouseTouchDown(event) {
          if (onMouseTouchDownContinue(event)) {
            var handleToViewportRatio =
              scrollbarVars._info._handleLength / Math.round(MATH.min(1, _viewportSize[scrollbarVars._w_h] / _contentScrollSizeCache[scrollbarVars._w_h]) * scrollbarVars._info._trackLength);
      ...
      function refreshScrollbarHandleOffset(isHorizontal, scrollOrTransition) {
        ...
        //DONT use the vArialble '_contentScrollSizeCache[scrollbarVars._w_h]' instead of '_viewportElement[0]['scroll' + scrollbarVars._Width_Height]'
        // because its a bit behind during the small delay when content size updates
        //(delay = mutationObserverContentLag, if its 0 then this var could be used)
        var maxScroll =
          (_viewportElementNative[_strScroll + scrollbarVars._Width_Height] - _viewportElementNative["client" + scrollbarVars._Width_Height]) * (_rtlScrollBehavior.n && isRTLisHorizontal ? -1 : 1); //* -1 if rtl scroll max is negative
      ...
      /**
       * Returns a object which is used for fast access for specific vArialbles.
