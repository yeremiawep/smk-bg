...
*/
      ...
      /***/ 5005: /***/ function (module, __unused_webpack_exports, __webpack_require__) {
        ...
        var aFunction = function (vArialble) {
          return typeof vArialble == "function" ? vArialble : undefined;
        };
      ...
      /***/ 30: /***/ function (module, __unused_webpack_exports, __webpack_require__) {
        ...
        // vArialtion of https://github.com/kitcambridge/es5-shim/commit/4f738ac066346
        // avoid IE GC bug
        var activeXDocument;
        ...
        var encode = function (input) {
          ...
          while (handledCPCount < inputLength) {
            ...
            for (i = 0; i < input.length; i++) {
              ...
              if (currentValue == n) {
                // Represent delta as a generalized vArialble-length integer.
                var q = delta;
              ...
              value: function init() {
                ...
                if (this.element.classList.contains("dropzone") && !this.element.querySelector(".dz-message")) {
                  this.element.appendChild(
                    Dropzone.createElement('<div class="dz-default dz-message"><button class="dz-button" type="button">'.concat(this.options.dictDefaultMessage, "</button></div>"))
                  );
                }
            ...
            },
            {
              ...
              value: function getFallbackForm() {
                ...
                fieldsString += '<input type="file" name="'
                  ...
                  .concat(this.options.uploadMultiple ? 'multiple="multiple"' : undefined, ' /><input type="submit" value="Upload!"></div>');
 ...
 */
      ...
      /// Make Dropzone a global vArialble.
