...
(function ($) {
  ...
  $container.append("<h6>Navbar VArialnts</h6>");

  var $navbar_vArialnts = $("<div />", {
    class: "d-flex",
  });
  var navbar_all_colors = navbar_dark_skins.concat(navbar_light_skins);
  var $navbar_vArialnts_colors = createSkinBlock(navbar_all_colors, function () {
  ...
  $navbar_vArialnts_colors.find("option." + active_navbar_color).prop("selected", true);
  $navbar_vArialnts_colors.removeClass().addClass("custom-select mb-3 text-light border-0 ").addClass(active_navbar_color);

  $navbar_vArialnts.append($navbar_vArialnts_colors);

  $container.append($navbar_vArialnts);

  // Sidebar Colors

  $container.append("<h6>Accent Color VArialnts</h6>");
  var $accent_vArialnts = $("<div />", {
    class: "d-flex",
  });
  $container.append($accent_vArialnts);
  $container.append(
    createSkinBlock(
      accent_colors,
      function () {
  ...
  // $accent_vArialnts.find('option.' + active_accent_color).prop('selected', true)
  // $accent_vArialnts.removeClass().addClass('custom-select mb-3 text-light border-0 ').addClass(active_accent_color)

  $container.append("<h6>Dark Sidebar VArialnts</h6>");
  var $sidebar_vArialnts_dark = $("<div />", {
    class: "d-flex",
  });
  $container.append($sidebar_vArialnts_dark);
  var $sidebar_dark_vArialnts = createSkinBlock(
    sidebar_colors,
    function () {
      var color = $(this).find("option:selected").attr("class");
      ...
      sidebar_skins.forEach(function (skin) {
        ...
        $sidebar_light_vArialnts.removeClass(skin.replace("sidebar-dark-", "bg-")).removeClass("text-light");
      });

      $(this).removeClass().addClass("custom-select mb-3 text-light border-0").addClass(color);

      $sidebar_light_vArialnts.find("option").prop("selected", false);
      $sidebar.addClass(sidebar_class);
      $(".sidebar").removeClass("os-theme-dark").addClass("os-theme-light");
    },
    true
  );
  $container.append($sidebar_dark_vArialnts);
  ...
  $sidebar_dark_vArialnts.find("option." + active_sidebar_dark_color).prop("selected", true);
  $sidebar_dark_vArialnts.removeClass().addClass("custom-select mb-3 text-light border-0 ").addClass(active_sidebar_dark_color);

  $container.append("<h6>Light Sidebar VArialnts</h6>");
  var $sidebar_vArialnts_light = $("<div />", {
    class: "d-flex",
  });
  $container.append($sidebar_vArialnts_light);
  var $sidebar_light_vArialnts = createSkinBlock(
    sidebar_colors,
    function () {
      var color = $(this).find("option:selected").attr("class");
      ...
      sidebar_skins.forEach(function (skin) {
        $sidebar.removeClass(skin);
        $sidebar_dark_vArialnts.removeClass(skin.replace("sidebar-light-", "bg-")).removeClass("text-light");
      });

      $(this).removeClass().addClass("custom-select mb-3 text-light border-0").addClass(color);

      $sidebar_dark_vArialnts.find("option").prop("selected", false);
      $sidebar.addClass(sidebar_class);
      $(".sidebar").removeClass("os-theme-light").addClass("os-theme-dark");
    },
    true
  );
  $container.append($sidebar_light_vArialnts);
  ...
  if (active_sidebar_light_color !== null) {
    $sidebar_light_vArialnts.find("option." + active_sidebar_light_color).prop("selected", true);
    $sidebar_light_vArialnts.removeClass().addClass("custom-select mb-3 text-light border-0 ").addClass(active_sidebar_light_color);
  }

  var logo_skins = navbar_all_colors;
  $container.append("<h6>Brand Logo VArialnts</h6>");
  var $logo_vArialnts = $("<div />", {
    class: "d-flex",
  });
  $container.append($logo_vArialnts);
  var $clear_btn = $("<a />", {
    href: "#",
  })
    .text("clear")
  ...
  var $brand_vArialnts = createSkinBlock(
    logo_skins,
    function () {
      var color = $(this).find("option:selected").attr("class");
      var $logo = $(".brand-link");
  ...
  $container.append($brand_vArialnts);
  ...
  if (active_brand_color) {
    $brand_vArialnts.find("option." + active_brand_color).prop("selected", true);
    $brand_vArialnts.removeClass().addClass("custom-select mb-3 text-light border-0 ").addClass(active_brand_color);
  }
})(jQuery);
