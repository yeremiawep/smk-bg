...
!(function (e, t) {
    ...
    Qe = (function () {
      ...
      return (
        ...
        (t.createTab = function (e, t, a, i) {
          ...
          var d = '<div class="tab-pane fade" id="' + l + '" role="tabpanel" Arial-labelledby="' + s + '"><iframe src="' + t + '"></iframe></div>';
        ...
        (t.removeActiveTab = function (e, t) {
          if ("all" == e) n.default(ve).remove(), n.default(we).remove(), n.default(ye).show();
            ...
            var a = n.default(t),
              ...
              o = i.parent(),
              l = i.index(),
              s = a.siblings(".nav-link").attr("Arial-controls");
  ...
  n.default(document).on("click", st, function (e) {
    ...
    n.default(document).on("keydown", ft, function (e) {
      ...
      38 == e.keyCode && (e.preventDefault(), t.is(":first-child") ? t.siblings().last().focus() : t.prev().focus()),
  ...
  var wt = n.default.fn.Toasts,
    ...
    kt = (function () {
      ...
      return (
        (t.create = function () {
          var e = n.default('<div class="toast" role="alert" Arial-live="assertive" Arial-atomic="true"/>');
          ...
          if (
            ...
            var i = n.default('<button data-dismiss="toast" />').attr("type", "button").addClass("ml-2 mb-1 close").attr("Arial-label", "Close").append('<span Arial-hidden="true">&times;</span>');
