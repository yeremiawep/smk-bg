...
!(function (t, e) {
        ...
        (e.toggle = function () {
          ...
          if (n) {
            ...
            if (i) {
              ...
              t && (("checkbox" !== i.type && "radio" !== i.type) || (i.checked = !this._element.classList.contains(_)), this.shouldAvoidTriggerChange || o.default(i).trigger("change")),
                i.focus(),
                (e = !1);
            }
          }
          this._element.hasAttribute("disabled") ||
            ...
            (e && this._element.setAttribute("Arial-pressed", !this._element.classList.contains(_)), t && o.default(this._element).toggleClass(_));
        }),
        (e.dispose = function () {
  ...
  o
    ...
    o.default(window).on("load.bs.button.data-api", function () {
      ...
      for (var a = 0, s = (t = [].slice.call(document.querySelectorAll('[data-toggle="button"]'))).length; a < s; a++) {
        var l = t[a];
        "true" === l.getAttribute("Arial-pressed") ? l.classList.add(_) : l.classList.remove(_);
      }
    }),
    ...
    P = (function () {
      ...
      return (
        ...
        (e._slide = function (t, e) {
          ...
          if (
            (t === N ? ((n = "carousel-item-left"), (i = "carousel-item-next"), (a = "left")) : ((n = "carousel-item-right"), (i = "carousel-item-prev"), (a = "right")), u && o.default(u).hasClass(S))
          )
            this._isSliding = !1;
    ...
    V = (function () {
      function t(t, e) {
        ...
        (this._parent = this._config.parent ? this._getParent() : null),
          this._config.parent || this._addArialAndCollapsedClass(this._element, this._triggerArray),
          ...
          if (
            ...
            if ((o.default(this._element).trigger(a), !a.isDefaultPrevented())) {
              ...
              o.default(this._element).removeClass(F).addClass(Q),
                ...
                this._triggerArray.length && o.default(this._triggerArray).removeClass(B).attr("Arial-expanded", !0),
            ...
            if ((o.default(this._element).trigger(e), !e.isDefaultPrevented())) {
              ...
              if (i > 0)
                for (var a = 0; a < i; a++) {
                  ...
                  null !== l && (o.default([].slice.call(document.querySelectorAll(l))).hasClass(q) || o.default(s).addClass(B).attr("Arial-expanded", !1));
                }
        ...
        (e._getParent = function () {
          ...
          return (
            o.default(a).each(function (e, i) {
              n._addArialAndCollapsedClass(t._getTargetFromElement(i), [i]);
            }),
            e
          );
        }),
        (e._addArialAndCollapsedClass = function (t, e) {
          var n = o.default(t).hasClass(q);
          e.length && o.default(e).toggleClass(B, !n).attr("Arial-expanded", n);
        }),
            ...
            if ((o.default(s).trigger(i), !i.isDefaultPrevented())) {
              if (!this._inNavbar && e) {
                ...
                "parent" === this._config.reference
                  ? (l = s)
                  : d.isElement(this._config.reference) && ((l = this._config.reference), "undefined" != typeof this._config.reference.jquery && (l = this._config.reference[0])),
              ...
              "ontouchstart" in document.documentElement && 0 === o.default(s).closest(".navbar-nav").length && o.default(document.body).children().on("mouseover", null, o.default.noop),
                this._element.focus(),
                this._element.setAttribute("Arial-expanded", !0),
        ...
        (e.hide = function () {
          if (!this._element.disabled && !o.default(this._element).hasClass($) && o.default(this._menu).hasClass(J)) {
            ...
            o.default(i).trigger(n),
              n.isDefaultPrevented() || (this._popper && this._popper.destroy(), o.default(this._menu).toggleClass(J), o.default(i).toggleClass(J).trigger(o.default.Event(tt, e)));
          }
        }),
        (e.dispose = function () {
                ...
                if (
                  ...
                  o.default(s).trigger(f),
                    f.isDefaultPrevented() ||
                      ...
                      n[i].setAttribute("Arial-expanded", "false"),
      ...
      return (
        ...
        (e._showElement = function (t) {
          ...
          (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE) || document.body.appendChild(this._element),
            ...
            this._element.setAttribute("Arial-modal", !0),
        ...
        (e._hideModal = function () {
          ...
          (this._element.style.display = "none"),
            this._element.setAttribute("Arial-hidden", !0),
  ...
  var It = "tooltip",
    ...
    Ht = {
      ...
      sanitizeFn: null,
      whiteList: {
        "*": ["class", "dir", "id", "lang", "role", /^Arial-[\w-]*$/i],
      ...
      return (
        ...
        (e.show = function () {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            s.setAttribute("id", l), this.element.setAttribute("Arial-describedby", l), this.setContent(), this.config.animation && o.default(s).addClass(Lt);
          ...
          var e = this,
            ...
            a = function () {
              e._hoverState !== xt && n.parentNode && n.parentNode.removeChild(n),
                e._cleanTipClass(),
                e.element.removeAttribute("Arial-describedby"),
      ...
      return (
        ...
        (e._transitionComplete = function (t, e, n) {
          if (e) {
            ...
            i && o.default(i).removeClass(ue), "tab" === e.getAttribute("role") && e.setAttribute("Arial-selected", !1);
          }
          o.default(t).addClass(ue), "tab" === t.getAttribute("role") && t.setAttribute("Arial-selected", !0), d.reflow(t), t.classList.contains(fe) && t.classList.add(de);
          var a = t.parentNode;
          if ((a && "LI" === a.nodeName && (a = a.parentNode), a && o.default(a).hasClass("dropdown-menu"))) {
            ...
            t.setAttribute("Arial-expanded", !0);
          }
          n && n();
        }),
        (t._jQueryInterface = function (e) {
