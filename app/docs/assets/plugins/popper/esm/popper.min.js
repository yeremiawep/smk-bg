 ...
 */ var e = "undefined" != typeof window && "undefined" != typeof document && "undefined" != typeof navigator,
  t = (function () {
    for (var t = ["Edge", "Trident", "Firefox"], o = 0; o < t.length; o += 1) if (e && 0 <= navigator.userAgent.indexOf(t[o])) return 1;
    return 0;
  })();
function o(e) {
  var t = !1;
...
function x(e, t, o, n) {
  return Math.max(
    ...
    o["offset" + e],
    o["scroll" + e],
    h(10) ? parseInt(o["offset" + e]) + parseInt(n["margin" + ("Height" === e ? "Top" : "Left")]) + parseInt(n["margin" + ("Height" === e ? "Bottom" : "Right")]) : 0
  );
}
function v(e) {
  var t = e.body,
...
function ne(e, t, o, n, i) {
  ...
  return t.setAttribute("x-placement", p), ee(t, { position: o.positionFixed ? "fixed" : "absolute" }), o;
}
function ie(e, t) {
  var o = e.offsets,
    n = o.popper,
    ...
    h = t ? r : s;
  return { left: m(1 == d % 2 && 1 == a % 2 && !f && t ? n.left - 1 : n.left), top: h(n.top), bottom: h(n.bottom), right: m(n.right) };
}
...
function pe(e, t) {
  ...
  if (
    ...
    (p = "right" == g ? ("HTML" === a.nodeName ? -a.clientWidth + m.right : -l.width + m.right) : m.left),
    d && u)
  )
  ...
  return (
    p.forEach(function (s, d) {
      ...
      var a = e.offsets.popper,
        ...
        y = !!t.flipVArialtions && ((w && "start" === r && h) || (w && "end" === r && c) || (!w && "start" === r && g) || (!w && "end" === r && u)),
        E = !!t.flipVArialtionsByContent && ((w && "start" === r && c) || (w && "end" === r && h) || (!w && "start" === r && u) || (!w && "end" === r && g)),
        x = y || E;
      (m || b || x) &&
        ((e.flipped = !0),
        (m || b) && (n = p[d + 1]),
...
var Oe = {
    ...
    preventOverflow: { order: 300, enabled: !0, fn: ye, priority: ["left", "right", "top", "bottom"], padding: 5, boundariesElement: "scrollParent" },
    keepTogether: { order: 400, enabled: !0, fn: ge },
    arrow: { order: 500, enabled: !0, fn: de, element: "[x-arrow]" },
    flip: { order: 600, enabled: !0, fn: ce, behavior: "flip", padding: 5, boundariesElement: "viewport", flipVArialtions: !1, flipVArialtionsByContent: !1 },
  ...
  Le = { placement: "bottom", positionFixed: !1, eventsEnabled: !0, removeOnDestroy: !1, onCreate: function () {}, onUpdate: function () {}, modifiers: Oe },
  Se = (function () {
    function e(t, o) {
      var n = this,
